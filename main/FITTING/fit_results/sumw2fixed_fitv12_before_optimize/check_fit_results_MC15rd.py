...
output_file = f"tmp_fitv12_results_MC15rd_{Kp_or_pip}_{gg_or_pipipi}.txt"
...
pattern = f"MC15rd_eta{Kp_or_pip}_{gg_or_pipipi}_fit_opt_loose_v7_tmp_fitv12_bdt_train_Dp_CMS_p_all_0.[0-9][0-9]_sumw2fixed_weighted.root"
...
with open(output_file, 'w') as out_f:
    ...
    out_f.write(f"File with lowest Acp uncertainty: {min_acp_file} with uncertainty {min_acp_error} (Acp = {min_acp})\n")
    out_f.write(f"File with lowest Acp_Ds uncertainty: {min_acp_ds_file} with uncertainty {min_acp_ds_error} (Acp_Ds = {min_acp_ds})\n")
