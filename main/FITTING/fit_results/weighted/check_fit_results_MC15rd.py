...
output_file = f"fitv6_results_MC15rd_{Kp_or_pip}_{gg_or_pipipi}.txt"
...
for root_file in os.listdir(input_dir):
    if fnmatch.fnmatch(root_file, f"MC15rd_eta{Kp_or_pip}_{gg_or_pipipi}_fit_opt_loose_v7_fitv6_bdt_train_Dp_CMS_p_all_0.*weighted.root"):
