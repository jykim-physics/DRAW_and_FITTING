...
def main():
    ...
    title_dict = dict()
    title_dict['etapip_gg']=r"$D^+ \to \eta_{\gamma\gamma} \pi^+$"
    title_dict['etapip_gg_K']=r"$D^+ \to \eta_{\gamma\gamma} K^+$"
    title_dict['etapip_pipipi']=r"$D^+ \to \eta_{3\pi} \pi^+$"
    title_dict['etapip_pipipi_K']=r"$D^+ \to \eta_{3\pi} K^+$"
    # Save CSV
    #csv_path = "ntot_over_sqrt_uncertainty.csv"
    csv_path = f"ntot_over_sqrt_uncertainty_{tree_name}.csv"
    ...
    png_path = f"ntot_over_sqrt_uncertainty_{tree_name}.png"
    plt.tight_layout()
