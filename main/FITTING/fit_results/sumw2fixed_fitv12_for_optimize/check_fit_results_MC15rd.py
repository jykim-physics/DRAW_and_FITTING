...
output_file = f"fitv12_results_MC15rd_{Kp_or_pip}_{gg_or_pipipi}.txt"
...
pattern = f"MC15rd_eta{Kp_or_pip}_{gg_or_pipipi}_fit_opt_loose_v7_fitv12_bdt_train_Dp_CMS_p_all_0.[0-9][0-9]_sumw2fixed_weighted.root"
