...
output_file = f"fitv8_results_proc13_{Kp_or_pip}_{gg_or_pipipi}.txt"
...
for root_file in os.listdir(input_dir):
    if fnmatch.fnmatch(root_file, f"proc13_etapip_{gg_or_pipipi}_fit_opt_loose_v7_fitv8_bdt_train_Dp_CMS_p_all_0.*new_Ds_correct.root"):
