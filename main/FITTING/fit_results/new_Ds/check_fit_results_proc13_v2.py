...
output_file = f"fit_results_proc13_{Kp_or_pip}_{gg_or_pipipi}.txt"
...
for root_file in os.listdir(input_dir):
    if fnmatch.fnmatch(root_file, f"proc13_etapip_{gg_or_pipipi}_fit_opt_loose_v7_fitv6_bdt_train_Dp_CMS_p_all_0.*new_Ds.root"):
