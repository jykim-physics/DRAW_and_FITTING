...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv2_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv2_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv2_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/fitresult/MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv2_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/fitresult/MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv2_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/MC15rd/Kspip/pipipi/MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv2_Dp_{suffix}.root"
...
data = ROOT.RooDataSet("data","", mychain, ROOT.RooArgSet(x,Pip_charge,Pip_kaonID, Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane, Dp_cosHelicityAngleMomentum, Dp_CMS_p), cuts_Dp)
...
for i in file_list:
    mychain_cc.Add(i)
data_cc = ROOT.RooDataSet("data","", mychain_cc, ROOT.RooArgSet(x,Pip_charge, Pip_kaonID, Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane, Dp_cosHelicityAngleMomentum, Dp_CMS_p), cuts_Dm)
