...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/MC15rd_Ds_Kspip_gg_K_fit_opt_loose_v7_fitv2_Dpregion_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/MC15rd_Ds_Kspip_gg_K_fit_opt_loose_v7_fitv2_Dpregion_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/MC15rd_Ds_Kspip_gg_K_fit_opt_loose_v7_fitv2_Dpregion_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/fitresult/MC15rd_Ds_Kspip_gg_K_fit_opt_loose_v7_fitv2_Dpregion_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/fitresult/MC15rd_Ds_Kspip_gg_K_fit_opt_loose_v7_fitv2_Dpregion_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/MC15rd/Kspip/gg/MC15rd_Ds_Kspip_gg_K_fit_opt_loose_v7_fitv2_Dpregion_{suffix}.root"
...
base_path = "/share/storage/jykim/storage_b2/storage/reduced_ntuples/MC15rd/Kspip//MC15rd_Kspip_loose_v7_1_250228_Dp_CMS_p_v3_copy_debug"
...
data = ROOT.RooDataSet("data","", mychain, ROOT.RooArgSet(x,Pip_charge,Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane, etapip_Eta_Easym, Dp_cosHelicityAngleMomentum, Dp_CMS_p), cuts_Dp)
...
for i in file_list:
    mychain_cc.Add(i)
data_cc = ROOT.RooDataSet("data","", mychain_cc, ROOT.RooArgSet(x,Pip_charge,Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane, etapip_Eta_Easym, Dp_cosHelicityAngleMomentum, Dp_CMS_p), cuts_Dm)

#data.append(data_cc)
Num_total_cc = data_cc.sumEntries()
print(Num_total_cc)

N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 6000000*scale, 500000*scale, 20000000*scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 5000000*scale,50000*scale,10000000*scale)
