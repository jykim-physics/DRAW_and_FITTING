...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv1_Dp_{args.train}_Dp_CMS_{args.sign}.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv1_Dm_{args.train}_Dp_CMS_{args.sign}.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/fitresult/MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv1_{args.train}_Dp_CMS_{args.sign}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/fitresult/MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv1_{args.train}_Dp_CMS_{args.sign}.txt"
...
base_path = "/share/storage/jykim/storage_b2/storage/reduced_ntuples/MC15rd/Kspip/MC15rd_Kspip_loose_v7_1_250122_Dp_dz"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 2000000*scale, 1500000*scale, 2800000*scale)  # N_total = N_D+ + N_D-
...
#Nbkg_D_plus = ROOT.RooRealVar("Nbkg_D_plus", "Number of background events for D+", 200000*scale, 120000*scale, 400000*scale)
#Nbkg_D_minus = ROOT.RooRealVar("Nbkg_D_minus", "Number of background events for D-", 200000*scale,120000*scale, 400000*scale)
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 200000*scale,240000*scale,600000*scale)
