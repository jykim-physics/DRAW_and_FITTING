...
h_data = ROOT.TH1F("h_data", "Data Histogram", 10000, min_bin, max_bin)
h_MC = ROOT.TH1F("h_MC", "MC Histogram", 10000, min_bin, max_bin)
#h_data = ROOT.TH1F("h_data", "Data Histogram", 100000, min_bin, max_bin)
#h_MC = ROOT.TH1F("h_MC", "MC Histogram", 100000, min_bin, max_bin)
...
def get_efficiency_and_error(h, cut_val):
    ...
    # BDT > cut_val
    # Pass = Right side of the plot
    val_pass = h.IntegralAndError(bin_cut + 1, n_bins, err_pass)
    # Fail = Left side of the plot
    val_fail = h.IntegralAndError(1, bin_cut, err_fail)
