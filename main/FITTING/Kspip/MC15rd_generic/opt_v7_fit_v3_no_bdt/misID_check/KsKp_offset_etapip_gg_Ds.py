...
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
...
data = ROOT.RooDataSet("data","", mychain, ROOT.RooArgSet(x,Pip_charge, Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane,  Dp_cosHelicityAngleMomentum, Dp_CMS_p,etapip_Eta_Easym, rank_Dp_chiProb, etapip_Eta_isSignal, etapip_Eta_genMotherID, Pip_genMotherID, Pip_genMotherPDG, Pip_mcPDG), cuts_Dp)
...
for i in file_list:
    mychain_cc.Add(i)
data_cc = ROOT.RooDataSet("data","", mychain_cc, ROOT.RooArgSet(x,Pip_charge,Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane,  Dp_cosHelicityAngleMomentum, Dp_CMS_p, etapip_Eta_Easym,rank_Dp_chiProb, etapip_Eta_isSignal, etapip_Eta_genMotherID, Pip_genMotherID, Pip_genMotherPDG, Pip_mcPDG), cuts_Dm)
...
data_combined = RooDataSet("data_combined", "Combined data", RooArgList(x, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane,  Dp_cosHelicityAngleMomentum, Dp_CMS_p, etapip_Eta_Easym), RooFit.Index(cat),
