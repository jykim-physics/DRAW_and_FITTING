...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv2_Ds_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv2_Ds_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv2_Ds_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/fitresult/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv2_Ds_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/fitresult/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv2_Ds_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/MC15rd/KsKp/gg/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv2_Ds_{suffix}.root"
...
fit_result = sim_model.fitTo(data_combined, RooFit.Save(), RooFit.Extended(True), ROOT.RooFit.NumCPU(8), RooFit.Strategy(0), RooFit.Minos(0), RooFit.Hesse(1), ROOT.RooFit.Offset(True))
#fit_result = sim_model.fitTo(data_combined, RooFit.Save(), RooFit.Extended(True), ROOT.RooFit.NumCPU(8), RooFit.Strategy(2), RooFit.Minos(0), RooFit.Hesse(1), ROOT.RooFit.Offset(True))
