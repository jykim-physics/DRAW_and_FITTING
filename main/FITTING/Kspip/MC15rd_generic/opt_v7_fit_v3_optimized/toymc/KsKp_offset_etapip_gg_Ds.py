...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/fitresult/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_train_Dp_CMS_p_Dp_CMS_{args.sign}_sumw2fixed_weighted.root")
