...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/fitresult/MC15rd_1ab_Kspip_pipipi_fit_opt_loose_v7_fitv3_train_Dp_CMS_p_Dp_CMS_{args.sign}_sumw2fixed.root")
...
ToyMC_all = ROOT.RooMCStudy(sim_model, {x,cat}, Extended(True), FitOptions(Save(True),PrintEvalErrors(0),PrintLevel(1), NumCPU(8), Offset("initial")))
