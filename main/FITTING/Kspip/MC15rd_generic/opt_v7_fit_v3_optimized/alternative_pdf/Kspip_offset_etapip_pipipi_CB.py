...
BDT_cut="0.72"
suffix = "sumw2fixed_alternative_CB"
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 40000*scale*CMS_scale,10000*scale*CMS_scale,10000000*scale*CMS_scale)
