...
sim_model.plotOn(frame_D_all, Name="DpKsPip", Components="kde_model", ProjWData=(cat, data_combined),    LineColor=ROOT.kMagenta+1)
...
leg1.AddEntry("data", "MC", "PE")
leg1.AddEntry("Fitting", "Fit", "l")
leg1.AddEntry("DpKsPip", "D^{+} #rightarrow K^{0}_{S}#pi^{+}", "l")
leg1.AddEntry("Background", "Bkg", "l")
leg1.SetBorderSize(0)
leg1.Draw()
