...
KDE_fit_result = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/Kspip/gg/KDE_MC15rd_Kspip_gg_kaon_misID_Dp_M_v3_result_true_extended_train_Dp_CMS_p.0.80.{args.sign}.root")
...
#Acp_peak_bkg = RooRealVar("Acp_peak_bkg", "Acp", 1)  # A_Cp as a fit parameter
...
f_in = ROOT.TFile(f"/share/storage/jykim/plots/MC15rd/Kspip/gg/KDE_MC15rd_Kspip_gg_kaon_misID_Dp_M_v3_result_true_extended_train_Dp_CMS_p.0.80.{args.sign}_workspace.root", "READ")
ws = f_in.Get("ws_kde")
...
model_D_plus = ROOT.RooAddPdf("model_D_plus", "D+ model",
                              ROOT.RooArgList(sig_model,  model_bkg, kde_model),
                              ROOT.RooArgList(Nsig_D_plus,  Nbkg_D_plus, N_peak_bkg_D_plus))
model_D_minus = ROOT.RooAddPdf("model_D_minus", "D- model",
                              ROOT.RooArgList(sig_model,  model_bkg, kde_model),
                              ROOT.RooArgList(Nsig_D_minus,  Nbkg_D_minus, N_peak_bkg_D_minus))
...
sim_model.plotOn(frame_D_all, Name="DspKsKp", Components="kde_model", ProjWData=(cat, data_combined),    LineColor=ROOT.kMagenta+1)
...
leg1.AddEntry("data", "MC", "PE")
leg1.AddEntry("Fitting", "Fit", "l")
leg1.AddEntry("DspKsKp", "D^{+}_{s} #rightarrow K^{0}_{S}K^{+}", "l")
leg1.AddEntry("Background", "Bkg", "l")
leg1.SetBorderSize(0)
leg1.Draw()
