...
BDT_cut="0.86"
suffix = f"sumw2fixed_weighted_float_var_{args.float_var}"
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.pdf"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/fitresult/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/fitresult/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/MC15rd/KsKp/gg/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_{suffix}.root"
...
#N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 300000*scale, 20000*scale, 1000000*scale)  # N_total = N_D+ + N_D-
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 300000*scale, 20000*scale, 6000000*scale)  # N_total = N_D+ + N_D-
...
#Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+",  60000*scale,500*scale,300000*scale)
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+",  60000*scale,500*scale,120000*scale)
...
mean = ROOT.RooRealVar("mean", "mean", 1.97, 1.96, 1.99)  # Central value
sigma = ROOT.RooRealVar("sigma", "sigma", 0.002, 0.0001, 0.01)  # Width parameter
gamma = ROOT.RooRealVar("gamma", "gamma", 0.1, -2.0, 2.0)  # Skewness parameter
#delta = ROOT.RooRealVar("delta", "delta", 0.6, 0.001, 3.0)  # Shape parameter
delta = ROOT.RooRealVar("delta", "delta", 0.6, 0.01, 2.0)  # Shape parameter
#x_bkg1_tau = ROOT.RooRealVar("x_bkg1_tau", "c0",-0.5, -20, 20)
x_bkg1_tau = ROOT.RooRealVar("x_bkg1_tau", "c0",-0.5, -5, 5)
...
mean_plus = ROOT.RooRealVar("mean_plus", "mean", 1.97, 1.95, 1.98)
sigma_plus = ROOT.RooRealVar("sigma_plus", "sigma", 0.002, 0.0001, 0.01)
gamma_plus = ROOT.RooRealVar("gamma_plus", "gamma", 0.1, -0.5, 0.5)
delta_plus = ROOT.RooRealVar("delta_plus", "delta", 0.6, 0.001, 3.0)
x_bkg1_tau_plus = ROOT.RooRealVar("x_bkg1_tau_plus", "c0",0.1, -20, 20)
...
fit_result = sim_model.fitTo(data_combined, RooFit.Save(), RooFit.Extended(True), RooFit.SumW2Error(True), ROOT.RooFit.NumCPU(8), RooFit.Strategy(0), ROOT.RooFit.Offset(True))
