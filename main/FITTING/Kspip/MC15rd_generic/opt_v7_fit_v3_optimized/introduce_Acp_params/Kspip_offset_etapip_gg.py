...
BDT_cut="0.80"
suffix = f"sumw2fixed_float_var_{args.float_var}"
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/MC15rd_Kspip_gg_fit_opt_loose_v7_fitv3_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/MC15rd_Kspip_gg_fit_opt_loose_v7_fitv3_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/MC15rd_Kspip_gg_fit_opt_loose_v7_fitv3_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.pdf"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/fitresult/MC15rd_1ab_Kspip_gg_fit_opt_loose_v7_fitv3_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/fitresult/MC15rd_1ab_Kspip_gg_fit_opt_loose_v7_fitv3_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/MC15rd/Kspip/gg/MC15rd_Kspip_gg_fit_opt_loose_v7_fitv3_Dp_{suffix}.root"
...
data = ROOT.RooDataSet("data","", mychain, ROOT.RooArgSet(x,Pip_charge, Dp_CMS_cosTheta, BDT,etapip_Eta_Easym,  Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane, Dp_cosHelicityAngleMomentum, Dp_CMS_p, rank_Dp_chiProb), cuts_Dp)
...
for i in file_list:
    mychain_cc.Add(i)
data_cc = ROOT.RooDataSet("data","", mychain_cc, ROOT.RooArgSet(x,Pip_charge, Dp_CMS_cosTheta, BDT,etapip_Eta_Easym, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane, Dp_cosHelicityAngleMomentum, Dp_CMS_p, rank_Dp_chiProb), cuts_Dm)

#data.append(data_cc)
Num_total_cc = data_cc.sumEntries()
print(Num_total_cc)

N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 2000000*scale*CMS_scale, 40000*scale*CMS_scale, 50000000*scale*CMS_scale)
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 400000*scale*CMS_scale,10000*scale*CMS_scale,10000000*scale*CMS_scale)
...
mean = ROOT.RooRealVar("mean", "mean", 1.87, 1.86, 1.88)  # Central value
...
mean_plus = ROOT.RooRealVar("mean_plus", "mean", 1.87, 1.86, 1.88)
...
mean_gauss = ROOT.RooRealVar("mean_gauss", "Gaussian mean", 0.0)
...
data_combined = RooDataSet("data_combined", "Combined data", RooArgList(x,  BDT, etapip_Eta_Easym, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane, Dp_cosHelicityAngleMomentum, Dp_CMS_p), RooFit.Index(cat),
