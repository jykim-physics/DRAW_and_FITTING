...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv1_Ds_Dp_{args.train}_Dp_CMS_{args.sign}_new_FOM.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv1_Ds_Dm_{args.train}_Dp_CMS_{args.sign}_new_FOM.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/fitresult/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv1_Ds_{args.train}_Dp_CMS_{args.sign}_new_FOM.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/KsKp/gg/generic/fitresult/MC15rd_Kspip_gg_K_fit_opt_loose_v7_fitv1_Ds_{args.train}_Dp_CMS_{args.sign}_new_FOM.txt"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 200000*scale, 20000*scale, 400000*scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 5000*scale,500*scale,30000*scale)
