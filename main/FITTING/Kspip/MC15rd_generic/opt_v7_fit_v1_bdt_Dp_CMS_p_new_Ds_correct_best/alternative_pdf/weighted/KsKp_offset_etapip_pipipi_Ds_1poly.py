...
BDT_cut = 0.92
suffix = f"{BDT_cut}_new_Ds_correct_1poly_wDpCMSp"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 250000*scale, 20000*scale, 500000*scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 100000*scale,500*scale,300000*scale)
...
x_bkg1_Cheby_c0 = ROOT.RooRealVar("x_bkg1_Cheby_c0", "c0",0.2, -1.0, 1.0)
