...
BDT_cut = 0.74
suffix = f"{BDT_cut}_new_Ds_correct_alternative_CB_gauss"
...
fitresult_name = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/fitresult/MC15rd_1ab_Kspip_pipipi_fit_opt_loose_v7_fitv1_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/fitresult/MC15rd_1ab_Kspip_pipipi_fit_opt_loose_v7_fitv1_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 1200000*scale*CMS_scale, 500000*scale*CMS_scale, 10000000*scale*CMS_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 300000*scale*CMS_scale,50000*scale*CMS_scale,10000000*scale*CMS_scale)
...
#gauss = ROOT.RooGaussian("gauss", "Gaussian PDF", x, mean, sigma_gauss)

# Perform the convolution
sig_model = ROOT.RooFFTConvPdf("sig_model", "Convolution of CB and Gaussian", x, CB, gauss)

#sig_frac = ROOT.RooRealVar("sig_frac", "fraction", 0.3, 0.0, 1.0)
#sig_model = ROOT.RooAddPdf("sig_model", "Gaus + JS", RooArgList(johnson, gauss), sig_frac)
