...
BDT_cut = 0.74
suffix = f"{BDT_cut}_new_Ds_correct_alternative_johnson_gauss"
...
sigma = ROOT.RooRealVar("sigma", "sigma", 0.002, 0.0001, 0.1)  # Width parameter
...
x_bkg1_tau = ROOT.RooRealVar("x_bkg1_tau", "c0",-0.5, -30, 30)
