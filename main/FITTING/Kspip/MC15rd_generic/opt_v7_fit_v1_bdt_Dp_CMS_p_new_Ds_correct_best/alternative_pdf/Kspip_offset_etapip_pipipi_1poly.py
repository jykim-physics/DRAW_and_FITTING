...
BDT_cut = 0.74
suffix = f"{BDT_cut}_new_Ds_correct_alternative_1poly"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 2000000*scale*CMS_scale, 40000*scale*CMS_scale, 50000000*scale*CMS_scale)  # N_total = N_D+ + N_D-
