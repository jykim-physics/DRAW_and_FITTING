...
BDT_cut = 0.83
suffix = f"{BDT_cut}_new_Ds_correct_alternative_1poly_exp"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 3000000*scale*CMS_scale, 500000*scale*CMS_scale, 5000000*scale*CMS_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 300000*scale*CMS_scale,50000*scale*CMS_scale,500000*scale*CMS_scale)
...
retrieved_pdf = ROOT.RooPolynomial("retrieved_pdf", "x_bkg1", x, ROOT.RooArgList(x_bkg1_Cheby_c0))
