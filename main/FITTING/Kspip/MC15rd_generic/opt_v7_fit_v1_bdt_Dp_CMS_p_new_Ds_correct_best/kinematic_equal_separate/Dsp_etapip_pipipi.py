...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/sys_separate_Dsp_etapip_pipipi_MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv1_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/sys_separate_Dsp_etapip_pipipi_MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv1_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/sys_separate_Dsp_etapip_pipipi_MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv1_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/fitresult/sys_separate_Dsp_etapip_pipipi_MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv1_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/fitresult/sys_separate_Dsp_etapip_pipipi_MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv1_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/MC15rd/Kspip/pipipi/sys_separate_Dsp_etapip_pipipi_MC15rd_Kspip_pipipi_fit_opt_loose_v7_fitv1_Dp_{suffix}.root"
...
for element in cm_elements:
    ...
    #pattern = f"{base_path}/{element}/{ref_tree}/{tree_name}/{BDT_cut}/{args.sign}/bdtg_Ds/*.BCS.bdtg.root"
    #pattern = f"{base_path}/{element}/{ref_tree}/{tree_name}/{BDT_cut}/{args.sign}/bdtg_Ds/ccbar.BCS.bdtg.root"
    #pattern = f"{base_path}/{element}/{ref_tree}/{tree_name}/{BDT_cut}/{args.sign}/bdtg_Ds/uubar.BCS.bdtg.root"
    #pattern = f"{base_path}/{element}/{ref_tree}/{tree_name}/{BDT_cut}/{args.sign}/bdtg_Ds/ddbar.BCS.bdtg.root"
    #pattern = f"{base_path}/{element}/{ref_tree}/{tree_name}/{BDT_cut}/{args.sign}/bdtg_Ds/ssbar.BCS.bdtg.root"
    #pattern = f"{base_path}/{element}/{ref_tree}/{tree_name}/{BDT_cut}/{args.sign}/bdtg_Ds/taupair.BCS.bdtg.root"
    #pattern = f"{base_path}/{element}/{ref_tree}/{tree_name}/{BDT_cut}/{args.sign}/bdtg_Ds/mixed.BCS.bdtg.root"
    #pattern = f"{base_path}/{element}/{ref_tree}/{tree_name}/{BDT_cut}/{args.sign}/bdtg_Ds/charged.BCS.bdtg.root"
    pattern = f"{base_path}/{element}/{ref_tree}/{tree_name}/{BDT_cut}/{args.sign}/bdtg_Ds/*.bdtg.root"
...
#bdtg_norm = ROOT.RooRealVar("bdtg_norm", "bdtg_norm", -1000, 1000)
...
#safe_expr = f"{scale} * max(bdtg_norm, 1e-5)"
#w_scaled = ROOT.RooFormulaVar("w_scaled", "Scaled Weight", safe_expr, ROOT.RooArgList(bdtg_norm))

before_data.addColumn(w_scaled)
before_data.get().Print("v")  # 현재 RooArgSet 내 변수 리스트 확인
