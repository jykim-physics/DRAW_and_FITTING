...
bdtg_norm = ROOT.RooRealVar("bdtg_norm", "bdtg_norm", -10000, 10000)
#bdtg_norm = ROOT.RooRealVar("bdtg_norm", "bdtg_norm", 1)
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 300000*scale, 20000*scale, 2000000*scale)  # N_total = N_D+ + N_D-
...
nll = sim_model.createNLL(data_combined, ROOT.RooFit.Extended(True), ROOT.RooFit.NumCPU(15),   ROOT.RooFit.Offset("initial"), RooFit.SumW2Error(True))
