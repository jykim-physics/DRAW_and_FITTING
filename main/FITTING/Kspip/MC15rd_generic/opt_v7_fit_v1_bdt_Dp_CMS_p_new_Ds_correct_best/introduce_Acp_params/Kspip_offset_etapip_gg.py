...
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/MC15rd_Kspip_gg_fit_opt_loose_v7_fitv1_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
...
file_sweight = f"/share/storage/jykim/sweight/MC15rd/Kspip/gg/MC15rd_Kspip_gg_fit_opt_loose_v7_fitv1_Dp_{suffix}.root"
...
before_data = ROOT.RooDataSet("data","", mychain, ROOT.RooArgSet(x,Pip_charge, Dp_CMS_cosTheta, BDT,etapip_Eta_Easym,  Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane, Dp_cosHelicityAngleMomentum, Dp_CMS_p), cuts_Dp)
...
for i in file_list:
    mychain_cc.Add(i)
before_data_cc = ROOT.RooDataSet("data","", mychain_cc, ROOT.RooArgSet(x,Pip_charge, Dp_CMS_cosTheta, BDT,etapip_Eta_Easym, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane, Dp_cosHelicityAngleMomentum, Dp_CMS_p), cuts_Dm)
...
data_combined = RooDataSet("data_combined", "Combined data", RooArgList(x, w_1, BDT, etapip_Eta_Easym, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane, Dp_cosHelicityAngleMomentum, Dp_CMS_p), RooFit.Index(cat),
