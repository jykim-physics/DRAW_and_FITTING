...
BDT_cut = 0.92
suffix = f"{BDT_cut}_new_Ds_correct_float_var_{args.float_var}_wDpCMSp"
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/KsKp/pipipi/generic/MC15rd_Kspip_pipipi_K_fit_opt_loose_v7_fitv1_Ds_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/KsKp/pipipi/generic/MC15rd_Kspip_pipipi_K_fit_opt_loose_v7_fitv1_Ds_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/KsKp/pipipi/generic/MC15rd_Kspip_pipipi_K_fit_opt_loose_v7_fitv1_Ds_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/KsKp/pipipi/generic/fitresult/MC15rd_Kspip_pipipi_K_fit_opt_loose_v7_fitv1_Ds_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/KsKp/pipipi/generic/fitresult/MC15rd_Kspip_pipipi_K_fit_opt_loose_v7_fitv1_Ds_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/MC15rd/KsKp/pipipi/MC15rd_Kspip_pipipi_K_fit_opt_loose_v7_fitv1_Ds_{suffix}.root"
...
#before_data = ROOT.RooDataSet("data","", mychain, ROOT.RooArgSet(x,Pip_charge, Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane,  Dp_cosHelicityAngleMomentum, Dp_CMS_p), cuts_Dp)
...
for i in file_list:
    mychain_cc.Add(i)
#before_data_cc = ROOT.RooDataSet("data","", mychain_cc, ROOT.RooArgSet(x,Pip_charge,Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane,  Dp_cosHelicityAngleMomentum, Dp_CMS_p), cuts_Dm)
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 200000*scale, 20000*scale, 350000*scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 100000*scale,500*scale,200000*scale)
...
sigma_gauss = ROOT.RooRealVar("sigma_gauss", "Gaussian width", 0.002, 0.0001, 0.01)
...
mean_plus = ROOT.RooRealVar("mean_plus", "mean", 1.96, 1.94, 1.98)
sigma_plus = ROOT.RooRealVar("sigma_plus", "sigma", 0.002, 0.0001, 0.01)
gamma_plus = ROOT.RooRealVar("gamma_plus", "gamma", 0.1, -2.0, 2.0)
delta_plus = ROOT.RooRealVar("delta_plus", "delta", 0.6, 0.001, 3.0)
x_bkg1_tau_plus = ROOT.RooRealVar("x_bkg1_tau_plus", "c0",-3, -10, 10)
#x_bkg1_tau_plus = ROOT.RooRealVar("x_bkg1_tau_plus", "c0",-0.5, -3, 3)
sigma_gauss_plus = ROOT.RooRealVar("sigma_gauss_plus", "Gaussian width", 0.002, 0.0001, 0.01)
...
frame_D_plus.GetXaxis().SetTitle("M(K_{S}^{0}K^{+}) [GeV/c^{2}]")
...
frame_D_minus.GetXaxis().SetTitle("M(K_{S}^{0}K^{-}) [GeV/c^{2}]")
...
frame_D_all.GetXaxis().SetTitle("M(K_{S}^{0}K^{+}) [GeV/c^{2}]")
