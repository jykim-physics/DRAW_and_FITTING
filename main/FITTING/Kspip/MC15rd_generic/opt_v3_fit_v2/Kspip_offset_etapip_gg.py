...
file_name_Dp = "/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/MC15rd_Kspip_gg_fit_opt_loose_v3_fitv2_Dp.png"
file_name_Dm = "/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/MC15rd_Kspip_gg_fit_opt_loose_v3_fitv2_Dm.png"
fitresult_name = "/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/fitresult/MC15rd_1ab_Kspip_gg_fit_opt_loose_v3_fitv2.root"
fitresult_text = "/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/fitresult/MC15rd_1ab_Kspip_gg_fit_opt_loose_v3_fitv2.txt"
...
# Open the ROOT file
input_file = TFile("../../MC15rd_sig/all/keys_pdf_MC15rd_etapip_gg.root", "READ")
...
#N_misID_Dp = RooRealVar("N_misID_Dp", "N", 3101)
#N_misID_Dm = RooRealVar("N_misID_Dm", "N", 3178)
N_misID_Dp = RooRealVar("N_misID_Dp", "N", 3101, 1000, 5000)
N_misID_Dm = RooRealVar("N_misID_Dm", "N", 3178, 1000, 5000)
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 1400000*scale, 100000*scale, 2200000*scale)  # N_total = N_D+ + N_D-
...
#Nbkg_D_plus = ROOT.RooRealVar("Nbkg_D_plus", "Number of background events for D+", 100000*scale, 60000*scale, 280000*scale)
#Nbkg_D_minus = ROOT.RooRealVar("Nbkg_D_minus", "Number of background events for D-", 100000*scale,60000*scale, 280000*scale)
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 200000*scale,120000*scale,560000*scale)
...
#mean = ROOT.RooRealVar("mean", "mean", 1.96, 1.94, 2.0)
...
#bkg_frac = ROOT.RooRealVar("bkg_frac", "fraction of Gaussian in BKG", 0.1, 0.01,1)
...
model_D_plus = ROOT.RooAddPdf("model_D_plus", "D+ model",
                              ROOT.RooArgList(sig_model,  model_bkg, retrieved_pdf),
                              ROOT.RooArgList(Nsig_D_plus,  Nbkg_D_plus, N_misID_Dp))
model_D_minus = ROOT.RooAddPdf("model_D_minus", "D- model",
                              ROOT.RooArgList(sig_model,  model_bkg, retrieved_pdf),
                              ROOT.RooArgList(Nsig_D_minus,  Nbkg_D_minus, N_misID_Dm))
