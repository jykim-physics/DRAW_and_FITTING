...
file_name_Dp = "/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/MC15rd_Kspip_pipipi_K_fit_opt_loose_v7_fitv1_Dp.png"
file_name_Dm = "/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/MC15rd_Kspip_pipipi_K_fit_opt_loose_v7_fitv1_Dm.png"
fitresult_name = "/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/fitresult/MC15rd_Kspip_pipipi_K_fit_opt_loose_v7_fitv1.root"
fitresult_text = "/share/storage/jykim/plots/MC15rd/Kspip/pipipi/generic/fitresult/MC15rd_Kspip_pipipi_K_fit_opt_loose_v7_fitv1.txt"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 2000000*scale, 200000*scale, 2800000*scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 200000*scale,50000*scale,600000*scale)
...
sigma = ROOT.RooRealVar("sigma", "sigma", 0.005, 0.00001, 0.1)  # Width parameter
gamma = ROOT.RooRealVar("gamma", "gamma", 0.5, 0.0, 5.0)  # Skewness parameter
delta = ROOT.RooRealVar("delta", "delta", 0.1, 0.001, 5.0)  # Shape parameter
