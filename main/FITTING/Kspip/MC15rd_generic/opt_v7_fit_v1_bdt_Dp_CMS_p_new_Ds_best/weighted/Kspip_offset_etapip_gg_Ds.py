...
suffix = "0.92"
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/MC15rd_Kspip_gg_fit_opt_loose_v7_fitv1_Ds_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}_wDpCMSp.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/MC15rd_Kspip_gg_fit_opt_loose_v7_fitv1_Ds_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}_wDpCMSp.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/fitresult/MC15rd_Kspip_gg_fit_opt_loose_v7_fitv1_Ds_{args.train}_Dp_CMS_{args.sign}_{suffix}_wDpCMSp.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/generic/fitresult/MC15rd_Kspip_gg_fit_opt_loose_v7_fitv1_Ds_{args.train}_Dp_CMS_{args.sign}_{suffix}_wDpCMSp.txt"
file_sweight = f"/share/storage/jykim/sweight/MC15rd/Kspip/gg/MC15rd_Kspip_gg_fit_opt_loose_v7_fitv1_Ds_{suffix}_wDpCMSp.root"
...
for element in cm_elements:
    ...
    pattern = f"{base_path}/{element}/{ref_tree}/{tree_name}/0.83/weighted/weighted*.BCS.root"
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+",  20000*scale,1000*scale,200000*scale)
