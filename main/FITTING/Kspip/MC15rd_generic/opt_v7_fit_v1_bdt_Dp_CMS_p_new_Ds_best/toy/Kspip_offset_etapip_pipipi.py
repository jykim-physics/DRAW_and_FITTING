...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 1400000*scale*CMS_scale, 40000*scale*CMS_scale, 2500000*scale*CMS_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 400000*scale*CMS_scale,10000*scale*CMS_scale,500000*scale*CMS_scale)
