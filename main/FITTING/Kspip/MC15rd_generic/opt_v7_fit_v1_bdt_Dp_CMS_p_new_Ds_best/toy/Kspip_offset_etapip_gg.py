...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 1200000*scale*CMS_scale, 50000*scale*CMS_scale, 2400000*scale*CMS_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 300000*scale*CMS_scale,5000*scale*CMS_scale,600000*scale*CMS_scale)
