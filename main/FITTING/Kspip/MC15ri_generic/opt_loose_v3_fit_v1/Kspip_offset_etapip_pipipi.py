...
file_name_Dp = "/share/storage/jykim/plots/MC15ri/Kspip/pipipi/generic/MC15ri_1ab_etapip_pipipi_fit_opt_loose_v2_fitv2_Dp.png"
file_name_Dm = "/share/storage/jykim/plots/MC15ri/Kspip/pipipi/generic/MC15ri_1ab_etapip_pipipi_fit_opt_loose_v2_fitv2_Dm.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/Kspip/pipipi/generic/fitresult/MC15ri_1ab_etapip_pipipi_fit_opt_loose_v2_fitv2.root"
fitresult_text = "/share/storage/jykim/plots/MC15ri/Kspip/pipipi/generic/fitresult/MC15ri_1ab_etapip_pipipi_fit_opt_loose_v2_fitv2.txt"
...
# Open the ROOT file
input_file = TFile("../../MC15ri_sig/all/keys_pdf_MC15ri_etapip_pipipi.root", "READ")

# Retrieve the RooKeysPdf
retrieved_pdf = input_file.Get("jykim")

# Check if retrieval was successful
if retrieved_pdf:
    print("Successfully loaded RooKeysPdf from the file!")
else:
    print("Failed to load RooKeysPdf.")

ROOT.gROOT.LoadMacro('/home/jykim/workspace/DRAW_and_FITTING/main/FITTING/Belle2Style.C')
ROOT.SetBelle2Style()

file_list = ['/share/storage/jykim/storage_b2/storage/reduced_ntuples/MC15ri/Kspip/MC15ri_Kspip_loose_v2_241119/Ks/etapip_pipipi/MC15ri*.BCS.root']
...
before_data = ROOT.RooDataSet("data","", mychain, ROOT.RooArgSet(x,Pip_charge,Pip_kaonID), cuts_Dp)
...
for i in file_list:
    mychain_cc.Add(i)
before_data_cc = ROOT.RooDataSet("data","", mychain_cc, ROOT.RooArgSet(x,Pip_charge, Pip_kaonID), cuts_Dm)
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 1000000*scale, 500000*scale, 1400000*scale)  # N_total = N_D+ + N_D-
...
Nbkg_D_plus = ROOT.RooRealVar("Nbkg_D_plus", "Number of background events for D+", 100000*scale, 60000*scale, 200000*scale)
Nbkg_D_minus = ROOT.RooRealVar("Nbkg_D_minus", "Number of background events for D-", 100000*scale,60000*scale, 200000*scale)
