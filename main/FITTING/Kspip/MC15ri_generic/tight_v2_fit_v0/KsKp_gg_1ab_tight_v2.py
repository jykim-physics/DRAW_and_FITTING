...
file_name = "/share/storage/jykim/plots/MC15ri/Kspip/generic/MC15ri_1ab_KsKp_fit_tight_v2_fitv0.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/Kspip/generic/fitresult/MC15ri_1ab_KsKp_fit_tight_v2.root"
...
sigma_gauss = ROOT.RooRealVar("sigma_gauss", "sigma", 0.0005, 0.0001, 0.1)
gauss = ROOT.RooGaussian("gauss", "gauss", x, mean, sigma_gauss)

sigma_gauss2 = ROOT.RooRealVar("sigma_gauss2", "sigma", 0.002, 0.0001, 0.1)
...
#Ds_gauss = ROOT.RooGaussian("Ds_gauss", "Ds_gauss", x, Ds_mean, Ds_sigma)

#Ds_sigma2 = ROOT.RooRealVar("Ds_sigma2", "sigma", 0.02, 0.001, 0.1)
#Ds_gauss2 = ROOT.RooGaussian("Ds_gauss2", "Ds_gauss", x, Ds_mean, Ds_sigma2)

#Ds_fraction = ROOT.RooRealVar("sig_fraction", "fraction", 0.5, 0.0, 1.0)
#Ds_model = ROOT.RooAddPdf("Ds_model", "Ds_model", ROOT.RooArgList(Ds_gauss, Ds_gauss2),ROOT.RooArgList(Ds_fraction))
