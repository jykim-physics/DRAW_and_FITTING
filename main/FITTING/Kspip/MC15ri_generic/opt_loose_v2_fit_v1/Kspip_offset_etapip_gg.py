...
file_name_Dp = "/share/storage/jykim/plots/MC15ri/Kspip/gg/generic/MC15ri_1ab_etapip_gg_fit_opt_loose_v2_fitv1_Dp.png"
file_name_Dm = "/share/storage/jykim/plots/MC15ri/Kspip/gg/generic/MC15ri_1ab_etapip_gg_fit_opt_loose_v2_fitv1_Dm.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/Kspip/gg/generic/fitresult/MC15ri_1ab_etapip_gg_fit_opt_loose_v2_fitv1.root"
fitresult_text = "/share/storage/jykim/plots/MC15ri/Kspip/gg/generic/fitresult/MC15ri_1ab_etapip_gg_fit_opt_loose_v2_fitv1.txt"
...
# Open the ROOT file
input_file = TFile("../../MC15ri_sig/all/keys_pdf_MC15ri_etapip_gg.root", "READ")
...
file_list = ['/share/storage/jykim/storage_b2/storage/reduced_ntuples/MC15ri/Kspip/MC15ri_Kspip_loose_v2_241119/Ks/etapip_gg/MC15ri*.BCS.root']
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 700000*scale, 50000*scale, 800000*scale)  # N_total = N_D+ + N_D-
...
Nbkg_D_plus = ROOT.RooRealVar("Nbkg_D_plus", "Number of background events for D+", 50000*scale, 30000*scale, 100000*scale)
Nbkg_D_minus = ROOT.RooRealVar("Nbkg_D_minus", "Number of background events for D-", 50000*scale,30000*scale, 100000*scale)
