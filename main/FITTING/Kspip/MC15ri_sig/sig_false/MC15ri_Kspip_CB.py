...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15ri/Kspip/MC15ri_1M_Kspip_Dp_M_tight_v1_sigDistance_CB_false.png"
...
model = ROOT.RooCrystalBall("CB", "CB_left", x, mean_gaussian, sigma, alphaL, nL, alphaR, nR)
