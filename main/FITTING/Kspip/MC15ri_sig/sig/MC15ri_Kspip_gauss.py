...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15ri/Kspip/MC15ri_1M_Kspip_Dp_M_tight_v1_sigDistance_gauss.png"
...
sigma_left = ROOT.RooRealVar("sigma_left", "sigma_left", 0.002, 0.00001, 0.1)
sigma_right = ROOT.RooRealVar("sigma_right", "sigma_right", 0.002, 0.00001, 0.1)
...
model = ROOT.RooAddPdf("model", "model", ROOT.RooArgList(gaussian, bifurcated_gaussian), ROOT.RooArgList(frac))
...
model.plotOn(frame, ROOT.RooFit.Name("bifurcated_gaussian"),ROOT.RooFit.Components("bifurcated_gaussian"), ROOT.RooFit.LineStyle(ROOT.kDashed), ROOT.RooFit.LineColor(ROOT.kGreen+2))
...
leg1.AddEntry("bifurcated_gaussian", "bifurcated gaussian", "l")
leg1.AddEntry("gaussian", "gaussian", "l")
