...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15ri/Kspip/MC15ri_misID_etapip_pipipi.png"
...
mychain.Add("/share/storage/jykim/storage_b2/storage/reduced_ntuples/MC15ri/Kspip/MC15ri_Kspip_loose_v2_241122_onlyDs_and_DptoetaKp/Ks/etapip_pipipi/*.root")

mychain_cc = ROOT.TChain(tree_name)
mychain_cc.Add("/share/storage/jykim/storage_b2/storage/reduced_ntuples/MC15ri/Kspip/MC15ri_Kspip_loose_v2_241122_onlyDs_and_DptoetaKp/Ks/etapip_pipipi/*.root")
...
output_file = TFile("keys_pdf_MC15ri_etapip_pipipi.root", "RECREATE")  # Create a ROOT file
