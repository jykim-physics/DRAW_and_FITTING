...
base_plot_dir = "/share/storage/jykim/plots/proc13/KsKp/pipipi/generic"
base_fit_dir = f"{base_plot_dir}/fitresult"

fitresult_name_plus = (
    f"{base_fit_dir}/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Ds_{args.train}_Dp_CMS_plus_{suffix}.root"
)
fitresult_name_minus = (
    f"{base_fit_dir}/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Ds_{args.train}_Dp_CMS_minus_{suffix}.root"
)
...
if args.output:
    ...
    file_name_out = (
        f"{base_plot_dir}/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Ds_Dall_{args.train}_Dp_CMS_signAvg_{suffix}.pdf"
    )
