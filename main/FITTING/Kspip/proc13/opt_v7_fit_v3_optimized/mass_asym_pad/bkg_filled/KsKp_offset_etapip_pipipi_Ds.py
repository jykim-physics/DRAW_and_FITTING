...
file_name_Dp = f"/share/storage/jykim/plots/proc13/KsKp/pipipi/generic/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Ds_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/proc13/KsKp/pipipi/generic/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Ds_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/proc13/KsKp/pipipi/generic/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Ds_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.pdf"
fitresult_name = f"/share/storage/jykim/plots/proc13/KsKp/pipipi/generic/fitresult/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Ds_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/proc13/KsKp/pipipi/generic/fitresult/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Ds_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/proc13/KsKp/pipipi/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Ds_{suffix}.root"
...
#cuts_Dp = charge_var + "==1 && rank_BDT==1"
#cuts_Dm = charge_var + "==-1 && rank_BDT==1"
...
rank_BDT = ROOT.RooRealVar("rank_BDT", "rank_BDT", 0, 1000)

data = ROOT.RooDataSet("data","", mychain, ROOT.RooArgSet(x,Pip_charge, Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane,  Dp_cosHelicityAngleMomentum, Dp_CMS_p, rank_Dp_chiProb, rank_BDT), cuts_Dp)
...
for i in file_list:
    mychain_cc.Add(i)
data_cc = ROOT.RooDataSet("data","", mychain_cc, ROOT.RooArgSet(x,Pip_charge,Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane,  Dp_cosHelicityAngleMomentum, Dp_CMS_p, rank_Dp_chiProb, rank_BDT), cuts_Dm)
