...
file_name_Dp = f"/share/storage/jykim/plots/proc13/Kspip/gg/generic/proc13_Kspip_gg_fit_opt_loose_v7_fitv3_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/proc13/Kspip/gg/generic/proc13_Kspip_gg_fit_opt_loose_v7_fitv3_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/proc13/Kspip/gg/generic/proc13_Kspip_gg_fit_opt_loose_v7_fitv3_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.pdf"
fitresult_name = f"/share/storage/jykim/plots/proc13/Kspip/gg/generic/fitresult/proc13_1ab_Kspip_gg_fit_opt_loose_v7_fitv3_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/proc13/Kspip/gg/generic/fitresult/proc13_1ab_Kspip_gg_fit_opt_loose_v7_fitv3_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/proc13/Kspip/gg/proc13_Kspip_gg_fit_opt_loose_v7_fitv3_Dp_{suffix}.root"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 2000000*scale*CMS_scale, 400000*scale*CMS_scale, 20000000*scale*CMS_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 200000*scale*CMS_scale,50000*scale*CMS_scale,10000000*scale*CMS_scale)
