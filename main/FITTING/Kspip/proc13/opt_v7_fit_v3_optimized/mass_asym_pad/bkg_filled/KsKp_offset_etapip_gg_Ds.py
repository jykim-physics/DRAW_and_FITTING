...
file_name_Dp = f"/share/storage/jykim/plots/proc13/KsKp/gg/generic/proc13_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/proc13/KsKp/gg/generic/proc13_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/proc13/KsKp/gg/generic/proc13_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.pdf"
fitresult_name = f"/share/storage/jykim/plots/proc13/KsKp/gg/generic/fitresult/proc13_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/proc13/KsKp/gg/generic/fitresult/proc13_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/proc13/KsKp/gg/proc13_Kspip_gg_K_fit_opt_loose_v7_fitv3_Ds_{suffix}.root"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 200000*scale, 20000*scale, 1000000*scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 100000*scale,500*scale,2000000*scale)
...
leg1.AddEntry("Background", "Bkg", "f")
