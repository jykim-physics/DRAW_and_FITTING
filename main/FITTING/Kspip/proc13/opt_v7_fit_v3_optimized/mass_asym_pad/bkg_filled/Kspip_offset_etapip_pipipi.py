...
file_name_Dp = f"/share/storage/jykim/plots/proc13/Kspip/pipipi/generic/proc13_Kspip_pipipi_fit_opt_loose_v7_fitv3_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/proc13/Kspip/pipipi/generic/proc13_Kspip_pipipi_fit_opt_loose_v7_fitv3_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/proc13/Kspip/pipipi/generic/proc13_Kspip_pipipi_fit_opt_loose_v7_fitv3_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.pdf"
fitresult_name = f"/share/storage/jykim/plots/proc13/Kspip/pipipi/generic/fitresult/proc13_Kspip_pipipi_fit_opt_loose_v7_fitv3_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/proc13/Kspip/pipipi/generic/fitresult/proc13_Kspip_pipipi_fit_opt_loose_v7_fitv3_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/proc13/Kspip/pipipi/proc13_Kspip_pipipi_fit_opt_loose_v7_fitv3_Dp_{suffix}.root"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 1500000*scale*CMS_scale, 40000*scale*CMS_scale, 50000000*scale*CMS_scale)
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 400000*scale*CMS_scale,50000*scale*CMS_scale,80000000*scale*CMS_scale)
...
fit_result = sim_model.fitTo(data_combined, RooFit.Save(), RooFit.Extended(True),  ROOT.RooFit.NumCPU(4), RooFit.Strategy(1), ROOT.RooFit.Offset("initial"))
...
leg1.AddEntry("Background", "#font[42]{Background}", "l")
...
leg1.AddEntry("data", "#font[42]{Data}", "PE")
leg1.AddEntry("Fitting", "#font[42]{Fit}", "l")
leg1.AddEntry("Background", "#font[42]{Background}", "f")
leg1.SetBorderSize(0)
leg1.Draw()
