...
for element in cm_elements:
    ...
    pattern = f"{base_path}/{element}/{ref_tree}/{tree_name}/0.92/*.BCS.root"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 300000*scale, 20000*scale, 500000*scale)  # N_total = N_D+ + N_D-
