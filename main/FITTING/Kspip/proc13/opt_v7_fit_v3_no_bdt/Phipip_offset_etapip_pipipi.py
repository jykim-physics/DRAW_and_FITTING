...
suffix = "no_bdt"
file_name_Dp = f"/share/storage/jykim/plots/proc13/Phipip/pipipi/generic/proc13_Phipip_pipipi_fit_opt_loose_v7_fitv3_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/proc13/Phipip/pipipi/generic/proc13_Phipip_pipipi_fit_opt_loose_v7_fitv3_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/proc13/Phipip/pipipi/generic/proc13_Phipip_pipipi_fit_opt_loose_v7_fitv3_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
fitresult_name = f"/share/storage/jykim/plots/proc13/Phipip/pipipi/generic/fitresult/proc13_Phipip_pipipi_fit_opt_loose_v7_fitv3_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/proc13/Phipip/pipipi/generic/fitresult/proc13_Phipip_pipipi_fit_opt_loose_v7_fitv3_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/proc13/Phipip/pipipi/proc13_Phipip_pipipi_fit_opt_loose_v7_fitv3_Dp_{suffix}.root"
...
cm_elements = ["KsHp_13_4S_off_v1", "KsHp_13_4S_v3", "KsHp_23_4S_off_v1", "KsHp_23_4S_v1", "KsHp_23_5Sscan_10657_v1", "KsHp_23_5Sscan_10706_v1", "KsHp_23_5Sscan_10751_v1", "KsHp_23_5Sscan_10810_v1"]
...
data = ROOT.RooDataSet("data","", mychain, ROOT.RooArgSet(x,Pip_charge,Pip_kaonID, Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane,  Dp_cosHelicityAngleMomentum, Dp_CMS_p, rank_Dp_chiProb), cuts_Dp)
...
for i in file_list:
    mychain_cc.Add(i)
data_cc = ROOT.RooDataSet("data","", mychain_cc, ROOT.RooArgSet(x,Pip_charge, Pip_kaonID, Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane,  Dp_cosHelicityAngleMomentum, Dp_CMS_p, rank_Dp_chiProb), cuts_Dm)

#data.append(data_cc)
Num_total_cc = data_cc.sumEntries()
print(Num_total_cc)

#N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 2500000*scale*CMS_scale, 400000*scale*CMS_scale, 50000000*scale*CMS_scale)  # N_total = N_D+ + N_D-
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 20000000*scale*CMS_scale, 400000*scale*CMS_scale, 50000000*scale*CMS_scale)  # N_total = N_D+ +    N_D-
...
#Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 4000000*scale*CMS_scale,100000*scale*CMS_scale,80000000*scale*CMS_scale)
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 4000000*scale*CMS_scale,100000*scale*CMS_scale,10000000*scale*CMS_scale)
...
mean = ROOT.RooRealVar("mean", "mean", 1.97, 1.95, 1.99)  # Central value
...
#bkg_comb = ROOT.RooPolynomial("bkg_comb", "x_bkg1", x, ROOT.RooArgList(x_bkg1_Cheby_c0))
#model_bkg = ROOT.RooPolynomial("model_bkg", "x_bkg1", x, ROOT.RooArgList(x_bkg1_Cheby_c0))

#bkg_frac = ROOT.RooRealVar("bkg_frac", "fraction of Gaussian in BKG", 0.001, 0.00, 1.0)
...
data_combined = RooDataSet("data_combined", "Combined data", RooArgList(x, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane,  Dp_cosHelicityAngleMomentum, Dp_CMS_p), RooFit.Index(cat),
...
frame_D_plus.GetXaxis().SetTitle("M(#phi#pi^{+}) [GeV/c^{2}]")
...
frame_D_minus.GetXaxis().SetTitle("M(#phi#pi^{-}) [GeV/c^{2}]")
...
frame_D_all.GetXaxis().SetTitle("M(#phi#pi^{+}) [GeV/c^{2}]")
