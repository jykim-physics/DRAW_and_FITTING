...
suffix = "no_bdt"
file_name_Dp = f"/share/storage/jykim/plots/proc13/KsKp/pipipi/generic/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Dpregion_Dp_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/proc13/KsKp/pipipi/generic/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Dpregion_Dm_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/proc13/KsKp/pipipi/generic/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Dpregion_Dall_{args.train}_Dp_CMS_{args.sign}_{suffix}.png"
fitresult_name = f"/share/storage/jykim/plots/proc13/KsKp/pipipi/generic/fitresult/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Dpregion_{args.train}_Dp_CMS_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/proc13/KsKp/pipipi/generic/fitresult/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Dpregion_{args.train}_Dp_CMS_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/proc13/KsKp/pipipi/proc13_Kspip_pipipi_K_fit_opt_loose_v7_fitv3_Dpregion_{suffix}.root"
...
data = ROOT.RooDataSet("data","", mychain, ROOT.RooArgSet(x,Pip_charge,Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane, etapip_Eta_Easym, Dp_cosHelicityAngleMomentum, Dp_CMS_p,rank_Dp_chiProb), cuts_Dp)
...
for i in file_list:
    mychain_cc.Add(i)
data_cc = ROOT.RooDataSet("data","", mychain_cc, ROOT.RooArgSet(x,Pip_charge,Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane, etapip_Eta_Easym, Dp_cosHelicityAngleMomentum, Dp_CMS_p,rank_Dp_chiProb), cuts_Dm)
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 1500000*scale,500*scale,4000000*scale)
...
data_combined = RooDataSet("data_combined", "Combined data", RooArgList(x,  BDT, Pip_dr, Dp_dz, Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane, etapip_Eta_Easym, Dp_cosHelicityAngleMomentum, Dp_CMS_p), RooFit.Index(cat),
...
nll = sim_model.createNLL(data_combined, ROOT.RooFit.Extended(True), ROOT.RooFit.NumCPU(15),   ROOT.RooFit.Offset("initial"), RooFit.Strategy(2))
