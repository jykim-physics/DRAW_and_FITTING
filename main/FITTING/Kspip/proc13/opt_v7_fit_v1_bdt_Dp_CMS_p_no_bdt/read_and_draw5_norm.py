...
h_data.Scale(1.0 / h_data.Integral())  # Normalize data histogram
h_MC.Scale(1.0 / h_MC.Integral())  # Normalize MC histogram
...
h_MC.Draw("PE SAME")  # Draw MC histogram
...
cdata_mc.SaveAs("data_and_mc_norm.png")
