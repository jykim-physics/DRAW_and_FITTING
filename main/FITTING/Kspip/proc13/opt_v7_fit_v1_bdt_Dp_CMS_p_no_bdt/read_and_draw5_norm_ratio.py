...
pad1.cd()
h_data.Draw("PE")  # Overlay data histogram
h_MC.Draw("PE SAME")  # MC histogram
...
#h_ratio.SetMinimum(0.5)  # Set lower limit of the ratio plot
#h_ratio.SetMaximum(1.5)  # Set upper limit of the ratio plot (adjust as needed)
...
cdata_mc.SaveAs("data_and_mc_ratio_norm.png")
