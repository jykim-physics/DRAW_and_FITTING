...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15rd/Kspip/MC15rd_misID_etapip_pipipi.png"
...
cuts_Dp = "abs(Pip_mcPDG)==321 & Pip_charge==1"
cuts_Dm = "abs(Pip_mcPDG)==321 & Pip_charge==-1"
...
Pip_mcPDG = ROOT.RooRealVar(Pip_mcPDG_var, charge_var, -1e7, 1e7)
...
for element in cm_elements:
    pattern = f"{base_path}/{element}/{ref_tree}/{tree_name}/ccbar.BCS.root"
...
before_data = ROOT.RooDataSet("data","", mychain, ROOT.RooArgSet(x,Pip_charge, Pip_mcPDG), cuts_Dp)
...
before_data_cc = ROOT.RooDataSet("data","", mychain_cc, ROOT.RooArgSet(x,Pip_charge, Pip_mcPDG), cuts_Dm)
...
output_file = TFile("keys_pdf_MC15rd_etapip_pipipi.root", "RECREATE")  # Create a ROOT file
