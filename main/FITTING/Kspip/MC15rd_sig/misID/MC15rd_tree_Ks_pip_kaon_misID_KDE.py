...
ROOT.SetBelle2Style()
file_name = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/KDE_MC15rd_Kspip_gg_kaon_misID_Dp_M_v3_true_extended_train_Dp_CMS_p_0.80.{args.sign}.png"
result_name = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/KDE_MC15rd_Kspip_gg_kaon_misID_Dp_M_v3_result_true_extended_train_Dp_CMS_p_0.80.{args.sign}.txt"
fitresult_root = f"/share/storage/jykim/plots/MC15rd/Kspip/gg/KDE_MC15rd_Kspip_gg_kaon_misID_Dp_M_v3_result_true_extended_train_Dp_CMS_p.0.80.{args.sign}.root"
...
cuts_Dp = (f"Pip_charge==1 && rank_Dp_chiProb==1 && {Dp_CMS_cosTheta_cut} && "
           ...
           "etapip_Eta_genMotherPDG == 431 && Pip_mcPDG == 321)")
