...
####################
#D0_M
x = ROOT.RooRealVar("M(D^{0})", "M(D^{0}) [GeV/c^{2}]", 1.7, 2.03, "")
...
#phi pi0
x_bkg1_mean = ROOT.RooRealVar("x_bkg1_mean", "mean of gaussians", 1.82,1.81, 1.84)
...
r = extended_model.fitTo(data,NumCPU=11, Extended=ROOT.kTRUE)
...
frame3 = mcstudy.plotPull(nsig, Bins=50, FitGauss=True)
...
c = ROOT.TCanvas("rf801_mcstudy", "rf801_mcstudy", 900, 300)
c.Divide(3, 1)
c.cd(1)
