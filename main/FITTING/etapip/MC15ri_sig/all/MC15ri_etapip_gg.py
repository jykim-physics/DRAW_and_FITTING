...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15ri/etapip/gg/MC15ri_1M_etapip_gg_Dp_M_tight_v2_johnson.png"
...
mean = ROOT.RooRealVar("mean", "mean of Johnson", 1.86, 1.8, 1.9)
sigma = ROOT.RooRealVar("sigma", "sigma of Johnson", 1, 0.01, 10)
gamma = ROOT.RooRealVar("gamma", "gamma of Johnson", 1, 0.01, 10)
delta = ROOT.RooRealVar("delta", "delta of Johnson", 1, 0.01, 10)

# Create a Johnson distribution
model = ROOT.RooJohnson("CB_left", "Johnson PDF", x, mean, sigma, gamma, delta)
