...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15ri/etaKp/pipipi/MC15ri_1M_etaKp_pipipi_Dp_M_tight_v2_all_gauss_CB.png"
...
mychain.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15ri_sigMC/DptoetaKp_pipipi/240419_tight_v2_Kp_BCS_etapi0const/*.root")
...
CB = ROOT.RooCrystalBall("CB_left", "CB_left", x, mean, sigma, alphaL, nL, alphaR, nR)
...
model = ROOT.RooAddPdf("model", "model", ROOT.RooArgList(CB, gauss),ROOT.RooArgList(fraction))
#model = CB_lef
...
model.plotOn(frame, ROOT.RooFit.Name("CB"),ROOT.RooFit.Components("CB_left"), ROOT.RooFit.LineStyle(ROOT.kDashed), ROOT.RooFit.LineColor(ROOT.kRed))
model.plotOn(frame, ROOT.RooFit.Name("Gauss"),ROOT.RooFit.Components("gauss"), ROOT.RooFit.LineStyle(ROOT.kDashed), ROOT.RooFit.LineColor(ROOT.kViolet))
