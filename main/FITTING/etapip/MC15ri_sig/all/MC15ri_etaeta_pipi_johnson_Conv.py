...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15ri/etaeta/pipi/MC15ri_1M_etaeta_pipi_Dp_M_tight_v3_johnson_conv.png"
result_name = "/share/storage/jykim/plots/MC15ri/etaeta/pipi/MC15ri_1M_etaeta_pipi_Dp_M_tight_v3_johnson_conv_result.txt"
...
mychain.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15ri_sigMC/Dtoetaeta_pipipi_pipipi/241014_tight_v3/etaeta_pipi_tag/*.root")

tree_name_cc = "etaeta_gg_tag"
mychain_cc = ROOT.TChain(tree_name_cc)
mychain_cc.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15ri_sigMC/Dtoetaeta_pipipi_pipipi_cc/241014_tight_v3/etaeta_pipi_tag/*.root")
...
# Perform the fit
result = model.fitTo(data, ROOT.RooFit.Range("fitRange"), ROOT.RooFit.NumCPU(4), ROOT.RooFit.Save(), ROOT.RooFit.Strategy(1))
result.Print()
