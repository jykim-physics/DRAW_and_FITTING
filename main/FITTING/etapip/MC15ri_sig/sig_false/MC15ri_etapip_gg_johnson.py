...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15ri/etapip/gg/MC15ri_1M_etapip_gg_Dp_M_tight_v1_false_johnson.png"
...
# Define parameters for the double-sided Johnson PDF
mean = ROOT.RooRealVar("mean", "mean", 1.86, 1.8, 2.0)
width = ROOT.RooRealVar("width", "width", 0.02, 0.001, 0.5)
gamma = ROOT.RooRealVar("gamma", "gamma", 1.0, 0.0, 20.0)
delta = ROOT.RooRealVar("delta", "delta", 1.0, 0.0, 10.0)

# Create double-sided Johnson PDF
model = ROOT.RooJohnson("Johnson", "Johnson", x, mean, width, gamma, delta)
