...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15ri/etapip/gg/MC15ri_1M_etapip_gg_Dp_M_tight_v1_false_poly.png"
...
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR", 0.02, 0.001, 0.1)
...
CB_left = ROOT.RooCrystalBall("CB_left", "CB_left", x, mean, sigma, sigmaR, alphaL, nL, alphaR, nR)
...
a2 = ROOT.RooRealVar("a2", "a2", 0.0, -1.0, 1.0)

# Create 1st-order polynomial PDF
polynomial = ROOT.RooPolynomial("polynomial", "polynomial", x, ROOT.RooArgList(a0, a1, a2))
...
model.plotOn(frame, ROOT.RooFit.Name("2nd poly"),ROOT.RooFit.Components("polynomial"), ROOT.RooFit.LineStyle(ROOT.kDashed), ROOT.RooFit.LineColor(ROOT.kGreen))
...
leg1.AddEntry("2nd poly", "2nd poly", "l")
