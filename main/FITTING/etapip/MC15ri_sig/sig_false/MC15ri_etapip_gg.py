...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15ri/etapip/gg/MC15ri_1M_etapip_gg_Dp_M_tight_v1_false.png"
...
model = ROOT.RooCrystalBall("CB_left", "CB_left", x, mean, sigma, sigmaR, alphaL, nL, alphaR, nR)
