...
file_name = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/MC15ri_1ab_etapip_gg_cc_fit_tight_v2_fitv10.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/fitresult/MC15ri_1ab_etapip_gg_cc_fit_tight_v2_fitv10.root"
...
input_file = ROOT.TFile.Open("roodataset_MC15ri_etapip_gg_tight_v2_Dm.root")
...
# True+false fixed
mean_johnson = ROOT.RooRealVar("mean_johnson", "mean of Johnson", 1.88049)
sigma_johnson = ROOT.RooRealVar("sigma_johnson", "sigma of Johnson", 0.00280275)
gamma = ROOT.RooRealVar("gamma", "gamma of Johnson", 0.322504 )
delta = ROOT.RooRealVar("delta", "delta of Johnson", 0.594428 )
...
rhopeta_sigma = ROOT.RooRealVar("rhopeta_sigma", "sigma", 0.03, 0.001, 0.08)
