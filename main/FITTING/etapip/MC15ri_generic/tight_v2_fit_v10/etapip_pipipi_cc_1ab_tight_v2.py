...
file_name = "/share/storage/jykim/plots/MC15ri/etapip/pipipi/generic/MC15ri_1ab_etapip_pipipi_cc_fit_tight_v2_fitv10.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/etapip/pipipi/generic/fitresult/MC15ri_1ab_etapip_pipipi_cc_fit_tight_v2_fitv10.root"
...
input_file = ROOT.TFile.Open("roodataset_MC15ri_etapip_pipipi_tight_v2_Dm.root")
...
r = extended_model.fitTo(data,ROOT.RooFit.Range("fitRange"),  RooFit.Extended(True), RooFit.PrintLevel(3), RooFit.Save(1),RooFit.SumW2Error(True), ROOT.RooFit.NumCPU(4), RooFit.MaxCalls(40000 ))
