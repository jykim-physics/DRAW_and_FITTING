...
file_name = "/share/storage/jykim/plots/MC15ri/etapip/pipipi/generic/MC15ri_1ab_etapip_pipipi_fit_tight_v2_fitv10.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/etapip/pipipi/generic/fitresult/MC15ri_1ab_etapip_pipipi_fit_tight_v2_fitv10.root"
...
#loc_ccbar = base_file_loc + 'topo/resultfile/result_etapip_pipipi/standard.root'
...
input_file = ROOT.TFile.Open("roodataset_MC15ri_etapip_pipipi_tight_v2_Dp.root")
...
#True+False fixed
mean_johnson = ROOT.RooRealVar("mean_johnson", "mean of Johnson", 1.86946 )
sigma_johnson = ROOT.RooRealVar("sigma_johnson", "sigma of Johnson", 0.0000465145)
gamma = ROOT.RooRealVar("gamma", "gamma of Johnson",  0.512248)
delta = ROOT.RooRealVar("delta", "delta of Johnson", 0.0871551)

#True fixed
#mean_johnson = ROOT.RooRealVar("mean_johnson", "mean of Johnson", 1.88371)
#sigma_johnson = ROOT.RooRealVar("sigma_johnson", "sigma of Johnson", 0.00606925 )
...
#mean_gaussian2 = ROOT.RooRealVar("mean_gaussian2", "mean of Gaussian", 0, -1, 1)
sigma_gaussian2 = ROOT.RooRealVar("sigma_gaussian2", "sigma of Gaussian", 0.01, 0.0001, 0.05)
...
sig_johnson_gauss = ROOT.RooFFTConvPdf("sig_johnson_gauss", "Convolution of Johnson and Gaussian", x, johnson, gaussian)

sig_fraction = ROOT.RooRealVar("sig_fraction", "fraction", 0.5, 0.0, 1.0)
sig_model = ROOT.RooAddPdf("sig_model", "Convolution of Johnson and Gaussian", ROOT.RooArgList(sig_johnson_gauss, gaussian2), ROOT.RooArgList(sig_fraction))
...
Ds_mean_johnson = ROOT.RooRealVar("Ds_mean_johnson", "mean of Johnson", 1.96822)
Ds_sigma_johnson = ROOT.RooRealVar("Ds_sigma_johnson", "sigma of Johnson", 0.0000265904 )
Ds_gamma = ROOT.RooRealVar("Ds_gamma", "gamma of Johnson", 0.545059 )
Ds_delta = ROOT.RooRealVar("Ds_delta", "delta of Johnson", 0.0644989 )
...
Ds_sigma_gaussian2 = ROOT.RooRealVar("Ds_sigma_gaussian2", "sigma of Gaussian", 0.01, 0.0005, 0.5)
...
Ds_johnson_gauss = ROOT.RooFFTConvPdf("Ds_johnson_gauss", "Convolution of Johnson and Gaussian", x, Ds_johnson, Ds_gaussian)

Ds_gaussian2 = ROOT.RooGaussian("Ds_gaussian2", "Gaussian PDF", x, Ds_mean_johnson, Ds_sigma_gaussian2)

Ds_fraction = ROOT.RooRealVar("Ds_fraction", "fraction", 0.5, 0.0, 1.0)
Ds_model = ROOT.RooAddPdf("Ds_model", "Convolution of Johnson and Gaussian", ROOT.RooArgList(Ds_johnson_gauss, Ds_gaussian2), ROOT.RooArgList(Ds_fraction)  )
...
rhopeta_sigma = ROOT.RooRealVar("rhopeta_sigma", "sigma", 0.03, 0.001, 0.1)
...
r = extended_model.fitTo(data, ROOT.RooFit.Range("fitRange"),  RooFit.Extended(True), RooFit.PrintLevel(3), RooFit.Save(1),RooFit.SumW2Error(True), ROOT.RooFit.NumCPU(14), ROOT.RooFit.MaxCalls(40000 ) )
...
canv.cd(1)
frame = x.frame(ROOT.RooFit.Range("fitRange"))
