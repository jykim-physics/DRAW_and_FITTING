...
file_name = "/share/storage/jykim/plots/MC15ri/etapip/pipipi/generic/MC15ri_1ab_etapip_pipipi_cc_fit_tight_v2_fitv1.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/etapip/pipipi/generic/fitresult/MC15ri_1ab_etapip_pipipi_cc_fit_tight_v2_fitv1.root"
...
mean = ROOT.RooRealVar("mean", "mean", 1.86, 1.8, 1.9)
sigmaL = ROOT.RooRealVar("sigmaL", "sigma", 0.02, 0.001, 0.1)
sigmaR = ROOT.RooRealVar("sigmaR", "sigma", 0.02, 0.001, 0.1)

alphaL = ROOT.RooRealVar("alphaL", "alphaL", 1.0, 0.0, 8.0)
nL = ROOT.RooRealVar("nL", "nL", 1.0, 0.0, 15.0)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 1.0, 0.0, 8.0)
nR = ROOT.RooRealVar("nR", "nR", 1.0, 0.0, 15.0)

# Create double-sided Crystal Ball PDF
sig_model = ROOT.RooCrystalBall("sig_model", "CB", x, mean, sigmaL,sigmaR, alphaL, nL, alphaR, nR)

Ds_mean = ROOT.RooRealVar("Ds_mean", "mean", 1.96, 1.93, 2.0)
Ds_sigma = ROOT.RooRealVar("Ds_sigma", "sigma", 0.02, 0.001, 0.1)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 1.0, 0.0, 8.0)
