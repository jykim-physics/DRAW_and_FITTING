...
declare -A job_configs=(
    ["MC15ri_etapip_gg_fitv6_3"]="etapip_gg_1ab_tight_v2.py:/share/storage/jykim/plots/MC15ri/etapip/gg/generic/"
    ["MC15ri_etapip_pipipi_fitv6_3"]="etapip_pipipi_1ab_tight_v2.py:/share/storage/jykim/plots/MC15ri/etapip/pipipi/generic/"
    ["MC15ri_etapip_gg_cc_fitv6_3"]="etapip_gg_cc_1ab_tight_v2.py:/share/storage/jykim/plots/MC15ri/etapip/gg/generic/"
    ["MC15ri_etapip_pipipi_cc_fitv6_3"]="etapip_pipipi_cc_1ab_tight_v2.py:/share/storage/jykim/plots/MC15ri/etapip/pipipi/generic/"
...
for job_name in "${!job_configs[@]}"; do
    ...
    yhep_basf2 -f "$python_script" -e "${dir}/${job_name}.err" -o "${dir}/${job_name}.out" -l "${dir}/${job_name}.log"
done
