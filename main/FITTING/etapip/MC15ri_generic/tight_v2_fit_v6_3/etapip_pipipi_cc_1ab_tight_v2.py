...
file_name = "/share/storage/jykim/plots/MC15ri/etapip/pipipi/generic/MC15ri_1ab_etapip_pipipi_cc_fit_tight_v2_fitv6_3.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/etapip/pipipi/generic/fitresult/MC15ri_1ab_etapip_pipipi_cc_fit_tight_v2_fitv6_3.root"
...
#Ture + false fixed
#mean_johnson = ROOT.RooRealVar("mean_johnson", "mean of Johnson", 1.86458)
#sigma_johnson = ROOT.RooRealVar("sigma_johnson", "sigma of Johnson", 0.0000109671)
#gamma = ROOT.RooRealVar("gamma", "gamma of Johnson", 0.223566)
#delta = ROOT.RooRealVar("delta", "delta of Johnson", 0.164680)
...
Ds_mean_johnson = ROOT.RooRealVar("Ds_mean_johnson", "mean of Johnson", 1.97588)
Ds_sigma_johnson = ROOT.RooRealVar("Ds_sigma_johnson", "sigma of Johnson", 0.000274441)
Ds_gamma = ROOT.RooRealVar("Ds_gamma", "gamma of Johnson", 0.206984 )
Ds_delta = ROOT.RooRealVar("Ds_delta", "delta of Johnson", 0.297917)
...
rhopeta_mean = ROOT.RooRealVar("rhopeta_mean", "mean", 1.72459)
rhopeta_sigma = ROOT.RooRealVar("rhopeta_sigma", "sigma", 0.0747283)
rhopeta_tail = ROOT.RooRealVar("rhopeta_tail", "sigma", 0.503453)

#rhopeta_model = ROOT.RooGaussian("rhopeta_model", "gauss", x, rhopeta_mean, rhopeta_sigma)
rhopeta_Novo = ROOT.RooNovosibirsk("rhopeta_Novo", "gauss", x, rhopeta_mean, rhopeta_sigma, rhopeta_tail)

#rhopeta_gauss_mean = ROOT.RooRealVar("rhopeta_gauss_mean", "mean of Gaussian", 0, -1, 1)
#rhopeta_gauss_sigma = ROOT.RooRealVar("rhopeta_gauss_sigma", "sigma of Gaussian", 0.01, 0.0001, 1)
rhopeta_gauss_mean = ROOT.RooRealVar("rhopeta_gauss_mean", "mean of Gaussian", 0, -0.05, +0.05)
rhopeta_gauss_sigma = ROOT.RooRealVar("rhopeta_gauss_sigma", "sigma of Gaussian", 0.01, 0.0001, 0.5)
rhopeta_gauss = ROOT.RooGaussian("rhopeta_gauss", "gauss", x, rhopeta_gauss_mean, rhopeta_gauss_sigma)

rhopeta_model = ROOT.RooFFTConvPdf("rhopeta_model", "gauss", x, rhopeta_Novo, rhopeta_gauss)
