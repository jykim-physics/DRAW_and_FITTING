...
#file_name_Dp = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/MC15ri_1ab_etapip_gg_fit_opt_loose_v2_fitv1_Dp_481fb.png"
#file_name_Dm = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/MC15ri_1ab_etapip_gg_fit_opt_loose_v2_fitv1_Dm_481fb.png"
#fitresult_name = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/fitresult/MC15ri_1ab_etapip_gg_fit_opt_loose_v2_fitv1_481fb.root"
#fitresult_text = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/fitresult/MC15ri_1ab_etapip_gg_fit_opt_loose_v2_fitv1_481fb.txt"
file_name_Dp = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/MC15ri_1ab_etapip_gg_fit_opt_loose_v2_fitv1_Dp.png"
file_name_Dm = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/MC15ri_1ab_etapip_gg_fit_opt_loose_v2_fitv1_Dm.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/fitresult/MC15ri_1ab_etapip_gg_fit_opt_loose_v2_fitv1.root"
fitresult_text = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/fitresult/MC15ri_1ab_etapip_gg_fit_opt_loose_v2_fitv1.txt"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 70000*scale, 50000*scale, 90000*scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 150000*scale, 130000*scale,160000*scale)  # N_total = N_D+ + N_D-
...
mean = ROOT.RooRealVar("mean", "mean", 1.880966853)
sigma = ROOT.RooRealVar("sigma", "sigma", 0.00458621460)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.906571103)
nL = ROOT.RooRealVar("nL", "nL", 2.996443424)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 1.489558000)
nR = ROOT.RooRealVar("nR", "nR", 2.41609115)
...
Ds_mean = ROOT.RooRealVar("Ds_mean", "mean", 1.982271047)
Ds_sigma = ROOT.RooRealVar("Ds_sigma", "sigma", 0.00171276839)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.44670226)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.781729801)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 1.055928738)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.042835787)
...
novo_mean = ROOT.RooRealVar("novo_mean", "Mean", 1.723684587)
novo_sigma = ROOT.RooRealVar("novo_sigma", "Sigma", 0.0655198635)
novo_tail = ROOT.RooRealVar("novo_tail", "Tail", 0.321479650)
...
bkg_comb_cc = ROOT.RooExponential("bkg_comb_cc", "x_bkg1", x, x_bkg1_tau_cc)
bkg_frac_cc = ROOT.RooRealVar("bkg_frac_cc", "fraction of Gaussian in BKG", 0.25, 0.1, 1)
#model_bkg_cc = ROOT.RooAddPdf("model_bkg_cc", "Gaus + Exp", RooArgList(rhopeta, bkg_comb_cc), bkg_frac_cc)
model_bkg_cc = ROOT.RooAddPdf("model_bkg_cc", "Gaus + Exp", RooArgList(rhopeta, bkg_comb), bkg_frac_cc)


Nbkg_D_plus = ROOT.RooRealVar("Nbkg_D_plus", "Number of background events for D+", 100000*scale, 50000*scale, 130000*scale)
Nbkg_D_minus = ROOT.RooRealVar("Nbkg_D_minus", "Number of background events for D-", 100000*scale,50000*scale, 130000*scale)
...
model_D_minus = ROOT.RooAddPdf("model_D_minus", "D- model",
                              ROOT.RooArgList(sig_model, Ds_model, model_bkg_cc),
