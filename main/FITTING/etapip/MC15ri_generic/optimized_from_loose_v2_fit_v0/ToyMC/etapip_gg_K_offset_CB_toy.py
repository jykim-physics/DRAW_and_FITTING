...
file_name_Dp = "/share/storage/jykim/plots/MC15ri/etaKp/gg/generic/MC15ri_1ab_etapip_gg_K_fit_opt_loose_v2_fitv1_Dp.png"
file_name_Dm = "/share/storage/jykim/plots/MC15ri/etaKp/gg/generic/MC15ri_1ab_etapip_gg_K_fit_opt_loose_v2_fitv1_Dm.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/etaKp/gg/generic/fitresult/MC15ri_1ab_etapip_gg_K_fit_opt_loose_v2_fitv1.root"
fitresult_text = "/share/storage/jykim/plots/MC15ri/etaKp/gg/generic/fitresult/MC15ri_1ab_etapip_gg_K_fit_opt_loose_v2_fitv1.txt"
...
file_list = ['/share/storage/jykim/storage_b2/storage/reduced_ntuples/MC15ri/etapip_eteeta/MC15ri_etaetapip_loose_v2_241106_yespi0veto/etapip_gg_K/MC15ri*.root']
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 900*scale, 600*scale, 1200*scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 4000*scale, 2500*scale,5500*scale)  # N_total = N_D+ + N_D-
...
mean = ROOT.RooRealVar("mean", "mean", 1.864617514)
sigma = ROOT.RooRealVar("sigma", "sigma",  0.00386979677)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.873224156)
nL = ROOT.RooRealVar("nL", "nL", 3.751151616)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 1.516934265)
nR = ROOT.RooRealVar("nR", "nR", 2.363637611)
...
mean_gaussian = ROOT.RooRealVar("mean_gaussian", "mean of Gaussian", 0.00487663915)
sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian", 0.00772276972)
...
Ds_mean = ROOT.RooRealVar("Ds_mean", "mean", 1.959266423)
Ds_sigma = ROOT.RooRealVar("Ds_sigma", "sigma", 0.004123138)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.899040509)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.606896037)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 1.576383951)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.127945188)
...
#Ds_mean_gaussian = ROOT.RooRealVar("Ds_mean_gaussian", "mean of Gaussian", 0.00876985557)
#Ds_sigma_gaussian = ROOT.RooRealVar("Ds_sigma_gaussian", "sigma of Gaussian", 0.00833103076)
...
Nbkg_D_plus = ROOT.RooRealVar("Nbkg_D_plus", "Number of background events for D+", 5000*scale, 3000*scale, 7000*scale)
Nbkg_D_minus = ROOT.RooRealVar("Nbkg_D_minus", "Number of background events for D-", 5000*scale,3000*scale, 7000*scale)
...
toyMC_canvas.SaveAs("toy_Acp_etapip_gg_K.png")

toyMC_canvas_Ds = ROOT.TCanvas("toyMC_canvas_Ds", "D+ fit", 800, 600)
toyMC_frame_Acp_Ds.Draw()
toyMC_canvas_Ds.SaveAs("toy_Acp_Ds_etapip_gg_K.png")
