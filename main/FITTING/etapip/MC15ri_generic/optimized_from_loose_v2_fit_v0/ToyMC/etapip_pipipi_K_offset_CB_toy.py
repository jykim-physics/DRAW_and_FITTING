import ROOT
from ROOT import RooFit, RooRealVar, RooDataSet, RooArgList, RooAddPdf, RooGaussian, RooFormulaVar, RooSimultaneous, RooCategory, RooArgSet
from ROOT.RooFit import Extended, FitOptions, Save, PrintEvalErrors, PrintLevel, Bins, FitGauss, NumCPU, Strategy
import glob
import ctypes
import os

file_name_Dp = "/share/storage/jykim/plots/MC15ri/etaKp/pipipi/generic/MC15ri_1ab_etapip_pipipi_K_fit_opt_loose_v2_fitv1_Dp.png"
file_name_Dm = "/share/storage/jykim/plots/MC15ri/etaKp/pipipi/generic/MC15ri_1ab_etapip_pipipi_K_fit_opt_loose_v2_fitv1_Dm.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/etaKp/pipipi/generic/fitresult/MC15ri_1ab_etapip_pipipi_K_fit_opt_loose_v2_fitv1.root"
fitresult_text = "/share/storage/jykim/plots/MC15ri/etaKp/pipipi/generic/fitresult/MC15ri_1ab_etapip_pipipi_K_fit_opt_loose_v2_fitv1.txt"
...
file_list = ['/share/storage/jykim/storage_b2/storage/reduced_ntuples/MC15ri/etapip_eteeta/MC15ri_etaetapip_loose_v2_241106_yespi0veto/etapip_pipipi_K/MC15ri*.root']
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 500*scale, 300*scale, 900*scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 2000*scale, 1000*scale,3000*scale)  # N_total = N_D+ + N_D-
...
Nbkg_D_plus = ROOT.RooRealVar("Nbkg_D_plus", "Number of background events for D+", 3000*scale, 2000*scale, 4000*scale)
Nbkg_D_minus = ROOT.RooRealVar("Nbkg_D_minus", "Number of background events for D-", 3000*scale,2000*scale, 4000*scale)
...
ToyMC_all = ROOT.RooMCStudy(sim_model, {x,cat}, Extended(True), FitOptions(Save(True), PrintEvalErrors(0), PrintLevel(-1), NumCPU(6),Strategy(2)))
...
toyMC_canvas.SaveAs("toy_Acp_etapip_pipipi_K.png")

toyMC_canvas_Ds = ROOT.TCanvas("toyMC_canvas_Ds", "D+ fit", 800, 600)
toyMC_frame_Acp_Ds.Draw()
toyMC_canvas_Ds.SaveAs("toy_Acp_Ds_etapip_pipipi_K.png")
