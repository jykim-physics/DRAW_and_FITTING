...
file_name_Dp = "/share/storage/jykim/plots/MC15ri/etaKp/pipipi/generic/MC15ri_1ab_etapip_pipipi_K_ref_fit_opt_loose_v2_fitv1_Dp.png"
file_name_Dm = "/share/storage/jykim/plots/MC15ri/etaKp/pipipi/generic/MC15ri_1ab_etapip_pipipi_K_ref_fit_opt_loose_v2_fitv1_Dm.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/etaKp/pipipi/generic/fitresult/MC15ri_1ab_etapip_pipipi_K_ref_fit_opt_loose_v2_fitv1.root"
fitresult_text = "/share/storage/jykim/plots/MC15ri/etaKp/pipipi/generic/fitresult/MC15ri_1ab_etapip_pipipi_K_ref_fit_opt_loose_v2_fitv1.txt"
...
file_list = ['/share/storage/jykim/storage_b2/storage/reduced_ntuples/MC15ri/etapip_eteeta/MC15ri_etaetapip_loose_v2_241106_yespi0veto/etapip_pipipi_K_bdt_to_etapip_pipipi/MC15ri*.root']
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 20000*scale, 10000*scale, 30000*scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 30000*scale, 20000*scale,40000*scale)  # N_total = N_D+ + N_D-
...
mean = ROOT.RooRealVar("mean", "mean", 1.875487683)
sigma = ROOT.RooRealVar("sigma", "sigma",  0.00300026413 )
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 1.365639654)
nL = ROOT.RooRealVar("nL", "nL", 1.851327936)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 1.619451034)
nR = ROOT.RooRealVar("nR", "nR", 1.9241799641)
...
Ds_mean = ROOT.RooRealVar("Ds_mean", "mean", 1.973213122)
Ds_sigma = ROOT.RooRealVar("Ds_sigma", "sigma", 0.00293188656)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 1.203860957)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.270980025)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 1.674873586)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 1.845670782)
...
novo_mean = ROOT.RooRealVar("novo_mean", "Mean", 1.731280462)
novo_sigma = ROOT.RooRealVar("novo_sigma", "Sigma", 0.0656863547)
novo_tail = ROOT.RooRealVar("novo_tail", "Tail", 0.411423114)
...
Nbkg_D_plus = ROOT.RooRealVar("Nbkg_D_plus", "Number of background events for D+", 10000*scale, 3000*scale, 50000*scale)
Nbkg_D_minus = ROOT.RooRealVar("Nbkg_D_minus", "Number of background events for D-", 10000*scale,3000*scale, 50000*scale)
