...
file_name_Dp = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/MC15ri_1ab_etapip_gg_K_ref_fit_opt_loose_v2_fitv1_Dp.png"
file_name_Dm = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/MC15ri_1ab_etapip_gg_K_ref_fit_opt_loose_v2_fitv1_Dm.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/fitresult/MC15ri_1ab_etapip_gg_K_ref_fit_opt_loose_v2_fitv1.root"
fitresult_text = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/fitresult/MC15ri_1ab_etapip_gg_K_ref_fit_opt_loose_v2_fitv1.txt"
...
file_list = ['/share/storage/jykim/storage_b2/storage/reduced_ntuples/MC15ri/etapip_eteeta/MC15ri_etaetapip_loose_v2_241106_yespi0veto/etapip_gg_K_bdt_to_etapip_gg/MC15ri*.root']
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 50000*scale, 30000*scale,70000*scale)  # N_total = N_D+ + N_D-
...
mean = ROOT.RooRealVar("mean", "mean", 1.874617080)
sigma = ROOT.RooRealVar("sigma", "sigma",  0.00413650746)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.870824132)
nL = ROOT.RooRealVar("nL", "nL",  3.296289126)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 1.511427273)
nR = ROOT.RooRealVar("nR", "nR", 2.374420698)
...
Ds_mean = ROOT.RooRealVar("Ds_mean", "mean", 1.978908288)
Ds_sigma = ROOT.RooRealVar("Ds_sigma", "sigma", 0.00105523876)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.255618428)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.422823049)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.742571877)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.283934315)
...
novo_mean = ROOT.RooRealVar("novo_mean", "Mean", 1.72403013)
novo_sigma = ROOT.RooRealVar("novo_sigma", "Sigma", 0.0673520544)
novo_tail = ROOT.RooRealVar("novo_tail", "Tail", 0.346482695)
...
Nbkg_D_plus = ROOT.RooRealVar("Nbkg_D_plus", "Number of background events for D+", 10000*scale, 5000*scale, 40000*scale)
Nbkg_D_minus = ROOT.RooRealVar("Nbkg_D_minus", "Number of background events for D-", 10000*scale,5000*scale, 40000*scale)
