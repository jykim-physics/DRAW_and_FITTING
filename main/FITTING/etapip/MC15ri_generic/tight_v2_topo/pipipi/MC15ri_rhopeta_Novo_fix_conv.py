...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15ri/etapip/pipipi/MC15ri_1ab_etapip_pipipi_Dp_M_tight_v2_rhopeta_Novo_fix_conv.png"
...
mean = ROOT.RooRealVar("mean", "Mean", 1.72459)
sigma = ROOT.RooRealVar("sigma", "Sigma", 0.0747283)
tail = ROOT.RooRealVar("tail", "Tail", 0.503453)
