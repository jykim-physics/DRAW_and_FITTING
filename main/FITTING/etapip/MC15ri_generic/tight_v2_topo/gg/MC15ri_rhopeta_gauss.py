...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15ri/etapip/gg/MC15ri_1ab_etapip_gg_Dp_M_tight_v2_rhopeta_gauss_1_7.png"
...
cuts = rank_var + "==1" + " && ( (iCascDcyBrP_Dsp_0==1 && Pip_charge==1) || (iCascDcyBrCcP_Dsp_0==1 && Pip_charge==-1)) && abs(Pip_genMotherPDG)==213 && abs(etapip_Eta_genMotherPDG)==431" 
...
mychain.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15ri_generic/MC15ri_etaetapip_tight_v2_240419_Kp_BCS_etapi0const/topo/resultfile/result_etapip_gg/*.root")
...
mean = ROOT.RooRealVar("mean", "mean", 1.7, 1.6, 1.85)
sigma = ROOT.RooRealVar("sigma", "sigma", 0.02, 0.001, 0.3)
...
model = ROOT.RooGaussian("CB_left", "CB_left", x, mean, sigma)

#CB = ROOT.RooCrystalBall("CB", "CB_left", x, mean, sigma, alphaL, nL)
#model = ROOT.RooCrystalBall("CB_left", "CB_left", x, mean, sigma, alphaL, nL)
