...
base_file_loc =  '/home/jykim/MC15ri_etaetapip_tight_v2_240419_Kp_BCS_etapi0const/'
...
# Convolute the Johnson distribution with Gaussian
Ds_model_cc = ROOT.RooFFTConvPdf("Ds_model_cc", "Convolution of Johnson and Gaussian", y, Ds_johnson_cc, Ds_gaussian_cc)
...
rhopeta_model_cc = ROOT.RooGaussian("rhopeta_model_cc", "gauss", y, rhopeta_mean_cc, rhopeta_sigma_cc)
...
nsig_cc = ROOT.RooRealVar("nsig_cc","# signal events",N_total*0.01,0,N_total*0.8)
nbkg1_cc = ROOT.RooRealVar("nbkg1_cc","# bkg events",N_total*0.8,0, N_total)
nbkg2_cc = ROOT.RooRealVar("nbkg2_cc","# bkg events",N_total*0.2,0, N_total)
nDs_cc = ROOT.RooRealVar("nDs_cc","# bkg events",N_total*0.8,0, N_total)
...
with open(output_json_file, 'w') as f:
    json.dump({'n_gen_Acp': n_gen_Acp, 'n_recon_Acp': n_recon_Acp, 'n_recon_Acp_errors': n_recon_Acp_errors}, f)
