...
pull_canvas.SaveAs("pull_distribution_nsig_5000_bkgfrac.pdf")
...
nsig_hist.Draw()
nsig_canvas.SaveAs("nsig_distribution_5000_bkgfrac.pdf")
...
nsig_error_canvas.SaveAs("nsig_error_distribution_5000_bkgfrac.pdf")
