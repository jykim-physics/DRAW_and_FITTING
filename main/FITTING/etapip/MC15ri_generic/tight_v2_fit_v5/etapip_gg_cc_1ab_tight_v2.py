...
file_name = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/MC15ri_1ab_etapip_gg_cc_fit_tight_v2_fitv5.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/fitresult/MC15ri_1ab_etapip_gg_cc_fit_tight_v2_fitv5.root"
...
# MC matched fixed
#mean_johnson = ROOT.RooRealVar("mean_johnson", "mean of Johnson", 1.88396)
#sigma_johnson = ROOT.RooRealVar("sigma_johnson", "sigma of Johnson", 0.00595210)
#gamma = ROOT.RooRealVar("gamma", "gamma of Johnson", 0.341503 )
#delta = ROOT.RooRealVar("delta", "delta of Johnson", 0.884366 )
...
# ALL fixed
Ds_mean_johnson = ROOT.RooRealVar("Ds_mean_johnson", "mean of Johnson", 1.99255)
Ds_sigma_johnson = ROOT.RooRealVar("Ds_sigma_johnson", "sigma of Johnson", 0.000882387)
Ds_gamma = ROOT.RooRealVar("Ds_gamma", "gamma of Johnson", 0.353469)
Ds_delta = ROOT.RooRealVar("Ds_delta", "delta of Johnson", 0.369132)
