...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 60000*scale, 30000*scale, 100000*scale)  # N_total = N_D+ + N_D-
...
Nbkg_D_plus = ROOT.RooRealVar("Nbkg_D_plus", "Number of background events for D+", 80000*scale, 50000*scale, 120000*scale)
Nbkg_D_minus = ROOT.RooRealVar("Nbkg_D_minus", "Number of background events for D-", 80000*scale,50000*scale, 120000*scale)
