...
file_name_Dp = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/MC15ri_1ab_etapip_gg_fit_opt_loose_v0_fitv0_Dp.png"
file_name_Dm = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/MC15ri_1ab_etapip_gg_fit_opt_loose_v0_fitv0_Dm.png"
fitresult_name = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/fitresult/MC15ri_1ab_etapip_gg_fit_opt_loose_v0_fitv0.root"
fitresult_text = "/share/storage/jykim/plots/MC15ri/etapip/gg/generic/fitresult/MC15ri_1ab_etapip_gg_fit_opt_loose_v0_fitv0.txt"
...
file_list = ['/share/storage/jykim/storage_b2/storage/reduced_ntuples/MC15ri/etapip_eteeta/MC15ri_etaetapip_loose_v1_241030_roe_Dptag_CFT_nopi0veto/etapip_gg/MC15ri*.root']
...
mean_johnson = ROOT.RooRealVar("mean_johnson", "mean of Johnson", 1.892668)
sigma_johnson = ROOT.RooRealVar("sigma_johnson", "sigma of Johnson", 0.00312570)
gamma = ROOT.RooRealVar("gamma", "gamma of Johnson", 0.280531)
delta = ROOT.RooRealVar("delta", "delta of Johnson", 0.661487)
...
Ds_mean_johnson = ROOT.RooRealVar("Ds_mean_johnson", "mean of Johnson", 1.979532)
Ds_sigma_johnson = ROOT.RooRealVar("Ds_sigma_johnson", "sigma of Johnson",0.00337313)
Ds_gamma = ROOT.RooRealVar("Ds_gamma", "gamma of Johnson",  0.319871)
Ds_delta = ROOT.RooRealVar("Ds_delta", "delta of Johnson",  0.670203)
...
novo_mean = ROOT.RooRealVar("novo_mean", "Mean", 1.7256014)
novo_sigma = ROOT.RooRealVar("novo_sigma", "Sigma", 0.0689753)
novo_tail = ROOT.RooRealVar("novo_tail", "Tail", 0.390743)
...
#gauss.plotOn(frame)
#fit_result.plotOn(frame, ROOT.RooFit.VisualizeError(fit_result))
#fit_result.plotOn(L_frame, ROOT.RooFit.VisualizeError(fit_result, 1), ROOT.RooFit.LineColor(ROOT.kRed))


# Show the profile plot with ROOT
#canvas = ROOT.TCanvas("canvas", "Likelihood Profile", 800, 600)
#frame.Draw()
#canvas.Draw()

# Optional: save the canvas as an image file
#canvas.SaveAs("likelihood_profile.png")
