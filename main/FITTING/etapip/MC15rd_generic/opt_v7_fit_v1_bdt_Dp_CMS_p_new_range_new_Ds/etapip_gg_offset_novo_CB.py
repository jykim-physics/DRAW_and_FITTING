...
suffix = "new_Ds"
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}.txt"
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 210000*scale*N_scale, 160000*scale*N_scale, 400000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 30000*scale*N_scale, 220000*scale*N_scale,550000*scale*N_scale)
