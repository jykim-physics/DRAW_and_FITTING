...
ROOT.SetBelle2Style()
plot_file_name = "/share/storage/jykim/plots/MC15rd/etapip/gg/MC15rd_etapip_gg_Dp_M_opt_v3_CB_rhopeta_from_Dsp_peak.png"
result_name = "/share/storage/jykim/plots/MC15rd/etapip/gg/MC15rd_etapip_gg_Dp_M_opt_v3_CB_result_rhopeta_from_Dsp_peak.txt"
...
tree_name_cc = "etapip_gg_rhopeta"
...
#model = ROOT.RooGaussian("CB_left", "Gaussian PDF", x, mean,sigma)

#mean = ROOT.RooRealVar("mean", "mean", 1.7, 1.65, 1.8)
#sigma = ROOT.RooRealVar("sigma", "sigma",  0.00258716780)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.539372285, 0,8)
nL = ROOT.RooRealVar("nL", "nL", 1.196900892, 0, 8)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 2.028555390, 0,8)
nR = ROOT.RooRealVar("nR", "nR", 1.379478402,0 , 8)

sigmaL = ROOT.RooRealVar("sigmaL", "Sigma", 0.05, 0.0001, 0.1)
sigmaR = ROOT.RooRealVar("sigmaR", "Sigma", 0.05, 0.0001, 0.1)
alpha = ROOT.RooRealVar("alpha", "alphaR", 1.028555390, 0,5)
n = ROOT.RooRealVar("n", "nR", 2.379478402,0 , 10)
# Create double-sided Crystal Ball PDF
#model = ROOT.RooCrystalBall("CB", "CB_left", x, mean, sigma, alphaL, nL, alphaR, nR)
#model = ROOT.RooCrystalBall("CB", "CB_left", x, mean, sigmaL, sigmaR, alphaL, nL, alphaR,nR)
