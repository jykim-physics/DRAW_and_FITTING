...
suffix = "KDE_fixed_2nd_cheby_extended_exp"
...
x_bkg1_tau_minus = ROOT.RooRealVar("x_bkg1_tau_minus", "c0",-5, -20, 5)
x_bkg1_tau2 = ROOT.RooRealVar("x_bkg1_tau2", "c0",0, -10, 10)
model_bkg_plus = ROOT.RooGenericPdf("model_bkg_plus","exp(@1*(@0-1.919) + @2*(@0-1.919)*(@0-1.919))",ROOT.RooArgList(x, x_bkg1_tau_plus, x_bkg1_tau2))
model_bkg_minus = ROOT.RooGenericPdf("model_bkg_minus","exp(@1*(@0-1.919) + @2*(@0-1.919)*(@0-1.919))",ROOT.RooArgList(x, x_bkg1_tau_minus, x_bkg1_tau2))
