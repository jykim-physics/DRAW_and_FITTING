...
parser.add_argument("-syst","--syst", choices=["plus", "minus","nominal"], required=True,
                    help="Specify 'plus' or 'minus' or 'nominal'")
...
suffix = f"KDE_fixed_2nd_cheby_Acp_peak_syst_{args.syst}"
...
Acp_peak_bkg_total_RooRealVar = KDE_fit_args.find("Acp")
if args.syst == 'nominal':
  Acp_peak_bkg = ROOT.RooRealVar("Acp_peak_bkg", "Acp of background events",Acp_peak_bkg_total_RooRealVar.getVal())
elif args.syst == 'plus':
  Acp_peak_bkg = ROOT.RooRealVar("Acp_peak_bkg", "Acp of background events",Acp_peak_bkg_total_RooRealVar.getVal() + Acp_peak_bkg_total_RooRealVar.getError())
elif args.syst == 'minus':
  Acp_peak_bkg = ROOT.RooRealVar("Acp_peak_bkg", "Acp of background events",Acp_peak_bkg_total_RooRealVar.getVal() - Acp_peak_bkg_total_RooRealVar.getError())
print("Acp_peak_bkg =", Acp_peak_bkg)
