...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv15_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv15_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv15_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.pdf"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv15_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv15_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
...
x_bkg1_c1_plus = ROOT.RooRealVar("x_bkg1_c1_plus", "c0",0.1, -1.0, 1.0)
x_bkg1_c1_minus = ROOT.RooRealVar("x_bkg1_c1_minus", "c0",0.1, -1.0, 1.0)
x_bkg1_c2 = ROOT.RooRealVar("x_bkg1_c2", "c0",0.1, -1.0, 1.0)
...
#Acp_x_bkg1_c1 = ROOT.RooRealVar("Acp_x_bkg1_c1", "c0",0.0, -1.0, 1.0)
Acp_x_bkg1_c2 = ROOT.RooRealVar("Acp_x_bkg1_c2", "c0",0.0, -1.0, 1.0)
...
#x_bkg1_c1_plus = ROOT.RooRealVar("x_bkg1_c1_plus", "c0",0.1, -1.0, 1.0)
x_bkg1_c2_plus = ROOT.RooRealVar("x_bkg1_c2_plus", "c0",0.1, -1.0, 1.0)
...
#x_bkg1_c1_minus = RooFormulaVar("x_bkg1_c1_minus","x_bkg1_c1_plus * (1 - Acp_x_bkg1_c1)/(1 + Acp_x_bkg1_c1)", RooArgList(x_bkg1_c1_plus,Acp_x_bkg1_c1))
x_bkg1_c2_minus = RooFormulaVar("x_bkg1_c2_minus","x_bkg1_c2_plus * (1 - Acp_x_bkg1_c2)/(1 + Acp_x_bkg1_c2)", RooArgList(x_bkg1_c2_plus,Acp_x_bkg1_c2))
...
if args.float_var == "mean":
    ...
    model_D_plus = ROOT.RooAddPdf("model_D_plus", "D+ model",
                                  ROOT.RooArgList(sig_model_plus, Ds_model, model_bkg_plus, kde_model),
                                  ROOT.RooArgList(Nsig_D_plus, Nsig_Ds_plus,  Nbkg_D_plus, N_peak_bkg_D_plus))
    model_D_minus = ROOT.RooAddPdf("model_D_minus", "D- model",
                                  ROOT.RooArgList(sig_model_minus, Ds_model,  model_bkg_minus, kde_model),
    ...
    model_D_plus = ROOT.RooAddPdf("model_D_plus", "D+ model",
                                  ROOT.RooArgList(sig_model_plus, Ds_model_plus, model_bkg_plus, kde_model),
                                  ROOT.RooArgList(Nsig_D_plus, Nsig_Ds_plus,  Nbkg_D_plus, N_peak_bkg_D_plus))
    model_D_minus = ROOT.RooAddPdf("model_D_minus", "D- model",
                                  ROOT.RooArgList(sig_model_minus, Ds_model_minus,  model_bkg_minus, kde_model),
                                  ROOT.RooArgList(Nsig_D_minus, Nsig_Ds_minus,  Nbkg_D_minus, N_peak_bkg_D_minus))
    ...
    model_D_plus = ROOT.RooAddPdf("model_D_plus", "D+ model",
                                  ROOT.RooArgList(sig_model, Ds_model_plus, model_bkg_plus, kde_model),
                                  ROOT.RooArgList(Nsig_D_plus, Nsig_Ds_plus,  Nbkg_D_plus, N_peak_bkg_D_plus))
    model_D_minus = ROOT.RooAddPdf("model_D_minus", "D- model",
                                  ROOT.RooArgList(sig_model, Ds_model_minus,  model_bkg_minus, kde_model),
                                  ROOT.RooArgList(Nsig_D_minus, Nsig_Ds_minus,  Nbkg_D_minus, N_peak_bkg_D_minus))
elif args.float_var == "x_bkg1_c2":
    CB = ROOT.RooCrystalBall("CB", "CB_left", x, mean, sigmaL,sigmaR, alphaL, nL, alphaR, nR)
    scaled_sigma_gaussian = RooFormulaVar("scaled_sigma_gaussian","sigma_gaussian * scale_factor", RooArgList(sigma_gaussian, scale_factor))
    gaussian = ROOT.RooGaussian("gaussian", "Gaussian PDF", x, mean_gaussian, scaled_sigma_gaussian)
    sig_model = ROOT.RooFFTConvPdf("sig_model", "Convolution of Johnson and Gaussian", x, CB, gaussian)
    ...
    model_bkg_plus = ROOT.RooChebychev("model_bkg_plus", "x_bkg1", x, ROOT.RooArgList(x_bkg1_c1_plus, x_bkg1_c2_plus))
    model_bkg_minus = ROOT.RooChebychev("model_bkg_minus", "x_bkg1", x, ROOT.RooArgList(x_bkg1_c1_minus, x_bkg1_c2_minus))
