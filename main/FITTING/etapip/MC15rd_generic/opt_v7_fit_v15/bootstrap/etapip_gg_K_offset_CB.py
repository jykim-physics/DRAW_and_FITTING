...
x_bkg1_c1_plus_var = ROOT.RooRealVar("x_bkg1_c1_plus_var", "c1",0.1, -1.0, 1.0)
x_bkg1_c1_minus_var = ROOT.RooRealVar("x_bkg1_c1_minus_var", "c1",0.1, -1.0, 1.0)
...
def var_fit_extract_Acp(data_Dp, data_Dm, n_bootstrap):
  ...
  model_bkg_plus_var = ROOT.RooChebychev("model_bkg_plus_var", "x_bkg1", x, ROOT.RooArgList(x_bkg1_c1_plus_var, x_bkg1_c2_var))
  model_bkg_minus_var = ROOT.RooChebychev("model_bkg_minus_var", "x_bkg1", x, ROOT.RooArgList(x_bkg1_c1_minus_var, x_bkg1_c2_var))

  model_D_plus_var= ROOT.RooAddPdf("model_D_plus_var", "D+ model",
                                ROOT.RooArgList(sig_model_var, Ds_model_var, model_bkg_plus_var, kde_model_var),
  ...
  model_D_minus_var= ROOT.RooAddPdf("model_D_minus_var", "D- model",
                                ROOT.RooArgList(sig_model_var, Ds_model_var, model_bkg_minus_var, kde_model_var),
