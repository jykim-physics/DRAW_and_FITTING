...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 50000*scale, 30000*scale, 120000*scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 100000*scale, 70000*scale,250000*scale)  # N_total = N_D+ + N_D-
...
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 1.112438500)
nL = ROOT.RooRealVar("nL", "nL", 2.240590020)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 1.419743001)
nR = ROOT.RooRealVar("nR", "nR", 2.095980491)
...
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 1.005275017)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.587181068)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 1.373374579)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.231298826)
...
novo_mean = ROOT.RooRealVar("novo_mean", "Mean", 1.730566491)
novo_sigma = ROOT.RooRealVar("novo_sigma", "Sigma", 0.0637824825)
novo_tail = ROOT.RooRealVar("novo_tail", "Tail", 0.377821828)
