...
file_name_Dp = "/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_fit_opt_loose_v3_fitv1_Dp.png"
file_name_Dm = "/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_fit_opt_loose_v3_fitv1_Dm.png"
fitresult_name = "/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_fit_opt_loose_v3_fitv1.root"
fitresult_text = "/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_fit_opt_loose_v3_fitv1.txt"
...
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.539372285)
nL = ROOT.RooRealVar("nL", "nL", 3.196900892)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 1.028555390)
nR = ROOT.RooRealVar("nR", "nR", 2.379478402)
...
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.250819618)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.905595356)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.560950724)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.273138436)
...
novo_mean = ROOT.RooRealVar("novo_mean", "Mean", 1.724379467)
novo_sigma = ROOT.RooRealVar("novo_sigma", "Sigma", 0.0645026175)
novo_tail = ROOT.RooRealVar("novo_tail", "Tail", 0.307544718)
