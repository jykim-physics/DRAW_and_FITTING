...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv3_bdt_{args.train}_Dp_CMS_{args.sign}.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv3_bdt_{args.train}_Dm_CMS_{args.sign}.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv3_bdt_{args.train}_{args.sign}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv3_bdt_{args.train}_{args.sign}.txt"
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.0006166759707627611)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",   0.0009544609698133307)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.15474725174143142)
nL = ROOT.RooRealVar("nL", "nL", 3.284576405364727)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.5223805939176867)
nR = ROOT.RooRealVar("nR", "nR", 2.5452232101500005)
...
sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian",  0.009479509517600848)
