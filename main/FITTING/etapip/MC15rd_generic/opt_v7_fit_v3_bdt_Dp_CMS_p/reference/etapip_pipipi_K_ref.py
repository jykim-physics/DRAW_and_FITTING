...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/MC15rd_etapip_pipipi_ref_fit_opt_loose_v7_fitv3_bdt_{args.train}_Dp_CMS_{args.sign}.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/MC15rd_etapip_pipipi_ref_fit_opt_loose_v7_fitv3_bdt_{args.train}_Dm_CMS_{args.sign}.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etapip_pipipi_ref_fit_opt_loose_v7_fitv3_bdt_{args.train}_{args.sign}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etapip_pipipi_ref_fit_opt_loose_v7_fitv3_bdt_{args.train}_{args.sign}.txt"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 40000*scale*N_scale, 20000*scale*N_scale, 120000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 30000*scale*N_scale, 10000*scale*N_scale,100000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 100000*scale*N_scale, 300000*scale*N_scale,200000*scale*N_scale)
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.005066637726051395)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0007097251345840602)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 1.6708224719954128)
nL = ROOT.RooRealVar("nL", "nL", 2.0049059507340505)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.5766749954498422)
nR = ROOT.RooRealVar("nR", "nR", 1.9759139396825158)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.0002089924193386205)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",  0.0009291069435709437)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.11120625527727902)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.6637035623067726)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.6798566725956442)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.455420970274634)
