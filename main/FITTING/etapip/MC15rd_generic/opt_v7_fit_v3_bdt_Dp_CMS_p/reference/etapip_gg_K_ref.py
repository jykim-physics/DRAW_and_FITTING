...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv3_bdt_{args.train}_Dp_CMS_{args.sign}.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv3_bdt_{args.train}_Dm_CMS_{args.sign}.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv3_bdt_{args.train}_{args.sign}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv3_bdt_{args.train}_{args.sign}.txt"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 50000*scale*N_scale, 20000*scale*N_scale, 70000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 90000*scale*N_scale, 40000*scale*N_scale,120000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 50000*scale*N_scale, 20000*scale*N_scale,80000*scale*N_scale)
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.0007359744891105252)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0011157499080186068)
alphaL = ROOT.RooRealVar("alphaL", "alphaL",  0.17606996219383683)
nL = ROOT.RooRealVar("nL", "nL", 3.5284422828848347)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.5620619172339759)
nR = ROOT.RooRealVar("nR", "nR", 2.603427300621241)
...
sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian", 0.0008, 0.0001, 0.01)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma",  0.0006166759707627611)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",  0.0009544609698133307)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.15474725174143142)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.284576405364727)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.5223805939176867)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.5452232101500005)
...
x_bkg1_tau = ROOT.RooRealVar("x_bkg1_tau", "c0",-0.5, -15, 0)
