...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 120000*scale*N_scale, 30000*scale*N_scale,180000*scale*N_scale)  # N_total = N_D+ + N_D-
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.0012243349625012262)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0022138438887697267)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.6523779784915901)
nL = ROOT.RooRealVar("nL", "nL", 2.212607588894029)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 1.4078859692688053)
nR = ROOT.RooRealVar("nR", "nR", 1.845443378346328)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.00039693193451606853)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",  0.0007966054238488211)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.2189274014802102)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.5033883120469937)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.6897714710560624)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.139743196912852)
...
novo_sigma = ROOT.RooRealVar("novo_sigma", "Sigma", 0.05562119985456295)
novo_tail = ROOT.RooRealVar("novo_tail", "Tail", 0.2638056822258444)
