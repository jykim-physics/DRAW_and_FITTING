...
if args.sign == "plus":
    N_peak_bkg_total = ROOT.RooRealVar("N_peak_bkg_total", "Number of background events", 764.9876580315748)
elif args.sign == "minus":
    N_peak_bkg_total = ROOT.RooRealVar("N_peak_bkg_total", "Number of background events", 352.99427127489025)
elif args.sign == "all":
    N_peak_bkg_total = ROOT.RooRealVar("N_peak_bkg_total", "Number of background events", 1025.7754838720707)

Acp_peak_bkg = RooRealVar("Acp_peak_bkg", "Acp", 0, -5, 5)  # A_Cp as a fit parameter
...
corr_matrix.Print()
print("Correlation between N_total and x_bkg1_tau =", fit_result.correlation("N_total", "x_bkg1_tau"))
print("Correlation between N_total_Ds and x_bkg1_tau =", fit_result.correlation("N_total_Ds", "x_bkg1_tau"))

# ---------------------------------------------------------------------
# Correlations involving Acp_peak_bkg
# ---------------------------------------------------------------------
