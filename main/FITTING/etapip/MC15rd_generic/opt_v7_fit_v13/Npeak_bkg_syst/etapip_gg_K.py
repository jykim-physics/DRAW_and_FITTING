...
parser.add_argument("-syst","--syst", choices=["plus", "minus"], required=True,
                    help="Specify 'plus' or 'minus'")
...
suffix = f"KDE_fixed_2nd_cheby_Npeak_bkg_sys_{args.syst}"
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_2nd_poly_fitv13_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_2nd_poly_fitv13_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_2nd_poly_fitv13_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.pdf"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_2nd_poly_fitv13_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_2nd_poly_fitv13_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
file_sweight = f"/share/storage/jykim/sweight/proc13/etaKp/gg/proc13_etapip_gg_K_fit_opt_loose_v7_2nd_poly_fitv13_Ds_weighted.root"
...
if args.syst == "plus":
   N_peak_bkg_total = ROOT.RooRealVar("N_peak_bkg_total", "Number of background events",N_peak_bkg_total_RooRealVar.getVal() + N_peak_bkg_total_RooRealVar.getError() )
