...
file_original_plus  = os.path.join(target_dir, "MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv13_bdt_train_Dp_CMS_p_plus_0.77_KDE_fixed_2nd_cheby_weighted.root")
file_original_minus = os.path.join(target_dir, "MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv13_bdt_train_Dp_CMS_p_minus_0.77_KDE_fixed_2nd_cheby_weighted.root")

pattern_plus = os.path.join(target_dir, "*fitv13_bdt_train_Dp_CMS_p_plus_0.77_sumw2fixed_float_var_*_weighted.root")
pattern_minus = os.path.join(target_dir, "*fitv13_bdt_train_Dp_CMS_p_minus_0.77_sumw2fixed_float_var_*_weighted.root")
