...
x_bkg1_c1_var = ROOT.RooRealVar("x_bkg1_c1_var", "c1",0.1, -1.0, 1.0)
...
def var_fit_extract_Acp(data_Dp, data_Dm, n_bootstrap):
  ...
  model_bkg_var = ROOT.RooChebychev("model_bkg_var", "x_bkg1", x, ROOT.RooArgList(x_bkg1_c1_var, x_bkg1_c2_var))
