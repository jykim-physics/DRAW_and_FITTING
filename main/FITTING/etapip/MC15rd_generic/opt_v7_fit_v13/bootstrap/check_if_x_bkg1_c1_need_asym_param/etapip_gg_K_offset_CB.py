...
suffix = "sumw2fixed"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/bootstrap/bootstrap_sys_MC15rd_etaKp_gg_fit_opt_loose_v7_fitv13_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 40000*scale*N_scale, 0*scale*N_scale,120000*scale*N_scale)
...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_2nd_poly_fitv13_bdt_train_Dp_CMS_p_{args.sign}_0.86_KDE_fixed_2nd_cheby_weighted.root")
...
N_peak_bkg_total_var_temp = const_args.find("N_peak_bkg_total")
N_peak_bkg_total_var_temp.SetName("N_peak_bkg_total_var_temp")
N_peak_bkg_total_var = ROOT.RooRealVar("N_peak_bkg_total_var", "N_peak_bkg_total_var", N_peak_bkg_total_var_temp.getVal())
#Acp_peak_bkg_var = RooRealVar("Acp_peak_bkg_var", "Acp", 0, -1, 1)
Acp_peak_bkg_var = RooRealVar("Acp_peak_bkg_var", "Acp", 0)
...
x_bkg1_c1_var_plus = ROOT.RooRealVar("x_bkg1_c1_var_plus", "c1",0.1, -1.0, 1.0)
x_bkg1_c1_var_minus = ROOT.RooRealVar("x_bkg1_c1_var_minus", "c1",0.1, -1.0, 1.0)
x_bkg1_c2_var = ROOT.RooRealVar("x_bkg1_c2_var", "c2",0.1, -1.0, 1.0)
...
f_in_var = ROOT.TFile("/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15re_6M_etapip_gg_Dp_M_v12_result_true_extended_train_Dp_CMS_p.0.86_workspace.root", "READ")
...
N_peak_bkg_total_var.setVal(N_peak_bkg_total_RooRealVar.getVal())
print("N_peak_bkg_total_var =", N_peak_bkg_total_var)

def var_fit_extract_Acp(data_Dp, data_Dm, n_bootstrap):
  sigmaL_var= ROOT.RooRealVar("sigmaL_var", "sigmaL_var", fit_sigmaL.getVal())
  sigmaR_var= ROOT.RooRealVar("sigmaR_var", "sigmaR_var",  fit_sigmaR.getVal())
  alphaL_var= ROOT.RooRealVar("alphaL_var", "alphaL_var", fit_alphaL.getVal())
  nL_var = ROOT.RooRealVar("nL_var", "nL_var", fit_nL.getVal())
  alphaR_var = ROOT.RooRealVar("alphaR_var", "alphaR_var", fit_alphaR.getVal())
  nR_var = ROOT.RooRealVar("nR_var", "nR_var", fit_nR.getVal())
  sigma_gaussian_var = ROOT.RooRealVar("sigma_gaussian_var", "sigma of Gaussian", fit_sigma_gaussian.getVal())

  Ds_sigmaL_var = ROOT.RooRealVar("Ds_sigmaL_var", "sigma_var", fit_Ds_sigmaL.getVal())
  Ds_sigmaR_var = ROOT.RooRealVar("Ds_sigmaR_var", "sigma_var",  fit_Ds_sigmaR.getVal())
  Ds_alphaL_var = ROOT.RooRealVar("Ds_alphaL_var", "alphaL_var", fit_Ds_alphaL.getVal())
  Ds_nL_var = ROOT.RooRealVar("Ds_nL_var", "nL_var", fit_Ds_nL.getVal())
  Ds_alphaR_var = ROOT.RooRealVar("Ds_alphaR_var", "alphaR_var", fit_Ds_alphaR.getVal())
  Ds_nR_var = ROOT.RooRealVar("Ds_nR_var", "nR_var",  fit_Ds_nR.getVal())
  Ds_sigma_gaussian_var = ROOT.RooRealVar("Ds_sigma_gaussian_var", "sigma of Gaussian", fit_Ds_sigma_gaussian.getVal())
  ...
  model_bkg_var_plus = ROOT.RooChebychev("model_bkg_var_plus", "x_bkg1", x, ROOT.RooArgList(x_bkg1_c1_var_plus, x_bkg1_c2_var))
  model_bkg_var_minus = ROOT.RooChebychev("model_bkg_var_minus", "x_bkg1", x, ROOT.RooArgList(x_bkg1_c1_var_minus, x_bkg1_c2_var))

  model_D_plus_var= ROOT.RooAddPdf("model_D_plus_var", "D+ model",
                                ROOT.RooArgList(sig_model_var, Ds_model_var, model_bkg_var_plus, kde_model_var),
                                ROOT.RooArgList(Nsig_D_plus_var, Nsig_Ds_plus_var, Nbkg_D_plus_var, N_peak_bkg_D_plus_var))
  model_D_minus_var= ROOT.RooAddPdf("model_D_minus_var", "D- model",
                                ROOT.RooArgList(sig_model_var, Ds_model_var, model_bkg_var_minus, kde_model_var),
                                ROOT.RooArgList(Nsig_D_minus_var, Nsig_Ds_minus_var, Nbkg_D_minus_var, N_peak_bkg_D_minus_var))
