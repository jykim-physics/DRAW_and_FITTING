...
suffix = "sumw2fixed"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/boostrap/bootstrap_sys_MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv13_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv13_bdt_train_Dp_CMS_p_{args.sign}_0.77_KDE_fixed_2nd_cheby_weighted.root")
...
x_bkg1_c1_var_plus = ROOT.RooRealVar("x_bkg1_c1_var_plus", "c0",0.1, -1.0, 1.0)
x_bkg1_c1_var_minus = ROOT.RooRealVar("x_bkg1_c1_var_minus", "c0",0.1, -1.0, 1.0)
...
f_in_var = ROOT.TFile("/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15re_6M_etapip_pipipi_Dp_M_v12_result_true_extended_train_Dp_CMS_p.0.77_workspace.root", "READ")
...
def var_fit_extract_Acp(data_Dp, data_Dm, n_bootstrap):
  ...
  model_bkg_var_plus = ROOT.RooChebychev("model_bkg_var", "x_bkg1", x, ROOT.RooArgList(x_bkg1_c1_var_plus, x_bkg1_c2_var))
  model_bkg_var_minus = ROOT.RooChebychev("model_bkg_var", "x_bkg1", x, ROOT.RooArgList(x_bkg1_c1_var_minus, x_bkg1_c2_var))

  model_D_plus_var= ROOT.RooAddPdf("model_D_plus_var", "D+ model",ROOT.RooArgList(sig_model_var, Ds_model_var, model_bkg_var_plus, kde_model_var),ROOT.RooArgList(Nsig_D_plus_var, Nsig_Ds_plus_var, Nbkg_D_plus_var, N_peak_bkg_D_plus_var) )
  model_D_minus_var= ROOT.RooAddPdf("model_D_minus_var", "D- model",ROOT.RooArgList(sig_model_var, Ds_model_var, model_bkg_var_minus, kde_model_var),ROOT.RooArgList(Nsig_D_minus_var, Nsig_Ds_minus_var, Nbkg_D_minus_var, N_peak_bkg_D_minus_var))
