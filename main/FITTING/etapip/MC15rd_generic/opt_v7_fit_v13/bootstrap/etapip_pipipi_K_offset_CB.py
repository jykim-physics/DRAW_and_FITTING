...
def var_fit_extract_Acp(data_Dp, data_Dm, n_bootstrap):
  ...
  model_D_plus_var= ROOT.RooAddPdf("model_D_plus_var", "D+ model",ROOT.RooArgList(sig_model_var, Ds_model_var, model_bkg_var, kde_model_var),ROOT.RooArgList(Nsig_D_plus_var, Nsig_Ds_plus_var, Nbkg_D_plus_var, N_peak_bkg_D_plus_var) )
  model_D_minus_var= ROOT.RooAddPdf("model_D_minus_var", "D- model",ROOT.RooArgList(sig_model_var, Ds_model_var, model_bkg_var, kde_model_var),ROOT.RooArgList(Nsig_D_minus_var, Nsig_Ds_minus_var, Nbkg_D_minus_var, N_peak_bkg_D_minus_var))
