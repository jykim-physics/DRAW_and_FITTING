...
file_name_Dp = f"test_Dp.png"
file_name_Dm = f"test_Dm.png"
file_name_Dall = f"test_Dall.png"
fitresult_name = f"test_result.root"
fitresult_text = f"test_result.txt"
file_sweight = f"test_sweight.root"
...
fit_result = sim_model.fitTo(data_combined, RooFit.Save(), RooFit.Extended(True), RooFit.SumW2Error(True), ROOT.RooFit.NumCPU(4), RooFit.         Strategy(2), ROOT.RooFit.Offset(True))
