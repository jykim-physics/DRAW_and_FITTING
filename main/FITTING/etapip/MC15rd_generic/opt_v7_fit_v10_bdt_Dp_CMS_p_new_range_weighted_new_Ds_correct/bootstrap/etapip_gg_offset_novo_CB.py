...
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/bootstrap_sys_MC15rd_etapip_gg_loose_v7_fitv10_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/bootstrap_sys_MC15rd_etapip_gg_loose_v7_fitv10_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/bootstrap_sys_MC15rd_etapip_gg_loose_v7_fitv10_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_fit_opt_loose_v7_fitv10_bdt_train_Dp_CMS_p_{args.sign}_0.83_new_Ds_correct_weighted.root")
...
N_total_var = RooRealVar("N_total_var", "N_total (N_D+ + N_D-)", 110000*scale*N_scale, 50000*scale*N_scale, 200000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total_var = ROOT.RooRealVar("Nbkg_total_var", "Number of background events for D+", 600000*scale*N_scale, 100000*scale*N_scale,1000000*scale*N_scale)
