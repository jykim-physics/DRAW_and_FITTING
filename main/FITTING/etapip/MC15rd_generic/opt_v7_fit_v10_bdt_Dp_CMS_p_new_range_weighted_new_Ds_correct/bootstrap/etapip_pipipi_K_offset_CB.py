...
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/bootstrap_sys_MC15rd_etaKp_pipipi_loose_v7_fitv10_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/bootstrap_sys_MC15rd_etaKp_pipipi_loose_v7_fitv10_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/bootstrap_sys_MC15rd_etaKp_pipipi_loose_v7_fitv10_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv10_bdt_train_Dp_CMS_p_{args.sign}_0.92_new_Ds_correct_weighted.root")
