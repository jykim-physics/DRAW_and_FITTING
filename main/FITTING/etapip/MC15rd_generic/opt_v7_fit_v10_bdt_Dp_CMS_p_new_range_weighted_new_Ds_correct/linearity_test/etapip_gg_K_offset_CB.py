...
file_sweight = f"/share/storage/jykim/sweight/proc13/etaKp/gg/proc13_etapip_gg_K_fit_opt_loose_v7_fitv10_Ds_weighted.root"
...
def Linearity_test(sim_model, cat, N_Input=100, N_gen=500, N_total=N_total):
  ...
  ToyMC_all = ROOT.RooMCStudy(sim_model, {x,cat}, Extended(True), FitOptions(Save(True),PrintEvalErrors(0),PrintLevel(0), NumCPU(2), Offset(True)))
