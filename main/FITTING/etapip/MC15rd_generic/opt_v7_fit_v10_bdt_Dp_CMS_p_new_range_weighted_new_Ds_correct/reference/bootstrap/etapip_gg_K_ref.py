...
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/ref_bootstrap_sys_MC15rd_etapip_gg_loose_v7_fitv10_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/ref_bootstrap_sys_MC15rd_etapip_gg_loose_v7_fitv10_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/ref_bootstrap_sys_MC15rd_etapip_gg_loose_v7_fitv10_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 50000*scale*N_scale, 20000*scale*N_scale, 250000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 150000*scale*N_scale, 40000*scale*N_scale, 500000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 600000*scale*N_scale, 50000*scale*N_scale,1600000*scale*N_scale)
...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv10_bdt_train_Dp_CMS_p_{args.sign}_0.91_weighted.root")
...
N_total_var = RooRealVar("N_total_var", "N_total (N_D+ + N_D-)", 50000*scale*N_scale, 20000*scale*N_scale, 250000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds_var = RooRealVar("N_total_Ds_var", "N_total (N_Ds+ + N_Ds-)", 150000*scale*N_scale, 40000*scale*N_scale, 500000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total_var = ROOT.RooRealVar("Nbkg_total_var", "Number of background events for D+", 600000*scale*N_scale, 50000*scale*N_scale,1600000*scale*N_scale)
...
with uproot.recreate(f"bootstrap_acp_results_ref_etapip_gg_{args.sign}.root") as f:
