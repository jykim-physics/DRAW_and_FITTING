...
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/ref_bootstrap_sys_MC15rd_etapip_pipipi_loose_v7_fitv10_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/ref_bootstrap_sys_MC15rd_etapip_pipipi_loose_v7_fitv10_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
...
N_total_var= RooRealVar("N_total_var", "N_total (N_D+ + N_D-)", 60000*scale*N_scale,  30000*scale*N_scale, 300000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds_var = RooRealVar("N_total_Ds_var", "N_total (N_Ds+ + N_Ds-)", 120000*scale*N_scale,  50000*scale*N_scale,700000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total_var = ROOT.RooRealVar("Nbkg_total_var", "Number of background events for D+", 250000*scale*N_scale, 20000*scale*N_scale,800000*scale*N_scale)
...
with uproot.recreate(f"bootstrap_acp_results_ref_etapip_pipipi_{args.sign}.root") as f:
