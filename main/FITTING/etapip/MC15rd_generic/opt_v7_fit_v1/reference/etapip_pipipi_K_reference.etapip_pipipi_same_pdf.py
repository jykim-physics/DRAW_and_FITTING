...
file_name_Dp = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/MC15rd_etapip_pipipi_K_ref_fit_opt_loose_v2_fitv1_Dp.png"
file_name_Dm = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/MC15rd_etapip_pipipi_K_ref_fit_opt_loose_v2_fitv1_Dm.png"
fitresult_name = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etapip_pipipi_K_ref_fit_opt_loose_v2_fitv1.root"
fitresult_text = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etapip_pipipi_K_ref_fit_opt_loose_v2_fitv1.txt"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 50000*scale, 15000*scale, 90000*scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 80000*scale, 30000*scale,120000*scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 60000*scale, 30000*scale, 200000*scale)
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigma",  0.000647785307)
sigmaR = ROOT.RooRealVar("sigmaR", "sigma", 0.00196696545)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.392663814)
nL = ROOT.RooRealVar("nL", "nL", 2.15496337)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 1.335260992)
nR = ROOT.RooRealVar("nR", "nR", 1.885672428)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.00138126780)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma", 0.000537304267)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.707169289)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.401336756)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.496558106)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.063601425)
