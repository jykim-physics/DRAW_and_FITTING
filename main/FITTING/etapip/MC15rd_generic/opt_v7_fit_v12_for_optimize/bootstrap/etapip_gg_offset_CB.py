...
suffix = "sumw2fixed"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/boostrap/bootstrap_sys_MC15rd_etapip_gg_fit_opt_loose_v7_fitv12_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_fit_opt_loose_v7_fitv12_bdt_train_Dp_CMS_p_{args.sign}_0.80_sumw2fixed_weighted.root")
...
N_total_var = RooRealVar("N_total_var", "N_total (N_D+ + N_D-)", 110000*scale*N_scale, 50000*scale*N_scale, 300000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds_var = RooRealVar("N_total_Ds_var", "N_total (N_Ds+ + N_Ds-)", 210000*scale*N_scale, 80000*scale*N_scale, 520000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total_var = ROOT.RooRealVar("Nbkg_total_var", "Number of background events for D+", 300000*scale*N_scale, 100000*scale*N_scale,1000000*scale*N_scale)
...
with uproot.recreate(f"bootstrap_acp_results_etapip_gg_{args.sign}_converge.root") as f:
