...
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv12_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv12_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
...
x_bkg1_c1 = ROOT.RooRealVar("x_bkg1_c1", "c0",0.001, -1.0, 1.0)
x_bkg1_c2 = ROOT.RooRealVar("x_bkg1_c2", "c0",0.001, -1.0, 1.0)
...
Acp_x_bkg1_c1 = ROOT.RooRealVar("Acp_x_bkg1_c1", "c0",0.01, -1.0, 1.0)
Acp_x_bkg1_c2 = ROOT.RooRealVar("Acp_x_bkg1_c2", "c0",0.01, -1.0, 1.0)
...
x_bkg1_c2_plus = ROOT.RooRealVar("x_bkg1_c2_plus", "c0",0.5, -1.0, 1.0)
...
if args.float_var == "mean":
    ...
    model_bkg_plus = ROOT.RooPolynomial("model_bkg_plus", "x_bkg1", x, ROOT.RooArgList(x_bkg1_c1_plus, x_bkg1_c2))
    model_bkg_minus = ROOT.RooPolynomial("model_bkg_minus", "x_bkg1", x, ROOT.RooArgList(x_bkg1_c1_minus, x_bkg1_c2))
    ...
    model_bkg_plus = ROOT.RooPolynomial("model_bkg_plus", "x_bkg1", x, ROOT.RooArgList(x_bkg1_c1, x_bkg1_c2_plus))
    model_bkg_minus = ROOT.RooPolynomial("model_bkg_minus", "x_bkg1", x, ROOT.RooArgList(x_bkg1_c1, x_bkg1_c2_minus))
