...
sigma_gaussian_plus = ROOT.RooRealVar("sigma_gaussian_plus", "sigma of Gaussian", fit_sigma_gaussian.getVal(), 0.001, 0.1)
Ds_mean_plus = ROOT.RooRealVar("Ds_mean_plus", "mean", 1.97, 1.95, 1.99)
Ds_sigma_gaussian_plus = ROOT.RooRealVar("Ds_sigma_gaussian_plus", "sigma of Gaussian", fit_Ds_sigma_gaussian.getVal(), 0.001, 0.1)
x_bkg1_tau_plus = ROOT.RooRealVar("x_bkg1_tau_plus", "c0",-3, -8, -0.01)
