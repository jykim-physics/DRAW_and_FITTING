...
suffix = "sumw2fixed"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/crossfeed/Dp_Ds_removed_bootstrap_sys_MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv12_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
...
while success_count < n_bootstrap:
    ...
    #fit_outputs_after = nominal_fit_to_non_crossfeed(data_boot_Dp, data_boot_Dm, iteration)
