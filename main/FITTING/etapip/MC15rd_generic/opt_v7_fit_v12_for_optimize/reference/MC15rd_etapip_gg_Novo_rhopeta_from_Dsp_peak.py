...
ROOT.SetBelle2Style()
plot_file_name = "/share/storage/jykim/plots/MC15rd/etapip/gg/MC15rd_etapip_gg_ref_Dp_M_fit_v12_novo_rhopeta_from_Dsp_peak_Dp_CMS_p_0.86.png"
result_name = "/share/storage/jykim/plots/MC15rd/etapip/gg/MC15rd_etapip_gg_ref_Dp_M_fit_v12_novo_result_rhopeta_from_Dsp_peak_Dp_CMS_p_0.86.txt"
fitresult_root = "/share/storage/jykim/plots/MC15rd/etapip/gg/MC15rd_etapip_gg_ref_Dp_M_fit_v12_novo_result_rhopeta_from_Dsp_peak_Dp_CMS_p_0.86.root"
...
#cuts_Dp = "Pip_charge==1 && Pip_genMotherPDG==213 && etapip_Eta_genMotherPDG==431 && nAllSigCascDcyBr_15>0"
#cuts_Dm = "Pip_charge==-1 && Pip_genMotherPDG==-213 && etapip_Eta_genMotherPDG==-431 && nAllSigCascDcyBr_15>0"
cuts_Dp = "Pip_charge==1 && Pip_genMotherPDG==213 && etapip_Eta_genMotherPDG==431 && nAllSigCascDcyBr_15>0 && Pip_genMotherPDG_1==431 && Pip_genMotherID_1==etapip_Eta_genMotherID"
cuts_Dm = "Pip_charge==-1 && Pip_genMotherPDG==-213 && etapip_Eta_genMotherPDG==-431 && nAllSigCascDcyBr_15>0 && Pip_genMotherPDG_1==-431 && Pip_genMotherID_1==etapip_Eta_genMotherID"
...
nAllSigCascDcyBr_15 = ROOT.RooRealVar("nAllSigCascDcyBr_15","", -1000000,1000000, "")
Pip_genMotherPDG_1  = ROOT.RooRealVar("Pip_genMotherPDG_1", "",-1000000,1000000, "")
Pip_genMotherID_1  = ROOT.RooRealVar("Pip_genMotherID_1", "",-1000000,1000000, "")
etapip_Eta_genMotherID  = ROOT.RooRealVar("etapip_Eta_genMotherID", "",-1000000,1000000, "")

base_path = "/share/storage/jykim/storage_b2/storage/reduced_ntuples/MC15rd/EtaHp/MC15rd_loose_v7_260108_nopi0veto/topo_basic_ref"
...
for element in cm_elements:
    pattern = f"{base_path}/{element}/resultfile/result_{tree_name}/standard.root"
...
full_var_set = ROOT.RooArgSet(x,Pip_charge, Pip_genMotherPDG, etapip_Eta_genMotherPDG, nAllSigCascDcyBr_15, Pip_genMotherPDG_1, Pip_genMotherID_1, etapip_Eta_genMotherID)
...
before_data_cc = ROOT.RooDataSet("data_cc","", mychain_cc, full_var_set, cuts_Dm)
...
# Perform the fit
result = model.fitTo(data, ROOT.RooFit.Range("fitRange"), ROOT.RooFit.NumCPU(4), ROOT.RooFit.Save(), ROOT.RooFit.Strategy(2))
result.Print()
