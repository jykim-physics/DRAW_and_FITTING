...
suffix = "sumw2fixed"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/bootstrap/bootstrap_sys_MC15rd_etapip_pipipi_ref_bdt_fit_loose_v7_fitv12_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 120000*scale*N_scale,  50000*scale*N_scale,400000*scale*N_scale)  # N_total = N_D+ + N_D-
...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/MC15rd_etapip_pipipi_ref_bdt_fit_loose_v7_fitv12_bdt_train_Dp_CMS_p_{args.sign}_0.77_sumw2fixed_weighted.root")
...
N_total_Ds_var = RooRealVar("N_total_Ds_var", "N_total (N_Ds+ + N_Ds-)", 120000*scale*N_scale,  50000*scale*N_scale,400000*scale*N_scale)  # N_total = N_D+ + N_D-
