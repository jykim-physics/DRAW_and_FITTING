...
toyMC_canvas.SaveAs(f"toy_ref_Acp_{tree_name}_{args.sign}.png")

toyMC_canvas_Ds = ROOT.TCanvas("toyMC_canvas_Ds", "D+ fit", 800, 600)
toyMC_frame_Acp_Ds.Draw()
toyMC_canvas_Ds.SaveAs(f"toy_ref_Acp_Ds_{tree_name}_{args.sign}.png")

toyMC_canvas_N_total = ROOT.TCanvas("toyMC_canvas_N_total", "D+ fit", 800, 600)
toyMC_frame_N_total.Draw()
toyMC_canvas_N_total.SaveAs(f"toy_ref_N_total_{tree_name}_{args.sign}.png")

toyMC_canvas_N_total_Ds = ROOT.TCanvas("toyMC_canvas_N_total_Ds", "D+ fit", 800, 600)
toyMC_frame_N_total_Ds.Draw()
toyMC_canvas_N_total_Ds.SaveAs(f"toy_ref_N_total_Ds_{tree_name}_{args.sign}.png")
