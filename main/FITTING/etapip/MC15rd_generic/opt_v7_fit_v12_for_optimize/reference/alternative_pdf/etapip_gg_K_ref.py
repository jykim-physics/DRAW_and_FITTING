...
suffix = "sumw2fixed_alternative_extend_exp"
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_ref_fit_loose_v7_fitv12_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_ref_fit_loose_v7_fitv12_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_ref_fit_loose_v7_fitv12_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.pdf"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_loose_v7_fitv12_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_loose_v7_fitv12_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
...
for element in cm_elements:
    pattern = f"{base_path}/{element}/{tree_name}/ref/min_unc_search/{BDT_cut}/weighted/*BDT.root"
...
full_var_set = ROOT.RooArgSet(x, Pip_charge, Dp_CMS_cosTheta, BDT, Pip_dr, Dp_dz,
                              ...
                              Dp_CMS_p, ds_weight, rank_Dp_chiProb)
...
f_sig = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_ref_Dp_M_v12_CB_conv_result_extended_train_Dp_CMS_p.0.86.root")
...
f_sig_Ds = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_ref_Dp_M_v12_CB_conv_result_extended_train_Dp_CMS_p.0.86_Ds.weighted.root")
...
x_bkg1_tau2 = ROOT.RooRealVar("x_bkg1_tau2", "c0",-1, -20, 20)


#bkg_comb = ROOT.RooExponential("bkg_comb", "x_bkg1", x, x_bkg1_tau)
bkg_comb = ROOT.RooGenericPdf("bkg_comb","exp(@1*(@0-1.919) + @2*(@0-1.919)*(@0-1.919))",ROOT.RooArgList(x, x_bkg1_tau, x_bkg1_tau2))
