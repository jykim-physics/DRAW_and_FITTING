...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/MC15rd_etapip_pipipi_fit_opt_loose_v7_fitv12_bdt_{args.train}_Dp_CMS_{args.bin}_{BDT_cut}_{suffix}_weighted.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/MC15rd_etapip_pipipi_fit_opt_loose_v7_fitv12_bdt_{args.train}_Dm_CMS_{args.bin}_{BDT_cut}_{suffix}_weighted.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/MC15rd_etapip_pipipi_fit_opt_loose_v7_fitv12_bdt_{args.train}_Dall_CMS_{args.bin}_{BDT_cut}_{suffix}_weighted.pdf"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/MC15rd_etapip_pipipi_fit_opt_loose_v7_fitv12_bdt_{args.train}_{args.bin}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/MC15rd_etapiop_pipipi_fit_opt_loose_v7_fitv12_bdt_{args.train}_{args.bin}_{BDT_cut}_{suffix}_weighted.txt"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 60000*scale*N_scale,  1000*scale*N_scale, 2400000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 140000*scale*N_scale,  2000*scale*N_scale,2000000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 25000*scale*N_scale, 1000*scale*N_scale,2500000*scale*N_scale)
...
mean = ROOT.RooRealVar("mean", "mean", 1.87, 1.84, 1.90)
