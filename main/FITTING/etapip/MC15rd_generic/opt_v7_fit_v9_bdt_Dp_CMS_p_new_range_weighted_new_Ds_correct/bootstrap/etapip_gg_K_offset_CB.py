...
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/bootstrap_sys_MC15rd_etaKp_gg_loose_v7_fitv9_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/bootstrap_sys_MC15rd_etaKp_gg_loose_v7_fitv9_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/bootstrap_sys_MC15rd_etaKp_gg_loose_v7_fitv9_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv9_bdt_train_Dp_CMS_p_{args.sign}_0.91_new_Ds_correct_weighted.root")
...
f_sig = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15re_6M_etapip_gg_K_Dp_M_opt_v7_DSCBShape_conv_result_extended_train_Dp_CMS_p.0.91_new_Ds_correct.root")
...
f_sig_Ds = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_Dp_M_opt_v7_DSCBShape_conv_result_extended_train_Dp_CMS_p_Ds.0.91.weighted.new_Ds_correct.root")
...
with uproot.recreate(f"bootstrap_acp_results_etapip_gg_K_{args.sign}_converge_DSCBShape.root") as f:
