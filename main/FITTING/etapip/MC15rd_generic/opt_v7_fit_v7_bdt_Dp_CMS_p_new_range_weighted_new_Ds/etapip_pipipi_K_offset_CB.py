...
suffix = "new_Ds"
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv7_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv7_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv7_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv7_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 4000*scale*N_scale, 0*scale*N_scale,30000*scale*N_scale)  # N_total = N_D+ + N_D-
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.00038286250162808584)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.000030610804058291363)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.3604436441464522)
nL = ROOT.RooRealVar("nL", "nL",  2.258098910264998 )
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.04069234937508905)
nR = ROOT.RooRealVar("nR", "nR", 2.1339976039206445)
...
sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian",  0.004243227053535413)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.0020004650243540104)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma", 0.001862046593416873)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL",0.9201531381716461)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.8914725952058635)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 1.1991172378600705)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.314194474521476)
...
Ds_sigma_gaussian = ROOT.RooRealVar("Ds_sigma_gaussian", "sigma of Gaussian", 0.004327315721158852)
