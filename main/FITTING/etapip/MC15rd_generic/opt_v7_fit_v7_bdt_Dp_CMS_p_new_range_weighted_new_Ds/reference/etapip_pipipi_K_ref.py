...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/MC15rd_etapip_pipipi_ref_bdt_fit_opt_loose_v7_fitv7_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_weighted.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/MC15rd_etapip_pipipi_ref_bdt_fit_opt_loose_v7_fitv7_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_weighted.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/MC15rd_etapip_pipipi_ref_bdt_fit_opt_loose_v7_fitv7_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/MC15rd_etapip_pipipi_ref_bdt_fit_opt_loose_v7_fitv7_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.txt"
...
for element in cm_elements:
    ...
    pattern = f"{base_path}/{element}/{tree_name}/ref/min_unc_search/new_Ds/0.90/weighted/*.BCS.root"
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.0011241744562425636)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0008000909477480385)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.6975917953017954)
nL = ROOT.RooRealVar("nL", "nL",  2.2005510326931534)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.8216613087136628)
nR = ROOT.RooRealVar("nR", "nR", 1.9043650006947928)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.0004893348569014754)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma", 0.0014088258296419973)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.2500887311918691)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.5963149918606865)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR",0.9281145390343316 )
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.3509185408896944)
...
novo_sigma = ROOT.RooRealVar("novo_sigma", "Sigma", 0.05523966396914679)
novo_tail = ROOT.RooRealVar("novo_tail", "Tail", 0.2601851289874964)
