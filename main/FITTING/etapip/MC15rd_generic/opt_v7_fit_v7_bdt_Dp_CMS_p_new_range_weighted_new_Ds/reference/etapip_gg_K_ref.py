...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv7_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_weighted.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv7_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_weighted.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv7_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv7_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.txt"
...
for element in cm_elements:
    pattern = f"{base_path}/{element}/{tree_name}/ref/min_unc_search/new_Ds/{BDT_cut}/weighted/*.BCS.root"
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.0007509549692479452)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0011260869202330413)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.17857489032600182)
nL = ROOT.RooRealVar("nL", "nL",  3.324298679852679)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.5655164410098729)
nR = ROOT.RooRealVar("nR", "nR", 2.526737418747927)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.006504423686210494)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma", 0.0031362282578949316)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 1.1442793110364822)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.1082359816095977)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 1.118714883711024)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.6751279959236105)
