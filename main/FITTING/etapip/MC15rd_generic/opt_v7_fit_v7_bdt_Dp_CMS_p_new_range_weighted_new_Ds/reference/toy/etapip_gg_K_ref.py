...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv6_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_weighted.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv6_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_weighted.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv6_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv6_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.txt"
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 180000*scale*N_scale, 50000*scale*N_scale,250000*scale*N_scale)  # N_total = N_D+ + N_D-
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.0007551577386909823)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0011394686619537085)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.18127343630327344)
nL = ROOT.RooRealVar("nL", "nL",  3.3466025576942355)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.5639013558384207)
nR = ROOT.RooRealVar("nR", "nR", 2.5818609719002246)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.0005438869446034505)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma", 0.0009552402137611152)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.12984567421491908)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.279322587559946)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.47405164166264835)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.7128830097995666)
...
novo_sigma = ROOT.RooRealVar("novo_sigma", "Sigma", 0.048148327739609566 )
novo_tail = ROOT.RooRealVar("novo_tail", "Tail", 0.08566602385647656)
...
bkg_frac = ROOT.RooRealVar("bkg_frac", "fraction of Gaussian in BKG", 0.3, 0.001, 1)
