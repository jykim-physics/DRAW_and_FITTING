...
suffix = "new_Ds"
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv7_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv7_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv7_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv7_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
file_sweight = f"/share/storage/jykim/sweight/proc13/etaKp/gg/proc13_etapip_gg_K_fit_opt_loose_v7_fitv7_Ds_weighted.root"
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.002498752005663582)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0010605844583011824)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.569142112224553)
nL = ROOT.RooRealVar("nL", "nL", 4.167773053369879 )
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.499871287743246)
nR = ROOT.RooRealVar("nR", "nR", 2.9070066654229554)
...
sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian",  0.007650969929588886)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.0019668519120909027)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",  0.0008588082312484825)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.4602495461031604)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL",3.918093089428148 )
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.45455699604406885)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR",  2.7285969756870356)
...
Ds_sigma_gaussian = ROOT.RooRealVar("Ds_sigma_gaussian", "sigma of Gaussian", 0.00844575151541912)
