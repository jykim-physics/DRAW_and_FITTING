...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dp_CMS_{args.sign}_new_FOM.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dm_CMS_{args.sign}_new_FOM.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_new_FOM.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_new_FOM.txt"
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.00009520864085511117)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0001618429261129044)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.08244560454153231)
nL = ROOT.RooRealVar("nL", "nL",  2.49454734277236)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.20850798928348951)
nR = ROOT.RooRealVar("nR", "nR", 2.213749062035608)
...
sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian", 0.004241373518532257)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.0018231925895088514)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma", 0.002112248548353345)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL",0.864398827396178)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.982115263857262)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 1.2608709908162772)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.486190064977856)
...
Ds_sigma_gaussian = ROOT.RooRealVar("Ds_sigma_gaussian", "sigma of Gaussian", 0.0043668294520461505)
