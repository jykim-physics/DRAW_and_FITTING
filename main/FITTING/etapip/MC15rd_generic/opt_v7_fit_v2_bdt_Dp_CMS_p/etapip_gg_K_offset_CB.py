...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv2_bdt_{args.train}_Dp_CMS_{args.sign}_new_FOM.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv2_bdt_{args.train}_Dm_CMS_{args.sign}_new_FOM.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv2_bdt_{args.train}_{args.sign}_new_FOM.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv2_bdt_{args.train}_{args.sign}_new_FOM.txt"
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.00048278620540487727)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0006334894435389718)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.11924153861640896)
nL = ROOT.RooRealVar("nL", "nL", 4.4574919301041005)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.31424898367508963)
nR = ROOT.RooRealVar("nR", "nR", 3.0903936142531285)
...
sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian", 0.007767601157877103)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.0016394898564159749)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",  0.0004262287153548215)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.42003974451058174)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.932351713894057)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.29172776440769715)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.561398493822674)
...
Ds_sigma_gaussian = ROOT.RooRealVar("Ds_sigma_gaussian", "sigma of Gaussian", 0.00868294975857218)
