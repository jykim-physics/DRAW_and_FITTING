...
if args.sign == "plus":
	Dp_CMS_cosTheta_cut = "Dp_CMS_cosTheta>0 && abs(etapip_Eta_daughterDiffOfPhi_0_1)<1.8 && etapip_Eta_daughterAngle_0_1<1.6"
	N_scale = 0.64
elif args.sign == "minus":
	Dp_CMS_cosTheta_cut = "Dp_CMS_cosTheta<0 && abs(etapip_Eta_daughterDiffOfPhi_0_1)<1.8 && etapip_Eta_daughterAngle_0_1<1.6"
	N_scale = 0.43
elif args.sign == "all":
	Dp_CMS_cosTheta_cut = "Dp_CMS_cosTheta>-10 && abs(etapip_Eta_daughterDiffOfPhi_0_1)<1.8 && etapip_Eta_daughterAngle_0_1<1.6"
	N_scale = 1

suffix = "sumw2fixed"
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_nobdt_fit_Dp_CMS_{args.sign}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_nobdt_fit_Dm_CMS_{args.sign}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_nobdt_fit_Dall_CMS_{args.sign}_{suffix}.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_nobdt_fit_{args.sign}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapiop_gg_nobdt_fit_{args.sign}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/proc13/etapip/gg/MC15rd_etapip_gg_nobdt_fit.root"
...
etapip_Eta_daughterDiffOfPhi_0_1 = ROOT.RooRealVar("etapip_Eta_daughterDiffOfPhi_0_1", "etapip_Eta_daughterDiffOfPhi_0_1", -1000, 1000)
etapip_Eta_daughterAngle_0_1 = ROOT.RooRealVar("etapip_Eta_daughterAngle_0_1", "etapip_Eta_daughterAngle_0_1", -1000, 1000)

full_var_set = ROOT.RooArgSet(x, Pip_charge, Dp_CMS_cosTheta, Pip_dr, Dp_dz,
                              Dp_cosAngleBetweenMomentumAndVertexVectorInXYPlane,
                              etapip_Eta_Easym, Dp_cosHelicityAngleMomentum, etapip_Eta_daughterDiffOfPhi_0_1, etapip_Eta_daughterAngle_0_1,
                              Dp_CMS_p)
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 110000*scale*N_scale, 50000*scale*N_scale, 1000000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 210000*scale*N_scale, 80000*scale*N_scale, 2000000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 600000*scale*N_scale, 100000*scale*N_scale,1000000000*scale*N_scale)
