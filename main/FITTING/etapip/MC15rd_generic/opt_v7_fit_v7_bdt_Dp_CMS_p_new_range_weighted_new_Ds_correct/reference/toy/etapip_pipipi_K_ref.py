...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/MC15rd_etapip_pipipi_ref_bdt_fit_opt_loose_v7_fitv6_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_weighted.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/MC15rd_etapip_pipipi_ref_bdt_fit_opt_loose_v7_fitv6_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_weighted.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/MC15rd_etapip_pipipi_ref_bdt_fit_opt_loose_v7_fitv6_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/MC15rd_etapip_pipipi_ref_bdt_fit_opt_loose_v7_fitv6_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.txt"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 40000*scale*N_scale, 10000*scale*N_scale, 100000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 80000*scale*N_scale, 20000*scale*N_scale,200000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+",  100000*scale*N_scale, 20000*scale*N_scale,400000*scale*N_scale)
...
Acp_bkg = RooRealVar("Acp_bkg", "Acp", 0, -0.1, 0.1)  # A_Cp as a fit parameter
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.0010292162986977609)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0008136820137925751)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.6318765684461668)
nL = ROOT.RooRealVar("nL", "nL",  2.24718600725933)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.8212609422427125)
nR = ROOT.RooRealVar("nR", "nR", 1.9201357311210538 )
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.0005117035009126359)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma", 0.0013869337971471342)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.25526752818772525)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.6316560677894176)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.9298561807440398)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.3126221504409723 )
...
ROOT.RooRandom.randomGenerator().SetSeed(250413)
...
toyMC_canvas.SaveAs(f"toy_Acp_{tree_name}_{args.sign}_ref.png")

toyMC_canvas_Ds = ROOT.TCanvas("toyMC_canvas_Ds", "D+ fit", 800, 600)
toyMC_frame_Acp_Ds.Draw()
toyMC_canvas_Ds.SaveAs(f"toy_Acp_Ds_{tree_name}_{args.sign}_ref.png")

toyMC_canvas_N_total = ROOT.TCanvas("toyMC_canvas_N_total", "D+ fit", 800, 600)
toyMC_frame_N_total.Draw()
toyMC_canvas_N_total.SaveAs(f"toy_N_total_{tree_name}_{args.sign}_ref.png")

toyMC_canvas_N_total_Ds = ROOT.TCanvas("toyMC_canvas_N_total_Ds", "D+ fit", 800, 600)
toyMC_frame_N_total_Ds.Draw()
toyMC_canvas_N_total_Ds.SaveAs(f"toy_N_total_Ds_{tree_name}_{args.sign}_ref.png")
