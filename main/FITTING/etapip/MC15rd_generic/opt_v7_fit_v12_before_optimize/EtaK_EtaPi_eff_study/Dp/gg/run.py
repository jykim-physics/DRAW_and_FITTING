...
path_A = [
    "/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/DptoetaKp_gg/260107_loose_v7_less_vars_ntuple/etapip_gg_K/min_unc_search/no_bdt/*.root",
    "/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/DptoetaKp_gg_cc/260107_loose_v7_less_vars_ntuple/etapip_gg_K/min_unc_search/no_bdt/*.root"
]
...
path_B = [
    "/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dptoetapip_gg/260107_loose_v7_less_vars_ntuple/etapip_gg/ref/min_unc_search/no_bdt/*.root",
    "/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dptoetapip_gg_cc/260107_loose_v7_less_vars_ntuple/etapip_gg/ref/min_unc_search/no_bdt/*.root"
]
...
#legend.AddEntry(h_A, "D^{+} #rightarrow #eta_{#gamma#gamma} K^{+}", "le")
#legend.AddEntry(h_B, "D^{+} #rightarrow #eta_{#gamma#gamma} #pi^{+}", "le")
legend.AddEntry(h_A, "D^{+} #rightarrow #eta_{#gamma#gamma} K^{+}", "l")
legend.AddEntry(h_B, "D^{+} #rightarrow #eta_{#gamma#gamma} #pi^{+}", "l")
legend.Draw()
