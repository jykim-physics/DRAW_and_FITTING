...
# --- 2. TChain 설정 (파일 묶기) ---
path_A = [
    "/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/DsptoetaKp_pipipi/260107_loose_v7_less_vars_ntuple/etapip_pipipi_K/min_unc_search/no_bdt/*.root",
    "/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/DsptoetaKp_pipipi_cc/260107_loose_v7_less_vars_ntuple/etapip_pipipi_K/min_unc_search/no_bdt/*.root"
]
...
path_B = [
    "/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dsptoetapip_pipipi/260107_loose_v7_less_vars_ntuple/etapip_pipipi/ref/min_unc_search/no_bdt/*.root",
    "/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dsptoetapip_pipipi_cc/260107_loose_v7_less_vars_ntuple/etapip_pipipi/ref/min_unc_search/no_bdt/*.root"
]
...
# --- 4. 데이터 채우기 (Cut 적용) ---
cut_string = "etapip_Eta_isSignal == 1 && etapip_Eta_genMotherID == Pip_genMotherID && abs(Pip_genMotherPDG)==431"
...
legend.AddEntry(h_A, "D^{+}_{s} #rightarrow #eta_{3#pi} K^{+}", "l")
legend.AddEntry(h_B, "D^{+}_{s} #rightarrow #eta_{3#pi} #pi^{+}", "l")
legend.Draw()
