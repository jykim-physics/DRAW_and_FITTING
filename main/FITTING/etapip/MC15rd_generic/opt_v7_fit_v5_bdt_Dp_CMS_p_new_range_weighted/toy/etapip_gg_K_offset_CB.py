...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv5_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_weighted.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv5_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_weighted.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv5_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv5_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.txt"
file_sweight = f"/share/storage/jykim/sweight/proc13/etaKp/gg/proc13_etapip_gg_K_fit_opt_loose_v7_fitv5_Ds_weighted.root"
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigmaL", 0.0016243535796111666)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigmaR",  0.0005150175759566298)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.38854510903933026 )
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.926635258924248 )
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.28094235770858317)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.77250522286847 )
...
Ds_sigma_gaussian = ROOT.RooRealVar("Ds_sigma_gaussian", "sigma of Gaussian", 0.008450506154226007)
