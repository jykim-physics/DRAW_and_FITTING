...
suffix = "KDE_fixed_Acp_peak_alternative_pdf_exp"
...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv12_bdt_train_Dp_CMS_p_{args.sign}_0.77_KDE_fixed_Acp_peak_weighted.root")
...
def nominal_fit_extract_Acp(data_Dp, data_Dm):
  ...
  x_bkg1_c1.setVal(0.1)
  x_bkg1_c2.setVal(0.1)
