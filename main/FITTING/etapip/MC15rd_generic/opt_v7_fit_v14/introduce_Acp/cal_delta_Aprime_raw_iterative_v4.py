...
# Configuration
# etapip_pipipi_K
float_tags = ["mean", "scale_factor", "Ds_mean", "x_bkg1_tau1", "x_bkg1_tau2"]
target_dir = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/"
file_original_plus  = os.path.join(target_dir, "MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv14_bdt_train_Dp_CMS_p_plus_0.77_KDE_fixed_2nd_cheby_weighted.root")
file_original_minus = os.path.join(target_dir, "MC15rd_etaKp_pipipi_fit_opt_loose_v7_fitv14_bdt_train_Dp_CMS_p_minus_0.77_KDE_fixed_2nd_cheby_weighted.root")

pattern_plus = os.path.join(target_dir, "*fitv14_bdt_train_Dp_CMS_p_plus_0.77_sumw2fixed_float_var_*_weighted.root")
pattern_minus = os.path.join(target_dir, "*fitv14_bdt_train_Dp_CMS_p_minus_0.77_sumw2fixed_float_var_*_weighted.root")

# etapip_gg_K
#float_tags = ["mean", "scale_factor", "Ds_mean", "x_bkg1_c1", "x_bkg1_c2"]
#file_original_plus  = "/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_2nd_poly_fitv13_bdt_train_Dp_CMS_p_plus_0.86_KDE_fixed_2nd_cheby_weighted.root"
#file_original_minus = "/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_2nd_poly_fitv13_bdt_train_Dp_CMS_p_minus_0.86_KDE_fixed_2nd_cheby_weighted.root"

#target_dir = "/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/"
#pattern_plus = os.path.join(target_dir, "*fitv13_bdt_train_Dp_CMS_p_plus_0.86_sumw2fixed_float_var_*_weighted.root")
#pattern_minus = os.path.join(target_dir, "*fitv13_bdt_train_Dp_CMS_p_minus_0.86_sumw2fixed_float_var_*_weighted.root")
