...
ROOT.SetBelle2Style()
plot_file_name = "/share/storage/jykim/plots/MC15rd/etapip/pipipi/MC15rd_etapip_pipipi_Dp_M_opt_v7_fit_v11_novo_rhopeta_Dp_CMS_p_0.74_new_Ds_correct.png"
result_name = "/share/storage/jykim/plots/MC15rd/etapip/pipipi/MC15rd_etapip_pipipi_Dp_M_opt_v7_fit_v11_novo_result_rhopeta_Dp_CMS_p_0.74_new_Ds_correct.txt"
fitresult_root = "/share/storage/jykim/plots/MC15rd/etapip/pipipi/MC15rd_etapip_pipipi_Dp_M_opt_v7_fit_v11_novo_result_rhopeta_Dp_CMS_p_0.74_new_Ds_correct.root"
...
cuts_Dp = "Pip_charge==1 && Pip_genMotherPDG==213 && etapip_Eta_genMotherPDG==431 && nAllSigCascDcyBr_16>0"
cuts_Dm = "Pip_charge==-1 && Pip_genMotherPDG==-213 && etapip_Eta_genMotherPDG==-431 && nAllSigCascDcyBr_16>0"
...
before_data = ROOT.RooDataSet("data","", mychain, ROOT.RooArgSet(x,Pip_charge, Pip_genMotherPDG, etapip_Eta_genMotherPDG, nAllSigCascDcyBr_16), cuts_Dp)
...
before_data_cc = ROOT.RooDataSet("data_cc","", mychain_cc, ROOT.RooArgSet(x,Pip_charge, Pip_genMotherPDG, etapip_Eta_genMotherPDG, nAllSigCascDcyBr_16), cuts_Dm)
