...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/MC15rd_etapip_pipipi_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dp_CMS_{args.sign}_new_FOM.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/MC15rd_etapip_pipipi_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dm_CMS_{args.sign}_new_FOM.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/MC15rd_etapip_pipipi_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_new_FOM.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/MC15rd_etapip_pipipi_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_new_FOM.txt"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 80000*scale*N_scale, 40000*scale*N_scale, 120000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 120000*scale*N_scale, 60000*scale*N_scale,160000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 400000*scale*N_scale, 200000*scale*N_scale,600000*scale*N_scale)
...
sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian", 0.0006, 0.00001, 0.01)
...
Ds_sigma_gaussian = ROOT.RooRealVar("Ds_sigma_gaussian", "sigma of Gaussian", 0.0006, 0.00001, 0.01)
...
novo_mean = ROOT.RooRealVar("novo_mean", "Mean",  1.73, 1.70,1.75)
...
ToyMC_all = ROOT.RooMCStudy(sim_model, {x,cat}, Extended(True), FitOptions(Save(True),PrintEvalErrors(0),PrintLevel(-1), NumCPU(28), Offset(True)))
ToyMC_all.generateAndFit(1000)

toyMC_frame_Acp = ToyMC_all.plotPull(Acp, Bins(20), FitGauss(True))
toyMC_frame_Acp_Ds = ToyMC_all.plotPull(Acp_Ds, Bins(20), FitGauss(True))
toyMC_frame_N_total = ToyMC_all.plotPull(N_total, Bins(20), FitGauss(True))
toyMC_frame_N_total_Ds = ToyMC_all.plotPull(N_total_Ds, Bins(20), FitGauss(True))
