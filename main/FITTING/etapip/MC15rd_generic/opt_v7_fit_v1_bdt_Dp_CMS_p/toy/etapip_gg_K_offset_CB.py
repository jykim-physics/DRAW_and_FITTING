...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dp_CMS_{args.sign}_new_FOM.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dm_CMS_{args.sign}_new_FOM.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_new_FOM.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_new_FOM.txt"
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.003348351362190105)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0013291398880326234)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.7315521824137551)
nL = ROOT.RooRealVar("nL", "nL", 4.238254299605553)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.6153540200901512)
nR = ROOT.RooRealVar("nR", "nR", 2.880337361331496)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.002581051411078383)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",   0.0009752481704527435)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.6045761227782245)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.7131259293766763)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.5137811654421556)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR",  2.6950265183653985)
...
Ds_sigma_gaussian = ROOT.RooRealVar("Ds_sigma_gaussian", "sigma of Gaussian", 0.008410786141027733)
