...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dp_CMS_{args.sign}_new_FOM.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dm_CMS_{args.sign}_new_FOM.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_new_FOM.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_new_FOM.txt"
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 180000*scale*N_scale, 150000*scale*N_scale,210000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 140000*scale*N_scale, 100000*scale*N_scale,250000*scale*N_scale)
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL", 0.0007631530061269721 )
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR", 0.001137250723631869 )
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.18061732848861453)
nL = ROOT.RooRealVar("nL", "nL", 3.3656520804293706 )
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.5646845612867496)
nR = ROOT.RooRealVar("nR", "nR", 2.5589977542125038 )
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma",  0.0006502319360911703)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",  0.0009786366594516267)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL",0.1593654914168797)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.1561107527458265)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR",  0.5282926897109578)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.441953863962658)
