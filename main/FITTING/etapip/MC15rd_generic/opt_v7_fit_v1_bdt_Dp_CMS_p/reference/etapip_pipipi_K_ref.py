...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/MC15rd_etapip_pipipi_ref_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dp_CMS_{args.sign}_new_FOM.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/MC15rd_etapip_pipipi_ref_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dm_CMS_{args.sign}_new_FOM.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etapip_pipipi_ref_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_new_FOM.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/MC15rd_etapip_pipipi_ref_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_new_FOM.txt"
...
for element in cm_elements:
    pattern = f"{base_path}/{element}/{tree_name}/train_Dp_dz/skimhad/ref/new_FOM/*.BCS.root"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 40000*scale*N_scale, 20000*scale*N_scale, 80000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 80000*scale*N_scale, 30000*scale*N_scale,180000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 200000*scale*N_scale, 100000*scale*N_scale,600000*scale*N_scale)
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.005090338569415339)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.001010173524680757)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 1.648930971871059)
nL = ROOT.RooRealVar("nL", "nL",  1.939437249356639)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.7265899453380051)
nR = ROOT.RooRealVar("nR", "nR", 1.9796398154011776)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.00024065639193778874)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",   0.0013679651830129534)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.12717208276048111)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.5447889452158985)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.9729867883091597)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.2234497347814117)
