...
N_start = N_input[0]
N_end = N_input[-1]
np_N_input = np.linspace(N_start*0.98,N_end*1.02,101)
...
plt.plot([N_start*0.98,N_end*1.02], [N_start*0.98,N_end*1.02], label='y=x')
...
plt.xlim(N_start*0.98,N_end*1.02)
plt.ylim(N_start*0.98,N_end*1.02)
