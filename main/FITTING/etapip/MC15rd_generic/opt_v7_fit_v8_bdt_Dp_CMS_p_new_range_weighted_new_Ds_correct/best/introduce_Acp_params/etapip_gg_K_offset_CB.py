...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv8_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv8_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv8_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_{suffix}_weighted.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
file_sweight = f"/share/storage/jykim/sweight/proc13/etaKp/gg/proc13_etapip_gg_K_fit_opt_loose_v7_fitv8_Ds_weighted.root"
...
x_bkg1_tau_plus = ROOT.RooRealVar("x_bkg1_tau_plus", "c0",-5, -20, 5)
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.002445081227437)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.001009558260554995)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.5591077662504114)
nL = ROOT.RooRealVar("nL", "nL", 4.239217138754572)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.49355314276643864)
nR = ROOT.RooRealVar("nR", "nR", 2.8723638332911183)

Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.001953627298541603)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",  0.0008559072367716423)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.4748153810384975)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.7597294908043644)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.4461236739009865)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR",  2.808865944270743)

sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian",  0.007683822512620898)
Ds_sigma_gaussian = ROOT.RooRealVar("Ds_sigma_gaussian", "sigma of Gaussian", 0.008545408576890082)
...
if args.float_var == "mean":
    ...
    model_D_plus = ROOT.RooAddPdf("model_D_plus", "D+ model",
                                  ROOT.RooArgList(sig_model_plus, Ds_model_plus, model_bkg),
                                  ROOT.RooArgList(Nsig_D_plus, Nsig_Ds_plus,  Nbkg_D_plus))
    model_D_minus = ROOT.RooAddPdf("model_D_minus", "D- model",
                                  ROOT.RooArgList(sig_model_minus, Ds_model_minus,  model_bkg),
                                  ROOT.RooArgList(Nsig_D_minus, Nsig_Ds_minus,  Nbkg_D_minus))
