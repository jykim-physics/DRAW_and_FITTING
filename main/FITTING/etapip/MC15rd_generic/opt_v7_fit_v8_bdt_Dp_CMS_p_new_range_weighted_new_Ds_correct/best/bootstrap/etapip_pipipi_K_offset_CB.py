...
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/bootstrap_sys_MC15rd_etaKp_pipipi_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/bootstrap_sys_MC15rd_etaKp_pipipi_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/bootstrap_sys_MC15rd_etaKp_pipipi_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
...
with uproot.recreate(f"bootstrap_acp_results_etapip_pipipi_K_{args.sign}_converge_SumW2Error.root") as f:
