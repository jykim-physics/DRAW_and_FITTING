...
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/bootstrap_sys_MC15rd_etapip_gg_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/bootstrap_sys_MC15rd_etapip_gg_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/bootstrap_sys_MC15rd_etapip_gg_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_fit_opt_loose_v7_fitv8_bdt_train_Dp_CMS_p_{args.sign}_0.83_new_Ds_correct_weighted.root")
...
with uproot.recreate(f"bootstrap_acp_results_etapip_gg_{args.sign}_converge_not_quarter.root") as f:
