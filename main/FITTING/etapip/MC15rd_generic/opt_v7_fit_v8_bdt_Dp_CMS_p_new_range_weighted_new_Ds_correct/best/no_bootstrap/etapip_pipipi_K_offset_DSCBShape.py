...
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/no_bootstrap/sys_MC15rd_etaKp_pipipi_loose_v7_fitv9_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/no_bootstrap/sys_MC15rd_etaKp_pipipi_loose_v7_fitv9_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted_v2.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/generic/fitresult/no_bootstrap/sys_MC15rd_etaKp_pipipi_loose_v7_fitv9_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted_v2.txt"
...
N_total_var = RooRealVar("N_total_var", "N_total (N_D+ + N_D-)", 1200*scale*N_scale, 0*scale*N_scale, 4000*scale*N_scale)  # N_total = N_D+ + N_D-
...
def var_fit_extract_Acp(data_Dp, data_Dm, n_bootstrap):
  sigmaLR_var= ROOT.RooRealVar("sigmaLR_var", "sigmaLR_var", sample_param( fit_sigmaLR.getVal(), fit_sigmaLR.getError()))
...
with uproot.recreate(f"no_bootstrap_acp_results_etapip_pipipi_K_{args.sign}_DSCBShape_v2.root") as f:
