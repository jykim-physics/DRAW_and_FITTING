...
file_name_Dp = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv8_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_weighted.png"
file_name_Dm = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv8_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_weighted.png"
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv8_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_weighted.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.txt"
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 180000*scale*N_scale, 50000*scale*N_scale,210000*scale*N_scale)  # N_total = N_D+ + N_D-
...
#minimizer.setMaxFunctionCalls(30000)  # Max calls
#minimizer.setMaxIterations(30000)      # Max iterations
...
ROOT.RooRandom.randomGenerator().SetSeed(250502)
