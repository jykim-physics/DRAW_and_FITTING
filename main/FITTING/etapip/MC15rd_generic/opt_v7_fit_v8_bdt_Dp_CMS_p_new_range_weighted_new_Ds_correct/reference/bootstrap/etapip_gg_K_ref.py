...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 180000*scale*N_scale, 50000*scale*N_scale,360000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds_var = RooRealVar("N_total_Ds_var", "N_total (N_Ds+ + N_Ds-)", 180000*scale*N_scale, 50000*scale*N_scale,360000*scale*N_scale)  # N_total = N_D+ + N_D-
...
with uproot.recreate(f"bootstrap_acp_results_ref_etapip_gg_{args.sign}_v2.root") as f:
