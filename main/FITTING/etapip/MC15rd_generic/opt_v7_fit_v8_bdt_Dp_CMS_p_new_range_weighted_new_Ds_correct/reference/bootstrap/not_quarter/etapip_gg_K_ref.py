...
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/ref_bootstrap_sys_MC15rd_etapip_gg_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/ref_bootstrap_sys_MC15rd_etapip_gg_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/ref_bootstrap_sys_MC15rd_etapip_gg_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)",  80000*scale*N_scale, 40000*scale*N_scale, 200000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 180000*scale*N_scale, 50000*scale*N_scale,400000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 140000*scale*N_scale, 40000*scale*N_scale,250000*scale*N_scale)
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.0011331606229133596)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0011791954197156265)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.2650231692940739)
nL = ROOT.RooRealVar("nL", "nL",  3.3633095502439505)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.5791937659190894)
nR = ROOT.RooRealVar("nR", "nR", 2.5602555393169295)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.0028976264206557237)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma", 0.002905968011708026)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.6010419971074595)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.277632587828558)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 1.1173816979664188)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.4639087617897415)
...
Ds_sigma_gaussian = ROOT.RooRealVar("Ds_sigma_gaussian", "sigma of Gaussian", 0.007, 0.001, 0.1)
...
novo_sigma = ROOT.RooRealVar("novo_sigma", "Sigma", 0.04815062892697982)
novo_tail = ROOT.RooRealVar("novo_tail", "Tail", 0.08483878211621003)
...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etapip/gg/generic/fitresult/MC15rd_etapip_gg_ref_fit_opt_loose_v7_fitv8_bdt_train_Dp_CMS_p_{args.sign}_0.91_weighted.root")
...
N_total_var = RooRealVar("N_total_var", "N_total (N_D+ + N_D-)", 80000*scale*N_scale, 40000*scale*N_scale, 200000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds_var = RooRealVar("N_total_Ds_var", "N_total (N_Ds+ + N_Ds-)", 180000*scale*N_scale, 50000*scale*N_scale,400000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total_var = ROOT.RooRealVar("Nbkg_total_var", "Number of background events for D+", 140000*scale*N_scale, 40000*scale*N_scale,250000*scale*N_scale)
...
x_bkg1_tau_var = ROOT.RooRealVar("x_bkg1_tau_var", "c0",-3, -8, -0.01)
...
sigma_gaussian_var = ROOT.RooRealVar("sigma_gaussian_var", "sigma of Gaussian", 0.008, 0.001, 0.1)
Ds_sigma_gaussian_var = ROOT.RooRealVar("Ds_sigma_gaussian_var", "sigma of Gaussian", 0.007, 0.001, 0.1)

f_sig = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_ref_Dp_M_opt_v7_CB_conv_result_extended_train_Dp_CMS_p.0.91_new_Ds_correct.root")
...
f_sig_Ds = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_ref_Dp_M_opt_v7_CB_conv_result_extended_train_Dp_CMS_p.0.91_Ds_new_Ds_correct.root")
...
f_rhopeta = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etapip/gg/MC15rd_etapip_gg_Dp_M_opt_v7_novo_result_rhopeta_from_Dsp_peak_Dp_CMS_p_0.83_new_Ds_correct.root")
...
with uproot.recreate(f"bootstrap_acp_results_ref_etapip_gg_{args.sign}_not_quarter.root") as f:
