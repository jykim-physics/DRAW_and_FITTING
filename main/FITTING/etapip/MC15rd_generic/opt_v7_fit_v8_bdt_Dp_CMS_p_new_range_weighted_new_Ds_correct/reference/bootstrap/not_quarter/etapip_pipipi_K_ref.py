...
file_name_Dall = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/ref_bootstrap_sys_MC15rd_etapip_pipipi_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted_Dall"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/ref_bootstrap_sys_MC15rd_etapip_pipipi_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/ref_bootstrap_sys_MC15rd_etapip_pipipi_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}_weighted.txt"
...
f = ROOT.TFile.Open(f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/fitresult/MC15rd_etapip_pipipi_ref_bdt_fit_opt_loose_v7_fitv8_bdt_train_Dp_CMS_p_{args.sign}_0.92_weighted.root")
...
N_total_var = RooRealVar("N_total_var", "N_total (N_D+ + N_D-)",  40000*scale*N_scale, 10000*scale*N_scale, 80000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds_var = RooRealVar("N_total_Ds_var", "N_total (N_Ds+ + N_Ds-)", 80000*scale*N_scale, 20000*scale*N_scale,180000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total_var = ROOT.RooRealVar("Nbkg_total_var", "Number of background events for D+", 200000*scale*N_scale, 20000*scale*N_scale,600000*scale*N_scale)
Acp_bkg_var= RooRealVar("Acp_bkg_var", "Acp", 0, -0.1, 0.1)  # A_Cp as a fit parameter
...
with uproot.recreate(f"bootstrap_acp_results_ref_etapip_pipipi_{args.sign}_not_quarter.root") as f:
