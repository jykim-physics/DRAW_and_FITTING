...
before_data = ROOT.RooDataSet("data","", mychain, ROOT.RooArgSet(x,Pip_charge, Dp_CMS_cosTheta, Pip_p), cuts_Dp)
...
for i in file_list:
    mychain_cc.Add(i)
before_data_cc = ROOT.RooDataSet("data","", mychain_cc, ROOT.RooArgSet(x,Pip_charge, Dp_CMS_cosTheta, Pip_p), cuts_Dm)
...
data_combined = RooDataSet("data_combined", "Combined data", RooArgList(x, w_1, Pip_p), RooFit.Index(cat),
