...
expected_values = np.linspace(N_total_value-N_total_error*3, N_total_value+N_total_error*3, 13)
N_input = list()
N_predict = list()
Fit_error = list()
for i in expected_values:
    ...
    N_fit, temp_fit_error = Linearity_test(sim_model, cat, N_Input=i,N_gen=500)
