...
file_name_Dp_Dm = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/generic/MC15rd_etapip_pipipi_fit_opt_loose_v7_fitv6_bdt_{args.train}_Dp_Dm_CMS_{args.sign}_{BDT_cut}_weighted.png"
...
dir_path = os.path.dirname(file_name_Dp_Dm)
...
data_combined.plotOn(frame_D_plus, Name="data")
sim_model.plotOn(frame_D_plus, Name="Background", Components="model_bkg", ProjWData=(cat, data_combined),LineColor=ROOT.kGreen+2, LineStyle=ROOT.kDashDotted)
sim_model.plotOn(frame_D_plus, Name="Fitting",ProjWData=(cat, data_combined), LineColor=ROOT.kBlue)
...
canvas_D_plus.SaveAs(file_name_Dp_Dm)
