...
file_name_Dp_Dm = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv6_bdt_{args.train}_Dp_Dm_CMS_{args.sign}_{BDT_cut}_weighted.png"
fitresult_name = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv6_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.root"
fitresult_text = f"/share/storage/jykim/plots/MC15rd/etaKp/gg/generic/fitresult/MC15rd_etaKp_gg_fit_opt_loose_v7_fitv6_bdt_{args.train}_{args.sign}_{BDT_cut}_weighted.txt"
file_sweight = f"/share/storage/jykim/sweight/proc13/etaKp/gg/proc13_etapip_gg_K_fit_opt_loose_v7_fitv6_Ds_weighted.root"
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.0031703235866665713)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0013364071042770444)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.6940307805875631)
nL = ROOT.RooRealVar("nL", "nL", 4.320419119204727)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.6037874298732917)
nR = ROOT.RooRealVar("nR", "nR", 2.9604285179569074)
...
sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian",  0.007624337517155892)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigmaL",  0.0016266074792169146)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigmaR",  0.0005142537181185612)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL",  0.38924540852083706 )
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.9253742005365755 )
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.28101812526725206)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.7698941902902896)
...
Ds_sigma_gaussian = ROOT.RooRealVar("Ds_sigma_gaussian", "sigma of Gaussian", 0.008452510107869963)
