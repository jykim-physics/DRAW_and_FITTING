...
file_name_Dp = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/MC15rd_etapip_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_to_sweight.png"
file_name_Dm = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/MC15rd_etapip_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_to_sweight.png"
fitresult_name = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/MC15rd_etapip_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_{BDT_cut}_to_sweight.root"
fitresult_text = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/MC15rd_etapip_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_{BDT_cut}_to_sweight.txt"
file_sweight = f"/share/storage/jykim/sweight/proc_all/etapip/gg/proc13_etapip_gg_fit_opt_loose_v7_fitv1_to_sweight.root"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 180000*scale*N_scale, 20000*scale*N_scale, 350000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 280000*scale*N_scale, 30000*scale*N_scale,450000*scale*N_scale)
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 500000*scale*N_scale, 30000*scale*N_scale,1500000*scale*N_scale)
...
Ds_sigma_gaussian = ROOT.RooRealVar("Ds_sigma_gaussian", "sigma of Gaussian", 0.009, 0.001, 0.1)
