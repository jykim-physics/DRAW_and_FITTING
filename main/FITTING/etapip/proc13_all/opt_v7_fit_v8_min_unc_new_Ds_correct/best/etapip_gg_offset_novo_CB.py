...
file_name_Dp = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/proc13_etapip_gg_fit_opt_loose_v7_fitv8_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/proc13_etapip_gg_fit_opt_loose_v7_fitv8_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/proc13_etapip_gg_fit_opt_loose_v7_fitv8_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
fitresult_name = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/proc13_etapip_gg_fit_opt_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/proc13_etapip_gg_fit_opt_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}.txt"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 110000*scale*N_scale, 50000*scale*N_scale, 250000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 210000*scale*N_scale, 80000*scale*N_scale, 500000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 600000*scale*N_scale, 100000*scale*N_scale,1600000*scale*N_scale)
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.002094078442510935)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0005690070647217811)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.46501320390814976)
nL = ROOT.RooRealVar("nL", "nL", 3.2798397827775547)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.28467270581412824)
nR = ROOT.RooRealVar("nR", "nR", 2.5139042774448916)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.003614985279311157)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",  0.00281219933711924)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.7129838945733548)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.0997212573625346)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 1.0567733079590378)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.4082742132365413)
