...
file_name_Dp = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/proc13_etapip_pipipi_ref_fit_opt_loose_v7_fitv8_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/proc13_etapip_pipipi_ref_fit_opt_loose_v7_fitv8_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/proc13_etapip_pipipi_ref_fit_opt_loose_v7_fitv8_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
fitresult_name = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/fitresult/proc13_etapip_pipipi_ref_fit_opt_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/fitresult/proc13_etapip_pipipi_ref_fit_opt_loose_v7_fitv8_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}.txt"
...
base_path = "/share/storage/jykim/storage_b2/storage/reduced_ntuples/proc13_all/proc13_all_etapip_loose_v7_250216_CMS_Psum_v3"
...
for element in cm_elements:
    pattern = f"{base_path}/{element}/{tree_name}/ref/{BDT_cut}/*.BCS.root"
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.004913345269808326)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0009663197928095382)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 1.6254779072760308)
nL = ROOT.RooRealVar("nL", "nL",  1.999708759766505)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.7394103440441708)
nR = ROOT.RooRealVar("nR", "nR", 1.9354130513955616)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.0004442047333018935)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",  0.0014081725680841544)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.2269753726165546)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.6434442340435393)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 0.9420851867751784)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.335229358733967)
