...
file_name_Dp = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/proc13_etapip_gg_fit_opt_loose_v7_fitv5_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}.png"
file_name_Dm = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/proc13_etapip_gg_fit_opt_loose_v7_fitv5_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}.png"
fitresult_name = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/proc13_etapip_gg_fit_opt_loose_v7_fitv5_bdt_{args.train}_{args.sign}_{BDT_cut}.root"
fitresult_text = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/proc13_etapip_gg_fit_opt_loose_v7_fitv5_bdt_{args.train}_{args.sign}_{BDT_cut}.txt"
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.002602105317998184)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",  0.005097321390971373)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.5226364295168113)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.020331171147541)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 1.5444839376116895)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.3618520894642057)
