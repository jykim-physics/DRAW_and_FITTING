...
file_name_Dp = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/MC15rd_etapip_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dp_CMS_{args.sign}_ref.png"
file_name_Dm = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/MC15rd_etapip_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_Dm_CMS_{args.sign}_ref.png"
fitresult_name = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/MC15rd_etapip_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_ref.root"
fitresult_text = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/MC15rd_etapip_gg_fit_opt_loose_v7_fitv1_bdt_{args.train}_{args.sign}_ref.txt"
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 280000*scale*N_scale, 140000*scale*N_scale,400000*scale*N_scale)
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.0016461558006704725)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",   0.00310426478494243)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.35232261704689516)
nL = ROOT.RooRealVar("nL", "nL", 3.2996856176640694)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 1.1450090119542526)
nR = ROOT.RooRealVar("nR", "nR", 2.5216867078528615)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.0038944238558206432)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",  0.004402319371570082)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.7489159743007306)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.001805800715721)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 1.4182301568920128)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR",  2.298470541000102)
