...
suffix = "new_Ds"
file_name_Dp = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/proc13_etapip_gg_fit_opt_loose_v7_fitv6_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/proc13_etapip_gg_fit_opt_loose_v7_fitv6_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
fitresult_name = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/proc13_etapip_gg_fit_opt_loose_v7_fitv6_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/proc13_etapip_gg_fit_opt_loose_v7_fitv6_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}.txt"
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.0020869485063513293)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0005712205565972639)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.4666560101262363)
nL = ROOT.RooRealVar("nL", "nL",  3.260345826346382)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.28848584535927246)
nR = ROOT.RooRealVar("nR", "nR", 2.502469079086476)
...
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.002625392323167417)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",  0.00510647736447882)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.5264296656542535)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 3.0217400130142065 )
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 1.5452956448772048)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.362702051743574)
