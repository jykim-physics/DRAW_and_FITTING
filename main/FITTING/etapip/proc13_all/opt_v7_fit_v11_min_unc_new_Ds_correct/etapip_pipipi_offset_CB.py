...
suffix = "sumw2fixed"
file_name_Dp = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/proc13_etapip_pipipi_fit_opt_loose_v7_fitv11_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/proc13_etapip_pipipi_fit_opt_loose_v7_fitv11_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/proc13_etapip_pipipi_fit_opt_loose_v7_fitv11_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
fitresult_name = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/fitresult/proc13_etapip_pipipi_fit_opt_loose_v7_fitv11_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/fitresult/proc13_etapip_pipipi_fit_opt_loose_v7_fitv11_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}.txt"
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 140000*scale*N_scale,  50000*scale*N_scale,300000*scale*N_scale)  # N_total = N_D+ + N_D-
