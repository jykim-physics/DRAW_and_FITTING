...
file_name_Dp = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/proc13_etapip_pipipi_fit_opt_loose_v7_fitv6_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}.best.png"
file_name_Dm = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/proc13_etapip_pipipi_fit_opt_loose_v7_fitv6_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}.best.png"
fitresult_name = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/fitresult/proc13_etapip_pipipi_fit_opt_loose_v7_fitv6_bdt_{args.train}_{args.sign}_{BDT_cut}.best.root"
fitresult_text = f"/share/storage/jykim/plots/proc_all/etapip/pipipi/generic/fitresult/proc13_etapip_pipipi_fit_opt_loose_v7_fitv6_bdt_{args.train}_{args.sign}_{BDT_cut}.best.txt"
...
for element in cm_elements:
    pattern = f"{base_path}/{element}/{tree_name}/min_unc_search/{BDT_cut}/*.BCS.root"
...
Acp_blind = RooRealVar("Acp_blind", "Acp", 0, -0.5, 0.5)

Acp_bias = RooRealVar("Acp_bias", "Acp_bias", 0, -1, 1)
Acp_random_number = round(random.uniform(-0.1, 0.1), 10)
Acp_bias = RooRealVar("Acp_bias", "Acp_bias", Acp_random_number)
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 120000*scale*N_scale,  50000*scale*N_scale,500000*scale*N_scale)  # N_total = N_D+ + N_D-
...
Acp_Ds_blind = RooRealVar("Acp_Ds_blind", "Acp", 0, -0.5, 0.5)

Acp_Ds_random_number = round(random.uniform(-0.1, 0.1), 10)
Acp_Ds_bias = RooRealVar("Acp_Ds_bias", "Acp_bias", Acp_Ds_random_number)
...
print(f"Acp_blind = {Acp_value:.3f} ± {Acp_error:.3f}")
...
frame_D_minus.GetXaxis().SetTitle("M(#eta_{#pi#pi#pi}#pi^{-}) [GeV/c^{2}]")
