...
file_name_Dp = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/proc13_etapip_gg_fit_opt_loose_v7_fitv6_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}.best.png"
file_name_Dm = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/proc13_etapip_gg_fit_opt_loose_v7_fitv6_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}.best.png"
fitresult_name = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/proc13_etapip_gg_fit_opt_loose_v7_fitv6_bdt_{args.train}_{args.sign}_{BDT_cut}.best.root"
fitresult_text = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/proc13_etapip_gg_fit_opt_loose_v7_fitv6_bdt_{args.train}_{args.sign}_{BDT_cut}.best.txt"
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 210000*scale*N_scale, 80000*scale*N_scale, 420000*scale*N_scale)  # N_total = N_D+ + N_D-
...
frame_D_minus.GetXaxis().SetTitle("M(#eta_{#gamma#gamma}#pi^{-}) [GeV/c^{2}]")
