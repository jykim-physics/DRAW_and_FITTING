...
file_name_Dp = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/MC15rd_etapip_gg_fit_opt_loose_v7_fitv2_bdt_{args.train}_Dp_CMS_{args.sign}.png"
file_name_Dm = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/MC15rd_etapip_gg_fit_opt_loose_v7_fitv2_bdt_{args.train}_Dm_CMS_{args.sign}.png"
fitresult_name = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/MC15rd_etapip_gg_fit_opt_loose_v7_fitv2_bdt_{args.train}_{args.sign}.root"
fitresult_text = f"/share/storage/jykim/plots/proc_all/etapip/gg/generic/fitresult/MC15rd_etapip_gg_fit_opt_loose_v7_fitv2_bdt_{args.train}_{args.sign}.txt"
...
for element in cm_elements:
    #pattern = f"{base_path}/{element}/{tree_name}/{args.train}/all/*.BCS.root"
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 180000*scale*N_scale, 80000*scale*N_scale, 260000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 280000*scale*N_scale, 160000*scale*N_scale,360000*scale*N_scale)
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 500000*scale*N_scale, 200000*scale*N_scale,800000*scale*N_scale)
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigmaL",  0.0023677637452118243)
sigmaR = ROOT.RooRealVar("sigmaR", "sigmaR",  0.0009763514413287905)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.5217671341267391)
nL = ROOT.RooRealVar("nL", "nL", 3.2513345624817918)
alphaR = ROOT.RooRealVar("alphaR", "alphaR",0.48561643002489113 )
nR = ROOT.RooRealVar("nR", "nR", 2.423581265451175)
...
sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian", 0.00850080368605464)

scale_factor = ROOT.RooRealVar("scale_factor", "scale_factor", 0,0,1)
...
Ds_mean = ROOT.RooRealVar("Ds_mean", "mean", 1.97, 1.94, 1.98)
#Ds_sigma = ROOT.RooRealVar("Ds_sigma", "sigma", 0.00103040185)
Ds_sigmaL = ROOT.RooRealVar("Ds_sigmaL", "sigma", 0.002674091012457565)
Ds_sigmaR = ROOT.RooRealVar("Ds_sigmaR", "sigma",  0.00437949317595822)
Ds_alphaL = ROOT.RooRealVar("Ds_alphaL", "alphaL", 0.5427698948091342)
Ds_nL = ROOT.RooRealVar("Ds_nL", "nL", 2.9825815325858307)
Ds_alphaR = ROOT.RooRealVar("Ds_alphaR", "alphaR", 1.4380794091750626)
Ds_nR = ROOT.RooRealVar("Ds_nR", "nR", 2.238460765649241)
...
Ds_sigma_gaussian = ROOT.RooRealVar("Ds_sigma_gaussian", "sigma of Gaussian", 0.008910282995857624)
...
novo_mean = ROOT.RooRealVar("novo_mean", "Mean",  1.729140997580629, 1.70,1.75)
#novo_sigma = ROOT.RooRealVar("novo_sigma", "Sigma", 0.047716847701201354)
#novo_tail = ROOT.RooRealVar("novo_tail", "Tail", 0.07866740181977971)
novo_sigma = ROOT.RooRealVar("novo_sigma", "Sigma",  0.047716847701201354)
novo_tail = ROOT.RooRealVar("novo_tail", "Tail", 0.07866740181977971)
...
print(f"Acp_blind = {Acp_value:.3f} ± {Acp_error:.6f}")
