...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15rd_6M_etapip_pipipi_K_Dp_M_opt_v7_DSCBShape_conv_extended_train_Dp_CMS_p.0.92_new_Ds_correct_v2.png"
result_name = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15rd_6M_etapip_pipipi_K_Dp_M_opt_v7_DSCBShape_conv_result_extended_train_Dp_CMS_p.0.92_new_Ds_correct_v2.txt"
fitresult_root = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15re_6M_etapip_pipipi_K_Dp_M_opt_v7_DSCBShape_conv_result_extended_train_Dp_CMS_p.0.92_new_Ds_correct_v2.root"
...
#sigmaLR = ROOT.RooRealVar("sigmaLR", "sigma", 0.002, 0.00001, 0.01)
#alphaL = ROOT.RooRealVar("alphaL", "alphaL", 1.2, 0.0, 3.0)
#nL = ROOT.RooRealVar("nL", "nL", 2.0, 0.0, 5.0)
#alphaR = ROOT.RooRealVar("alphaR", "alphaR", 1.5, 0.0, 3.0)
