...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15rd/etapip/pipipi/MC15rd_6M_etapip_pipipi_Dp_M_opt_v7_CB_conv_extended_250122.png"
result_name = "/share/storage/jykim/plots/MC15rd/etapip/pipipi/MC15rd_6M_etapip_pipipi_Dp_M_opt_v7_CB_conv_result_extended_250122.txt"
...
mychain.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dptoetapip_pipipi/250122_loose_v7/etapip_pipipi/*BCS.root")

tree_name_cc = "etapip_pipipi"
mychain_cc = ROOT.TChain(tree_name_cc)
mychain_cc.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dptoetapip_pipipi_cc/250122_loose_v7/etapip_pipipi/*BCS.root")
...
nL = ROOT.RooRealVar("nL", "nL", 2.0, 0.1, 5.0)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.3, 0.0, 2.0)
nR = ROOT.RooRealVar("nR", "nR", 1.0, 0.1, 5.0)
...
sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian", 0.001, 0.0001, 0.01)
