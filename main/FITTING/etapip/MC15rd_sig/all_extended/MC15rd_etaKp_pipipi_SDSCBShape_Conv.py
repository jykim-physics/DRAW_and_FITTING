...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15rd_6M_etapip_pipipi_K_Dp_M_opt_v7_SDSCBShape_conv_extended_train_Dp_CMS_p.0.92_new_Ds_correct.png"
result_name = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15rd_6M_etapip_pipipi_K_Dp_M_opt_v7_SDSCBShape_conv_result_extended_train_Dp_CMS_p.0.92_new_Ds_correct.txt"
fitresult_root = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15re_6M_etapip_pipipi_K_Dp_M_opt_v7_SDSCBShape_conv_result_extended_train_Dp_CMS_p.0.92_new_Ds_correct.root"
...
mychain.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/DptoetaKp_pipipi/250216_loose_v7/etapip_pipipi_K/min_unc_search/new_Ds_v2/0.92/*BCS.root")

tree_name_cc = "etapip_pipipi_K"
mychain_cc = ROOT.TChain(tree_name_cc)
mychain_cc.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/DptoetaKp_pipipi_cc/250216_loose_v7/etapip_pipipi_K/min_unc_search/new_Ds_v2/0.92/*BCS.root")
...
mean = ROOT.RooRealVar("mean", "mean", 1.86, 1.83, 1.88)
...
sigmaLR = ROOT.RooRealVar("sigmaLR", "sigma", 0.0002, 0.00001, 0.01)
...
alpha = ROOT.RooRealVar("alpha", "alphaL", 0.2, 0.0, 2.5)
n = ROOT.RooRealVar("n", "nL", 2.0, 0.1, 4.0)
...
CB = ROOT.RooCrystalBall("CB", "CB_left", x, mean, sigmaLR,  alpha, n, True)
