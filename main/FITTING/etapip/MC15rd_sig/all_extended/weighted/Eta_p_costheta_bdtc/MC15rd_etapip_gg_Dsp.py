...
ROOT.SetBelle2Style()
#file_name = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_Dp_M_v12_CB_conv_extended_train_Dp_CMS_p_Ds.0.86.weighted.png"
#result_name = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_Dp_M_v12_CB_conv_result_extended_train_Dp_CMS_p_Ds.0.86.weighted.txt"
#fitresult_root = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_Dp_M_v12_CB_conv_result_extended_train_Dp_CMS_p_Ds.0.86.weighted.root"
file_name = "output/MC15rd_6M_etapip_gg_Dsp_M_CB_conv_extended.0.86.eta_p_costheta_weighted.png"
result_name = "output/MC15rd_6M_etapip_gg_Dsp_M_CB_conv_extended.0.86.eta_p_costheta_weighted.txt"
fitresult_root = "output/MC15rd_6M_etapip_gg_Dsp_M_CB_conv_extended.0.86.eta_p_costheta_weighted.root"
...
full_var_set = ROOT.RooArgSet(x, truth_var, Pip_charge, rank_Dp_chiProb, bdtg_norm)


# Create a TChain and add all ROOT files
mychain = ROOT.TChain(tree_name)
mychain.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dsptoetapip_gg/260602_loose_v7_eta_theta_var/etapip_gg/ref/min_unc_search/0.86/weighted/Ds_etapip_gg_K_eta_p_costheta/*bdtg.root")

tree_name_cc = "etapip_gg"
mychain_cc = ROOT.TChain(tree_name_cc)
mychain_cc.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dsptoetapip_gg_cc/260602_loose_v7_eta_theta_var/etapip_gg/ref/min_unc_search/0.86/weighted/Ds_etapip_gg_K_eta_p_costheta/*bdtg.root")
