...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_Dp_M_opt_v7_DSCBShape_extended_train_Dp_CMS_p_Ds.0.91.weighted.new_Ds_correct.png"
result_name = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_Dp_M_opt_v7_DSCBShape_result_extended_train_Dp_CMS_p_Ds.0.91.weighted.new_Ds_correct.txt"
fitresult_root = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_Dp_M_opt_v7_DSCBShape_result_extended_train_Dp_CMS_p_Ds.0.91.weighted.new_Ds_correct.root"
...
sigmaLR = ROOT.RooRealVar("sigmaLR", "sigma", 0.002, 0.0001, 0.1)
sigmaL = ROOT.RooRealVar("sigmaL", "sigma", 0.002, 0.0001, 0.1)
sigmaR = ROOT.RooRealVar("sigmaR", "sigma", 0.002, 0.0001, 0.1)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.5, 0.01, 3.0)
nL = ROOT.RooRealVar("nL", "nL", 4.0, 0.01, 6.0)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.3, 0.01, 3.0)
nR = ROOT.RooRealVar("nR", "nR", 3.0, 0.01, 6.0)



# Create double-sided Crystal Ball PDF
#CB = ROOT.RooCrystalBall("CB", "CB_left", x, mean, sigmaLR,  alphaL, nL, alphaR, nR)
#model = ROOT.RooCrystalBall("CB_left", "CB_left", x, mean, sigmaLR,  alphaL, nL, alphaR, nR)
model = ROOT.RooCrystalBall("CB_left", "CB_left", x, mean, sigmaL, sigmaR,  alphaL, nL, alphaR, nR)
...
# Perform the fit
#result = model.fitTo(data, ROOT.RooFit.Range(fit_range[0], fit_range[1]), ROOT.RooFit.NumCPU(4), ROOT.RooFit.Save(), ROOT.RooFit.Offset("initial"), ROOT.RooFit.Strategy(2),ROOT.RooFit.SumW2Error(True))
#result.Print()
