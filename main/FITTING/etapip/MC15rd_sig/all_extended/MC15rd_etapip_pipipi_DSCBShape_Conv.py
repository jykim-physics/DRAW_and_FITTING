...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15rd/etapip/pipipi/MC15rd_6M_etapip_pipipi_Dp_M_opt_v7_DSCBShape_conv_extended_train_Dp_CMS_p.0.74_new_Ds_correct.png"
result_name = "/share/storage/jykim/plots/MC15rd/etapip/pipipi/MC15rd_6M_etapip_pipipi_Dp_M_opt_v7_DSCBShape_conv_result_extended_train_Dp_CMS_p.0.74_new_Ds_correct.txt"
fitresult_root = "/share/storage/jykim/plots/MC15rd/etapip/pipipi/MC15rd_6M_etapip_pipipi_Dp_M_opt_v7_DSCBShape_conv_result_extended_train_Dp_CMS_p.0.74_new_Ds_correct.root"
...
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.08, 0.0, 3.0)
nL = ROOT.RooRealVar("nL", "nL", 2.0, 0.0, 4.0)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.13, 0.0, 3.0)
