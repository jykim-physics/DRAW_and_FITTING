...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_Dp_M_opt_v7_DSCBShape_conv_extended_train_Dp_CMS_p.0.91_new_Ds_correct.png"
result_name = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_Dp_M_opt_v7_DSCBShape_conv_result_extended_train_Dp_CMS_p.0.91_new_Ds_correct.txt"
fitresult_root = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15re_6M_etapip_gg_K_Dp_M_opt_v7_DSCBShape_conv_result_extended_train_Dp_CMS_p.0.91_new_Ds_correct.root"
...
mychain.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/DptoetaKp_gg/250216_loose_v7/etapip_gg_K/min_unc_search/new_Ds_v2/0.91/*BCS.root")

tree_name_cc = "etapip_gg_K"
mychain_cc = ROOT.TChain(tree_name_cc)
mychain_cc.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/DptoetaKp_gg_cc/250216_loose_v7/etapip_gg_K/min_unc_search/new_Ds_v2/0.91/*BCS.root")
...
sigmaLR = ROOT.RooRealVar("sigmaLR", "sigma", 0.002, 0.0001, 0.01)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.5, 0.1, 3.0)
nL = ROOT.RooRealVar("nL", "nL", 4.0, 0.1, 5.0)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.3, 0.1, 3.0)
