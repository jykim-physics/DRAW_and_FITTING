...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_Dp_M_opt_v7_CB_conv_extended.png"
result_name = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_Dp_M_opt_v7_CB_conv_result_extended.txt"
...
mychain.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/DptoetaKp_gg/241213_loose_v7/etapip_gg_K/*BCS.root")

tree_name_cc = "etapip_gg_K"
mychain_cc = ROOT.TChain(tree_name_cc)
mychain_cc.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/DptoetaKp_gg_cc/241213_loose_v7/etapip_gg_K/*BCS.root")
...
sigmaR = ROOT.RooRealVar("sigmaR", "sigma", 0.003, 0.0001, 0.-1)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.02, 0.0, 3.0)
nL = ROOT.RooRealVar("nL", "nL", 1.0, 0.0, 5.0)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.03, 0.0, 3.0)
