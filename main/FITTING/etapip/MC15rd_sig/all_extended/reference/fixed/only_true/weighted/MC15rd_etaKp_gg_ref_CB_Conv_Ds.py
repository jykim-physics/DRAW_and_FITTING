...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_ref_Dp_M_v12_CB_conv_extended_train_Dp_CMS_p.0.86_Ds.weighted.only_true.png"
result_name = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_ref_Dp_M_v12_CB_conv_result_extended_train_Dp_CMS_p.0.86_Ds.weighted.only_true.txt"
fitresult_root = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_ref_Dp_M_v12_CB_conv_result_extended_train_Dp_CMS_p.0.86_Ds.weighted.only_true.root"
...
cuts_Dp = " Pip_charge==1 && rank_Dp_chiProb==1 && etapip_Eta_isSignal==1 && Pip_genMotherID==etapip_Eta_genMotherID && Pip_genMotherPDG==431 && Pip_mcPDG==211"
cuts_Dm = " Pip_charge==-1 && rank_Dp_chiProb==1 && etapip_Eta_isSignal==1 && Pip_genMotherID==etapip_Eta_genMotherID && Pip_genMotherPDG==-431 && Pip_mcPDG==-211"
...
full_var_set = ROOT.RooArgSet(x, truth_var, Pip_charge, ds_weight, rank_Dp_chiProb, etapipi_Eta_isSignal, Pip_genMotherID, etapip_Eta_genMotherID, Pip_genMotherPDG, Pip_mcPDG)


# Create a TChain and add all ROOT files
mychain = ROOT.TChain(tree_name)
mychain.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dsptoetapip_gg/260107_loose_v7_less_vars_ntuple/etapip_gg/ref/min_unc_search//0.86/weighted/*BDT.root")

tree_name_cc = "etapip_gg"
mychain_cc = ROOT.TChain(tree_name_cc)
mychain_cc.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dsptoetapip_gg_cc/260107_loose_v7_less_vars_ntuple/etapip_gg/ref/min_unc_search/0.86/weighted/*BDT.root")
...
mean = ROOT.RooRealVar("mean", "mean", 1.97, 1.95, 1.99)
sigmaL = ROOT.RooRealVar("sigmaL", "sigma",  fit_Ds_sigmaL.getVal())
sigmaR = ROOT.RooRealVar("sigmaR", "sigma",  fit_Ds_sigmaR.getVal())
alphaL = ROOT.RooRealVar("alphaL", "alphaL", fit_Ds_alphaL.getVal())
nL = ROOT.RooRealVar("nL", "nL",  fit_Ds_nL.getVal())
alphaR = ROOT.RooRealVar("alphaR", "alphaR", fit_Ds_alphaR.getVal())
nR = ROOT.RooRealVar("nR", "nR", fit_Ds_nR.getVal())

#sigmaL = ROOT.RooRealVar("sigmaL", "sigma", 0.002, 0.0001, 0.01)
#sigmaR = ROOT.RooRealVar("sigmaR", "sigma", 0.003, 0.0001, 0.01)
#alphaL = ROOT.RooRealVar("alphaL", "alphaL", 1.0, 0.01, 4.0)
#nL = ROOT.RooRealVar("nL", "nL", 4.0, 0.0, 5.0)
#alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.3, 0.01, 4.0)
