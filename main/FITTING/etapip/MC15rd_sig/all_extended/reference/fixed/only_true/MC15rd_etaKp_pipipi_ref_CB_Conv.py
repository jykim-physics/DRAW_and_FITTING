...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15rd_6M_etapip_pipipi_K_ref_Dp_M_v12_CB_conv_extended_train_Dp_CMS_p.0.77.only_true.png"
result_name = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15rd_6M_etapip_pipipi_K_ref_Dp_M_v12_CB_conv_result_extended_train_Dp_CMS_p.0.77.only_true.txt"
fitresult_root = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15rd_6M_etapip_pipipi_K_ref_Dp_M_v12_CB_conv_result_extended_train_Dp_CMS_p.0.77.only_true.root"
...
cuts = rank_var + "==1"
cuts_Dp = " Pip_charge==1 && rank_Dp_chiProb==1 && Dp_isSignal==1"
cuts_Dm = " Pip_charge==-1 && rank_Dp_chiProb==1 && Dp_isSignal==1"
...
mychain.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dptoetapip_pipipi/260107_loose_v7_less_vars_ntuple/etapip_pipipi/ref/min_unc_search/0.77/*BDT.root")

tree_name_cc = "etapip_pipipi"
mychain_cc = ROOT.TChain(tree_name_cc)
mychain_cc.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dptoetapip_pipipi_cc/260107_loose_v7_less_vars_ntuple/etapip_pipipi/ref/min_unc_search/0.77/*BDT.root")
...
#sigmaR = ROOT.RooRealVar("sigmaR", "sigma", 0.0003, 0.00001, 0.01)
#alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.2, 0.01, 2.5)
#nL = ROOT.RooRealVar("nL", "nL", 2.0, 0.01, 3.5)
#alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.3, 0.01, 2.5)
