...
ROOT.SetBelle2Style()
file_name = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/MC15rd_6M_etapip_pipipi_ref_Dp_M_opt_v7_CB_conv_extended_train_Dp_CMS_p.{BDT_cut}.weighted_new_Ds_correct_only_true.png"
result_name = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/MC15rd_6M_etapip_pipipi_ref_Dp_M_opt_v7_CB_conv_result_extended_train_Dp_CMS_p_Ds_p.{BDT_cut}.weighted_new_Ds_correct_only_true.txt"
fitresult_root = f"/share/storage/jykim/plots/MC15rd/etapip/pipipi/MC15rd_6M_etapip_pipipi_ref_Dp_M_opt_v7_CB_conv_result_extended_train_Dp_CMS_p_Ds_p.{BDT_cut}.weighted_new_Ds_correct_only_true.root"
...
cuts_Dp = " Pip_charge==1 & etapip_Eta_isSignal==1 & Pip_genMotherID==etapip_Eta_genMotherID & Pip_genMotherPDG==431 & Pip_mcPDG==211 "
cuts_Dm = " Pip_charge==-1 & etapip_Eta_isSignal==1 & Pip_genMotherID==etapip_Eta_genMotherID & Pip_genMotherPDG==-431 & Pip_mcPDG==-211 "
...
full_var_set = ROOT.RooArgSet(x, truth_var, Pip_charge, ds_weight, etapipi_Eta_isSignal, Pip_genMotherID, etapip_Eta_genMotherID, Pip_genMotherPDG, Pip_mcPDG)


# Create a TChain and add all ROOT files
mychain = ROOT.TChain(tree_name)
mychain.Add(f"/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dsptoetapip_pipipi/250216_loose_v7/etapip_pipipi/ref/min_unc_search/new_Ds_v2/{BDT_cut}/weighted/*BCS.root")

tree_name_cc = "etapip_pipipi"
mychain_cc = ROOT.TChain(tree_name_cc)
mychain_cc.Add(f"/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dsptoetapip_pipipi_cc/250216_loose_v7/etapip_pipipi/ref/min_unc_search/new_Ds_v2/{BDT_cut}/weighted/*BCS.root")
...
sigmaL = ROOT.RooRealVar("sigmaL", "sigma", 0.00043690238007956854)
sigmaR = ROOT.RooRealVar("sigmaR", "sigma", 0.00024606699731560274)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 0.23734630082787544)
nL = ROOT.RooRealVar("nL", "nL", 2.6505314073415525)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.2100686632942425)
nR = ROOT.RooRealVar("nR", "nR", 2.3490320664081663)
...
sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian", 0.0045, 0.001, 0.01)
