...
ROOT.SetBelle2Style()
file_name = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15rd_6M_etapip_pipipi_K_ref_Dp_M_opt_v7_CB_conv_extended_train_Dp_CMS_p.{BDT_cut}_new_Ds_correct_only_true.png"
result_name = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15rd_6M_etapip_pipipi_K_ref_Dp_M_opt_v7_CB_conv_result_extended_train_Dp_CMS_p.{BDT_cut}_new_Ds_correct_only_true.txt"
fitresult_root = f"/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15rd_6M_etapip_pipipi_K_ref_Dp_M_opt_v7_CB_conv_result_extended_train_Dp_CMS_p.{BDT_cut}_new_Ds_correct_only_true.root"
...
cuts = rank_var + "==1"
cuts_Dp = " Pip_charge==1 & Dp_isSignal==1"
cuts_Dm = " Pip_charge==-1 & Dp_isSignal==1"
...
mychain.Add(f"/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dptoetapip_pipipi/250216_loose_v7/etapip_pipipi/ref/min_unc_search/new_Ds_v2/{BDT_cut}/*BCS.root")

tree_name_cc = "etapip_pipipi"
mychain_cc = ROOT.TChain(tree_name_cc)
mychain_cc.Add(f"/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dptoetapip_pipipi_cc/250216_loose_v7/etapip_pipipi/ref/min_unc_search/new_Ds_v2/{BDT_cut}/*BCS.root")
...
mean = ROOT.RooRealVar("mean", "mean", 1.86, 1.84, 1.89)
sigmaL = ROOT.RooRealVar("sigmaL", "sigma", 0.0004310975997132347)
sigmaR = ROOT.RooRealVar("sigmaR", "sigma", 2.909462763292009e-05)
alphaL = ROOT.RooRealVar("alphaL", "alphaL",0.31057324893042276)
nL = ROOT.RooRealVar("nL", "nL", 2.2903845461590393)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 0.0413930546287739)
nR = ROOT.RooRealVar("nR", "nR", 1.896267875688979)
