...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_ref_Dp_M_opt_v7_CB_conv_extended_train_Dp_CMS_p_fixed_from_DpEtaPip.png"
result_name = "/share/storage/jykim/plots/MC15rd/etaKp/gg/MC15rd_6M_etapip_gg_K_ref_Dp_M_opt_v7_CB_conv_result_extended_train_Dp_CMS_p_fixed_from_DpEtaPip.txt"
...
mychain.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dptoetapip_gg/250216_loose_v7/etapip_gg/train_Dp_dz/skimhad/ref/*BCS.root")

tree_name_cc = "etapip_gg"
mychain_cc = ROOT.TChain(tree_name_cc)
mychain_cc.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/Dptoetapip_gg_cc/250216_loose_v7/etapip_gg/train_Dp_dz/skimhad/ref/*BCS.root")
...
'''
sigmaL = ROOT.RooRealVar("sigmaL", "sigma",  0.0016461558006704725)
sigmaR = ROOT.RooRealVar("sigmaR", "sigma", 0.00310426478494243)
alphaL = ROOT.RooRealVar("alphaL", "alphaL",0.35232261704689516 )
nL = ROOT.RooRealVar("nL", "nL", 3.2996856176640694)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 1.14500901195425261)
...
sigma_gaussian = ROOT.RooRealVar("sigma_gaussian", "sigma of Gaussian", 0.001, 0.00001, 0.01)
