...
ROOT.SetBelle2Style()
file_name = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15rd_6M_etapip_pipipi_K_Dp_M_opt_v3_CB_conv.png"
result_name = "/share/storage/jykim/plots/MC15rd/etaKp/pipipi/MC15rd_6M_etapip_pipipi_K_Dp_M_opt_v3_CB_conv_result.txt"
...
mychain.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/DptoetaKp_pipipi/241129_loose_v3/etapip_pipipi_K/*BCS.root")

tree_name_cc = "etapip_pipipi_K"
mychain_cc = ROOT.TChain(tree_name_cc)
mychain_cc.Add("/share/storage/jykim/storage_ghi/Ntuples_ghi_2/MC15rd_sigMC/DptoetaKp_pipipi_cc/241129_loose_v3/etapip_pipipi_K/*BCS.root")
...
sigma = ROOT.RooRealVar("sigma", "sigma", 0.02, 0.0001, 0.1)
alphaL = ROOT.RooRealVar("alphaL", "alphaL", 2.0, 0.0, 5.0)
nL = ROOT.RooRealVar("nL", "nL", 1.0, 0.0, 5.0)
alphaR = ROOT.RooRealVar("alphaR", "alphaR", 3.0, 0.0, 5.0)
...
# Perform the fit
result = model.fitTo(data, ROOT.RooFit.Range(fit_range[0], fit_range[1]), ROOT.RooFit.NumCPU(4), ROOT.RooFit.Save(), ROOT.RooFit.Offset(True))
result.Print()
