...
suffix = "test"
file_name_Dp = f"/share/storage/jykim/plots/proc_all/etapip/3pi0/generic/proc13_etapip_3pi0_fit_opt_loose_v7_fitv12_bdt_{args.train}_Dp_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
file_name_Dm = f"/share/storage/jykim/plots/proc_all/etapip/3pi0/generic/proc13_etapip_3pi0_fit_opt_loose_v7_fitv12_bdt_{args.train}_Dm_CMS_{args.sign}_{BDT_cut}_{suffix}.png"
file_name_Dall = f"/share/storage/jykim/plots/proc_all/etapip/3pi0/generic/proc13_etapip_3pi0_fit_opt_loose_v7_fitv12_bdt_{args.train}_Dall_CMS_{args.sign}_{BDT_cut}_{suffix}.pdf"
fitresult_name = f"/share/storage/jykim/plots/proc_all/etapip/3pi0/generic/fitresult/proc13_etapip_3pi0_fit_opt_loose_v7_fitv12_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}.root"
fitresult_text = f"/share/storage/jykim/plots/proc_all/etapip/3pi0/generic/fitresult/proc13_etapip_3pi0_fit_opt_loose_v7_fitv12_bdt_{args.train}_{args.sign}_{BDT_cut}_{suffix}.txt"
file_sweight = f"/share/storage/jykim/sweight/proc13/etapip/3pi0/proc13_etapip_3pi0_fit_opt_loose_v7_fitv12_Ds_weighted.root"
...
base_path = "/share/storage/jykim/storage_b2/storage/reduced_ntuples/proc13/proc13_EtaHp_3pi0_loose_v7"
cm_elements = ["3pi0_13_had_4S_off_v1", "3pi0_13_had_4S_v3", "3pi0_23_had_4S_off_v1", "3pi0_23_had_4S_v1", \
               "3pi0_23_had_5Sscan_10657_v1", "3pi0_23_had_5Sscan_10706_v1", "3pi0_23_had_5Sscan_10751_v1", "3pi0_23_had_5Sscan_10810_v1"]

tree_name = "etapip_3pi0"
file_list = []
for element in cm_elements:
    #pattern = f"{base_path}/{element}/{tree_name}/min_unc_search/{BDT_cut}/*BDT.root"
    pattern = f"{base_path}/{element}/{tree_name}/test/{BDT_cut}/*BDT.root"
...
fit_variable = "Dp_M"
fit_var_name = "M(#eta_{3#pi^{0}}#pi^{+}) [GeV/c^{2}]"
fit_range = (1.71, 2.06)
...
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 110000*scale*N_scale, 5000*scale*N_scale, 300000*scale*N_scale)  # N_total = N_D+ + N_D-
...
N_total_Ds = RooRealVar("N_total_Ds", "N_total (N_Ds+ + N_Ds-)", 210000*scale*N_scale, 8000*scale*N_scale, 520000*scale*N_scale)  # N_total = N_D+ + N_D-
Acp_Ds_blind = RooRealVar("Acp_Ds_blind", "Acp", 0, -0.5, 0.5)

random.seed(62)  # Set a seed for reproducibility
...
Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 600000*scale*N_scale, 100000*scale*N_scale,2000000*scale*N_scale)
...
frame_D_all.GetXaxis().SetTitle("M(#eta_{3#pi^{0}}#pi^{+}) [GeV/c^{2}]")
