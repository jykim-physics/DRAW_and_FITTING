...
#suffix = "sumw2fixed"
file_name_Dp = f"Dp_etaeta_gpi_untag.png"
file_name_Dm = f"Dm_etaeta_gpi_untag.png"
file_name_Dall = f"Dall_etaeta_gpi_untag.png"
fitresult_name = f"etaeta_gpi_untag.result.root"
fitresult_text = f"etaeta_gpi_untag.txt"
file_sweight = f"etaeta_gpi_untag_sweight.root"
...
scale=1
N_scale=1
N_total = RooRealVar("N_total", "N_total (N_D+ + N_D-)", 15000*scale*N_scale, 5000*scale*N_scale, 50000*scale*N_scale)  # N_total = N_D+ + N_D-

Nbkg_total = ROOT.RooRealVar("Nbkg_total", "Number of background events for D+", 200000*scale*N_scale, 100000*scale*N_scale,400000*scale*N_scale)
