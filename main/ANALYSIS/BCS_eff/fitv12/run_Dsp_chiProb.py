...
plt.tight_layout()
plt.savefig(f'multiplicity_hist_unweighted_chiProb_{tree_name}.png', dpi=160)
plt.close()
...
plt.tight_layout()
plt.savefig(f'multiplicity_hist_weighted_chiProb_{tree_name}.png', dpi=160)
plt.close()

print(f"[INFO] Saved histograms: multiplicity_hist_unweighted.png, multiplicity_hist_weighted_chiProb_{tree_name}.png")
